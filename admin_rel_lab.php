			...
			<!-- Content area -->
				<div class="content">
					...
					<div class="col-lg-3">
							...
							<a class="btn btn-success" href="admin_rel_lab_asesorias.php">Agregar</a>
							</div>
					</fieldset>
					</form>
					...
					<table class="table table-condensed datatable-button-html5-columns">
						...
						?>
                          <tr>
							...
							<?php do { ?>
								<li><i class="icon-files-empty2 text-orange position-left"></i><a class="text-orange" href="admin_rel_lab_etapas.php?IDetapa=1&IDasesoria=<?php echo $row_asesorias['IDasesoria']; ?>&IDasesoria_etapa=<?php echo $row_asesorias_etapa1['IDasesoria_etapa']; ?>&IDempleado=<?php echo $row_asesorias['IDempleado']; ?>"><?php echo date( 'd/m/Y', strtotime($row_asesorias_etapa1['fecha_inicio'])); ?></a></li>
							<?php } while ($row_asesorias_etapa1 = mysql_fetch_assoc($asesorias_etapa1)); ?>
							<?php } ?>
								<li><i class="icon-file-plus2 text-success position-left"></i><a class="text-success" href="admin_rel_lab_etapas.php?IDetapa=1&IDempleado=<?php echo $row_asesorias['IDempleado']; ?>&IDasesoria=<?php echo $row_asesorias['IDasesoria']; ?>">Agregar</a></li>
								</ul>
							</div>
							</td>
							 <td>
							...
							<?php do { ?>
								<li><i class="icon-files-empty2 text-warning position-left"></i><a class="text-warning" href="admin_rel_lab_etapas.php?IDetapa=2&IDasesoria=<?php echo $row_asesorias['IDasesoria']; ?>&IDasesoria_etapa=<?php echo $row_asesorias_etapa2['IDasesoria_etapa']; ?>&IDempleado=<?php echo $row_asesorias['IDempleado']; ?>"><?php echo date( 'd/m/Y', strtotime($row_asesorias_etapa2['fecha_inicio'])); ?></a></li>
							<?php } while ($row_asesorias_etapa2 = mysql_fetch_assoc($asesorias_etapa2)); ?>
							<?php } ?>
								<li><i class="icon-file-plus2 text-success position-left"></i><a class="text-success" href="admin_rel_lab_etapas.php?IDetapa=2&IDempleado=<?php echo $row_asesorias['IDempleado']; ?>&IDasesoria=<?php echo $row_asesorias['IDasesoria']; ?>">Agregar</a></li>
								</ul>
							</div>
							</td>
							 <td>
							...
							<?php do { ?>
								<li><i class="icon-files-empty2 text-danger position-left"></i><a class="text-danger" href="admin_rel_lab_etapas.php?IDetapa=3&IDasesoria=<?php echo $row_asesorias['IDasesoria']; ?>&IDasesoria_etapa=<?php echo $row_asesorias_etapa3['IDasesoria_etapa']; ?>&IDempleado=<?php echo $row_asesorias['IDempleado']; ?>"><?php echo date( 'd/m/Y', strtotime($row_asesorias_etapa3['fecha_inicio'])); ?></a></li>
							<?php } while ($row_asesorias_etapa3 = mysql_fetch_assoc($asesorias_etapa3)); ?>
							<?php } ?>
								<li><i class="icon-file-plus2 text-success position-left"></i><a class="text-success" href="admin_rel_lab_etapas.php?IDetapa=3&IDempleado=<?php echo $row_asesorias['IDempleado']; ?>&IDasesoria=<?php echo $row_asesorias['IDasesoria']; ?>">Agregar</a></li>
								</ul>
							</div>
							</td>
							 <td>
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-body">
														...
														<form action="admin_rel_lab.php" method="post" name="importar" id="importar" class="form-horizontal" enctype="multipart/form-data">
														 <fieldset>
