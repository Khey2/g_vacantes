...
mysql_select_db($database_vacantes, $vacantes);
$query_usuarios = "SELECT DISTINCT prod_activos.IDempleado, prod_activos.emp_paterno, prod_activos.emp_materno, prod_activos.emp_nombre, prod_activos.rfc, prod_activos.denominacion, nom35_resultados.IDresultado, nom35_resultados.IDexamen, vac_matriz.matriz FROM prod_activos LEFT JOIN nom35_resultados ON nom35_resultados.IDempleado = prod_activos.IDempleado LEFT JOIN vac_matriz ON vac_matriz.IDmatriz = prod_activos.IDmatriz WHERE nom35_resultados.IDperiodo = $IDperiodo AND prod_activos.IDmatriz = $IDmatriz AND nom35_resultados.IDexamen = $IDexamen_  GROUP BY IDempleado, IDexamen";
		...
		<form method="POST" action="admin_n35e.php">
			<table class="table">
				<tr>
                    ...
                    <td>
                    <button type="submit" class="btn btn-primary">Filtrar</button> &nbsp;  <button type="button" class="btn btn-warning" onClick="window.location.href='admin_n35ep.php'">Pendientes</button>
					</td>
					</tr>
		    </table>
		</form>
