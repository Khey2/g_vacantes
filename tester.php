...
//parametros
mysql_select_db($database_vacantes, $vacantes);
$query_tester = "SELECT * FROM prod_captura WHERE semana = 4 AND anio = 2022 AND IDmatriz = 20 AND IDpuesto in (2, 18, 281)";
$tester = mysql_query($query_tester, $vacantes) or die(mysql_error());
...
do { 
$la_captura = $row_tester['IDcaptura'];
echo $la_captura;
...
echo "Distrib: " . $dist . "</br>";
	...
	//redirecto
	//header("Location: productividad_captura_puesto_a.php?IDpuesto=$el_puesto"); 	
		

} while ($row_tester = mysql_fetch_assoc($tester));
