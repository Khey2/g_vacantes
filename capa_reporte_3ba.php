...
//TODAS LAS ALTAS
$query_altas = "SELECT ind_bajas.*, vac_matriz.matriz, vac_matriz.region_op FROM ind_bajas LEFT JOIN vac_matriz ON ind_bajas.IDmatriz = vac_matriz.IDmatriz WHERE ind_bajas.fecha_antiguedad BETWEEN '$fecha_inicio' AND '$fecha_fin' AND ind_bajas.IDpuesto in ($puestos) AND ind_bajas.estatus in (1,3) AND ind_bajas.IDmatriz IN ($IDmatrizes)"; 
			...
			<!-- Content area -->
				...
				<div class="table-responsive">
                    ...
                    <tbody>
						...
						$query_detalle = "SELECT * FROM capa_avance WHERE capa_avance.fecha_antiguedad BETWEEN '$fecha_inicio' AND '$fecha_fin' AND capa_avance.IDC_capa_cursos IN ($IDC_capa_cursos) AND IDempleado = $IDempleado"; 
					  ...
					  <tr>
						...
						<td class="text-center"><?php echo $IDempleado; ?></td>
