...
mysql_select_db($database_vacantes, $vacantes);
$query_documentos = "SELECT * FROM con_documentos WHERE IDarea in ($elarea)";
...
<p align="center">PAGAR&#201;</p>
&nbsp; <br>
&nbsp; <br>

<p>BUENO POR $_________________</p>
&nbsp; <br>

<p  class="justificar">'.$row_contratos['a_nombre'].' '.$row_contratos['a_paterno'].' '.$row_contratos['a_materno'].', en la ciudad de '.$ubicacionfirma.', a '.$ini_cont_d.' de '.$ini_cont_m.' de '.$ini_cont_y.', por medio del presente pagar&#233;, reconozco deber y me obligo incondicionalmente a pagar, en _________________________, o en cualquiera otra entidad en que se me requiera el pago a la orden de	<strong>'.$empresa.', </strong>a m&#225;s tardar el d&#237;a _________ del mes de _________ del a&#241;o 20____, la cantidad de ______________________________________ </p>

<p class="justificar">Cantidad que, en caso de mora de pago, causar&#225; un inter&#233;s mensual moratorio a raz&#243;n del 5% sobre la cantidad que como suerte principal ampara el presente pagar&#233;. </p> 

<p class="justificar">Este pagar&#233; est&#225; regido por la Ley General de T&#237;tulos y Operaciones de Cr&#233;dito. </p> 

<p><strong>Domicilio del deudor:</strong>___________________________________________________________________</p>
<p>___________________________________________________________________________________</p>
<p><strong>Firma del Suscriptor:</strong> ___________________________</p>
&nbsp; <br>
<p align="center"><strong>POR AVAL</strong></p>
&nbsp; <br>
<p><strong>Nombre del Aval</strong>: ______________________________________________________________________</p>
<p><strong>Domicilio del aval:</strong>_______________________________________________________________</p>
<p>____________________________________________________________________________________</p>
<p><strong>Firma del Aval:</strong> ________________________________________________________________________</p>
</body>';
...
$nombreDelDocumento = "PAGARE ".date('dmY')." ".$IDempleado.".pdf";
