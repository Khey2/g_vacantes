...
<body>
<br clear="ALL"/>
<p class="justificar"><strong>Anexo 3: Descuento por Crédito de Infonavit</strong></p>
&nbsp; <br>
...
<p class="justificar><strong>Código F-RH-RS-03</strong></p>
&nbsp; <br>

<p class="justificar">Por este conducto manifiesto que al día de hoy, no cuento con ningún crédito de INFONAVIT, y doy mi autorización para que en caso de ser necesario se realice cualquier investigación al respecto. De esta forma libero a la empresa de cualquier responsabilidad solidaria.</p>
...
$nombreDelDocumento = "ANEXO 3 INFONAVIT ".date('dmY')." ".$IDempleado.".pdf";
