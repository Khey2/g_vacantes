...
mysql_select_db($database_vacantes, $vacantes);
$query_matriz = "SELECT * FROM vac_matriz WHERE IDmatriz = '$su_matriz'";
...
if ($la_sucursal  == 13) { $monto_asistencias = 100;} 
...
// cajas minimas
mysql_select_db($database_vacantes, $vacantes);
$query_minimo = "SELECT * FROM vac_matriz WHERE IDmatriz = $su_matriz";
...
echo "Distrib: " . $dist . "</br>";
    ...
    $query1 = "UPDATE prod_captura SET adicional3 = $diferencia1, pago_resto = $diferencia2, bono_asistencia = $bono_asistencia, autorizador = '$el_usuario', pago = '$porc_pago', pago_total = '$monto_T', reci = '$reci', carg = '$carg', esti = '$esti', dist = '$dist' WHERE IDcaptura = '$IDcaptura'"; 
    $result1 = mysql_query($query1) or die(mysql_error());  
	
	//redirecto
	header("Location: productividad_autoriza_empleado_a.php?IDpuesto=$el_puesto&IDmatriz=$su_matriz"); 	
