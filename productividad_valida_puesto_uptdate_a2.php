...
//$estib = 0.025;
//$otros = 0.10;
$monto_recibo = $row_matriz['monto_recibo'];
$monto_carga = $row_matriz['monto_carga'];
$monto_estiba = $row_matriz['monto_estiba'];
$monto_reparto = $row_matriz['monto_reparto'];
...
//tope
if ( $porc_pago > 90) { $monto_T = ($sueldo_semanal * 0.9); $porc_pago = 90;} else { $monto_T =  $monto_T; $porc_pago = $porc_pago; }
...
echo "Distrib: " . $dist . "</br>";
  ...
  $query1 = "UPDATE prod_captura SET validador = '$el_usuario', pago = '$porc_pago', pago_total = '$monto_T', reci = '$reci', carg = '$carg', esti = '$esti', dist = '$dist' WHERE IDcaptura = '$IDcaptura'"; 
  $result1 = mysql_query($query1) or die(mysql_error());  
	
	//redirecto
	header("Location: productividad_valida_puesto_a.php?IDpuesto=$el_puesto"); 	
