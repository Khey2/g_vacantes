...
//$mail->AddAddress('aalopez@sahuayo.mx');
$mail->AddAddress('rtejeda@sahuayo.mx');
$mail->Subject = 'Reporte Mensual de Vacantes.';
$mail->isHTML(true);
$mail->CharSet = 'UTF-8';
$mail->AltBody = 'Reporte Mensual de Vacantes.';
...
.ars { padding-left: 30px; vertical-align: top;  }
</style>
...
<img width="100" border="0" style="display: block; width: 100px;" src="https://intranet.sahuayo.com.mx/global_assets/images/logo_dark.png" alt="" />
</a>
</td>
</tr>
<tr>
...
<tr>
  <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
        <!-- section text ======-->
        <div style="line-height: 35px">Reporte de <span style="color: #5caad2;">Vacantes</span></div>
    </td>
</tr>
<tr>
...
<tr>
<td align="center">
        <table border="0" width="400" align="center" cellpadding="0" cellspacing="0" bgcolor="eeeeee">
<tr>
...
Estimado Usuario, a continuacion se muesta el reporte de vacantes correspondiente al mes de ' . $elmes. '. Las vacantes activas son las del ultimo dia del mes.</p>
<table  border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="ffffff" class="bg_color">
 <thead>
 <tr>
 <th>Sucursal</th>
...
mysql_select_db($database_vacantes, $vacantes);
$query_global = "SELECT Count(vac_vacante.IDvacante) as Totales, vac_vacante.ajuste_dias, vac_vacante.IDestatus, vac_vacante.fecha_requi, vac_matriz.matriz FROM vac_vacante INNER JOIN vac_matriz ON vac_matriz.IDmatriz = vac_vacante.IDmatriz WHERE vac_vacante.IDestatus = 1 AND vac_matriz.IDmatriz = '$LaMatriz' AND vac_vacante.fecha_ocupacion IS NULL GROUP BY vac_vacante.IDestatus, vac_matriz.matriz";
$global = mysql_query($query_global, $vacantes) or die(mysql_error());
$row_global = mysql_fetch_assoc($global);
if($row_global['Totales'] == 0) {$activas = 0;} else {$activas = $row_global['Totales'];}

// total mes actual
mysql_select_db($database_vacantes, $vacantes);
$query_totales = "SELECT Count(vac_vacante.IDvacante) AS Totales, vac_matriz.matriz FROM vac_vacante INNER JOIN vac_matriz ON vac_matriz.IDmatriz = vac_vacante.IDmatriz WHERE MONTH(vac_vacante.fecha_ocupacion) = '$mes_actual' AND vac_matriz.IDmatriz = '$LaMatriz'";
$totales = mysql_query($query_totales, $vacantes) or die(mysql_error());
$row_totales = mysql_fetch_assoc($totales);
$todas = $row_totales['Totales'];
...
$body .= '<tr>';
$body .= '<td class="ars"><strong>TOTAL</strong></td>';
...
<td align="center" style="color: #ffffff; font-size: 14px; font-family: "Work Sans", Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
    <!-- main section button -->
<div style="line-height: 22px;"><a href="https://intranet.sahuayo.com.mx/" style="color: #ffffff; text-decoration: none;">Acceso</a></div>
</td>
</tr>
    <tr>
<td height="10" style="font-size: 10px; line-height: 10px;">&nbsp;</td>
    ...
    <p style="line-height: 24px">Saludos cordiales.</p>
    </td>
    </tr>
</table>
    </td>
...
<td align="left" style="color: #aaaaaa; font-size: 14px; font-family: "Work Sans", Calibri, sans-serif; line-height: 24px;">
    <div style="line-height: 24px;"><span style="color: #333333;">Sistema de Gestion de Recursos Humanos | SAHUAYO | 2020</span></div>
</td>
    </tr>
</table>
