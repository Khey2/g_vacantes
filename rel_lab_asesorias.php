...
//activo?
$query_empleado_act = "SELECT * FROM prod_activos WHERE IDempleado = $IDempleado AND IDmatriz IN ($IDmatrizes)";
...
} else { header("Location: rel_lab_asesorias.php?info=9"); $avalidar = 2;}

// si no he mandado a validar
} else { $avalidar = 0; }

if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
$insertSQL = sprintf("INSERT INTO rel_lab_asesorias (IDempleado, IDpuesto, IDarea, jefe_inmediato, IDmatriz, emp_paterno, emp_materno, emp_nombre, denominacion, rfc, fecha_captura, anio, mes, IDempleado_captura, fecha_antiguedad, IDestatus, IDmotivo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['IDempleado'], "int"),
                       GetSQLValueString($row_empleado['IDpuesto'], "int"),
                       GetSQLValueString($row_empleado['IDarea'], "int"),
                       GetSQLValueString($_POST['jefe_inmediato'], "text"),
 ...
 header("Location: rel_lab.php?info=1");
}
					...
					<div class="panel-body">
						...
						<legend class="text-semibold">Resultado</legend>
								   ...
								   <div class="form-group">
										...
										<div class="col-lg-9">
											<input type="text" name="jefe_inmediato" id="jefe_inmediato" class="form-control" placeholder="Captura el nombre del jefe inmediato">
										</div>
									</div>
									<!-- /basic text input -->
                    	 ...
                    	 <button type="button" onClick="window.location.href='rel_lab_asesorias.php'" class="btn btn-warning btn-icon">Buscar otro</button>
