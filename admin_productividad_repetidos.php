...
//repetidos
mysql_select_db($database_vacantes, $vacantes);
$query_repetidos = "SELECT  Count(prod_captura.IDempleado) AS repetidos, prod_captura.IDempleado FROM prod_captura WHERE prod_captura.semana = '$semana' GROUP BY prod_captura.IDempleado HAVING repetidos > 1"; 
