...
<body class= "<?php if (isset($_COOKIE["lmenu"])) { echo 'sidebar-xs';}?>  has-detached-right">
	...
	<div class="media panel-body no-margin">
		<div class="media-body">
					...
					<p>Instrucciones. Si existe algun dato erroneo, solicita su cambio a <a href="amilto:amdelafunete@sahuayo.mx">Aline de la Fuente</a>.</p>
					...
					<table class="table table-condensed datatable-button-html5-columns">
						...
						<tbody>							  
						<?php			
						$query_doctos = "SELECT * FROM capa_becarios_files WHERE IDempleado = $el_usuario";
						...
						?>
							...
							echo $elmes; ?></td>
							<td><a href="becariosfiles/<?php echo $row_doctos['IDempleado']; ?>/<?php echo $row_doctos['file']; ?>"><?php echo $row_doctos['file']; ?></a></td>
							<td>Tipo</td>
							<td>*****</td>
							<td>
								<button type="button" class="btn btn-success btn-icon" onClick="window.location.href='f_capa_becarios_evaluar.php?IDempleado=<?php echo $el_usuario; ?>&IDmes=<?php echo $row_evaluaciones['IDmes']; ?>&anio=<?php echo $row_evaluaciones['anio']; ?>'">Ver evaluación</button>
								<button type="button" class="btn btn-danger btn-icon" onClick="window.location.href='f_capa_becarios_evaluar.php?IDempleado=<?php echo $el_usuario; ?>&IDmes=<?php echo $row_evaluaciones['IDmes']; ?>&anio=<?php echo $row_evaluaciones['anio']; ?>'">Borrar</button>
                            </td>
						    </tr>
