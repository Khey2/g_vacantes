						...
						<div class="col-lg-12">
							...
							<div class="panel panel-flat">
								<div class="panel-heading mt-5">
									<h1 class="panel-title">Sucursal: </h1>
								...
								<div class="panel-body">
									...
									<p>A continuación se muestan los resultados obtenidos a Noviembre de 2020 para la Sucursal Seleccionada.</p>
									...
									<table class="table table-condensed datatable-button-html5-columns">
                                     ...
                                     <?php  do { ?>
                                           <tr>
													...
													<td><?php echo $row_avances['IDresultado'];?></td>
					    			...
					    			<?php } while ($row_avances = mysql_fetch_assoc($avances));  ?>
                                     ...
                                     <a href="objetivos_d_agregar.php?IDtarea=<?php echo $IDtarea; ?>" class="btn btn-info">Agregar avance</a>
								</div>
