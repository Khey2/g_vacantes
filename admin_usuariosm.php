...
mysql_select_db($database_vacantes, $vacantes);
$query_usuarios = "SELECT vac_usuarios.IDusuario, vac_usuarios.usuario, vac_usuarios.usuario_nombre, vac_usuarios.usuario_parterno, vac_usuarios.usuario_materno, vac_usuarios.nivel_acceso, vac_usuarios.IDmatrizes, vac_matriz.matriz, vac_puestos.denominacion FROM vac_usuarios left JOIN vac_matriz ON vac_matriz.IDmatriz = vac_usuarios.IDmatriz left JOIN vac_puestos ON vac_puestos.IDpuesto = vac_usuarios.IDusuario_puesto ";
					...
					<div class="panel-body">
                      ...
                      <?php do { ?>
                        <tr>
                         ...
                         <td></td>
                         <td><button type="button" class="btn btn-primary" onClick="window.location.href='admin_usuariosm_edit.php?IDusuario=<?php echo $row_usuarios['IDusuario']; ?>'">Editar</button> 
                         <button type="button" data-target="#modal_theme_danger<?php echo $row_usuarios['IDusuario']; ?>"  data-toggle="modal" class="btn btn-danger btn-icon">Borrar</button>
                         <button type="button" class="btn bg-indigo btn-icon" onClick="window.location.href='admin_usuariosm_asigdar.php?IDusuario=<?php echo $row_usuarios['IDusuario']; ?>'">Matrices</button>
                         <button type="button" class="btn bg-indigo btn-icon" onClick="window.location.href='admin_usuariosm_asignar.php?IDusuario=<?php echo $row_usuarios['IDusuario']; ?>'">Áreas</button></td>
                        </tr>      
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="admin_usuariosm_edit.php?IDusuario=<?php echo $row_usuarios['IDusuario']; ?>&borrar=1">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
