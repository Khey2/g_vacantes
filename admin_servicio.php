...
mysql_select_db($database_vacantes, $vacantes);
$query_resultados = "SELECT DISTINCT sed_servicio.IDservicio, sed_servicio.IDempleado, ed_servicio.emp_paterno, sed_servicio.emp_materno, sed_servicio.emp_nombre, sed_servicio.denominacion, sed_servicio.IDmatriz, vac_matriz.matriz FROM sed_servicio left JOIN vac_matriz ON vac_matriz.IDmatriz = sed_servicio.IDmatriz GROUP BY sed_servicio.IDempleado";
