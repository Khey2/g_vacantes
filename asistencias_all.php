...
$query_matriz_R = "SELECT * FROM vac_matriz WHERE IDmatriz IN($IDmatrizes) ORDER BY matriz DESC";
			...
			<!-- Content area -->
                ...
                <form method="POST" action="asistencias_r.php">
					<table class="table">
							...
							<a href="asistencias_reporte_r_dias.php?IDmatriz=<?php echo $IDmatriz?>&anio=<?php echo $anio?>&mes=<?php echo $el_mes?>&IDfecha=<?php echo $IDfecha?>" class="btn bg-success">Descargar Día</a> 
							<a href="asistencias_reporte_r_mes.php?IDmatriz=<?php echo $IDmatriz?>&anio=<?php echo $anio?>&mes=<?php echo $el_mes?>&IDfecha=<?php echo $IDfecha?>" class="btn bg-warning">Descargar Mes</a> </td>
							</td>
					      </tr>
				    </table>
				</form>
                ...
                <tbody>
                  ...
                  <tr>
				   ...
				   <a href="asistencias_edit_r.php?IDmatriz=<?php echo $IDmatriz?>&anio=<?php echo $anio?>&mes=<?php echo $el_mes?>&IDfecha=<?php echo $IDfecha?>" class="btn bg-info"><i class="icon icon-eye"></i></a>
				   <a href="asistencias_reporte_r_dia.php?IDmatriz=<?php echo $IDmatriz?>&anio=<?php echo $anio?>&mes=<?php echo $el_mes?>&IDfecha=<?php echo $IDfecha?>" class="btn bg-success"><i class="icon icon-file-download2"></i></a>
				   	<?php } ?>
					</td>
