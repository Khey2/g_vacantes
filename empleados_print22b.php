...
mysql_select_db($database_vacantes, $vacantes);
$query_contratos = "SELECT prod_activos.*, vac_matriz.matriz, vac_matriz.matriz_cv, vac_matriz.direccion, vac_puestos.denominacion, vac_puestos.IDarea FROM prod_activos LEFT JOIN vac_matriz ON prod_activos.IDmatriz = vac_matriz.IDmatriz LEFT JOIN vac_puestos ON prod_activos.IDpuesto = vac_puestos.IDpuesto WHERE prod_activos.IDempleado = $IDempleado";
mysql_query("SET NAMES 'utf8'");
...
// convertir fecha en letras
$nac_cont_d = date('d', strtotime($row_contratos['fecha_nacimiento']));
$nac_cont_m_ = date('m', strtotime($row_contratos['fecha_nacimiento']));
$nac_cont_y = date('Y', strtotime($row_contratos['fecha_nacimiento']));
...
$date_b = new DateTime($row_contratos['fecha_nacimiento']);
...
$empresa = $row_contratos['descripcion_nomina'];
...
<table border="0" cellspacing="0" cellpadding="0" width="60%" align="center">
    <tr>
      <td width="45%" valign="top"><p align="center">
        ...
        <strong>C. ' .$row_contratos['emp_nombre'].' '.$row_contratos['emp_paterno'].' '.$row_contratos['emp_materno'].'</strong><br>
      </td>
</table>
