...
?>
                            ...
                            <?php if ($row_puestos['capturador'] != '') { ?>
            					...
            					<form method="post" name="form1<?php echo $row_puestos['IDempleado']; ?>" action="productividad_captura_puesto_a.php?IDpuesto=<?php echo $row_puestos['IDpuesto']; ?>" 
                                ...
                                class="form-horizontal form-validate-jquery">
                                    ...
                                    <div class="form-group">
											...
											<select name="garantizado" class="form-control">
                                                ...
                                                <option value="9">Otro (explicar en Observaciones)</option>
    									    </select>
												</div>
											</div>
										</div>
