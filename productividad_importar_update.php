...
set_time_limit(0);
 do { 
				...
				$totalRows_villose = mysql_num_rows($villose);
 				...
 				if ($totalRows_villose > 0) { $sueldo_total_productividad = $row_tabulador['sueldo_mensual'];} else { $sueldo_total_productividad = $row_activos['sueldo_total'];} 
				...
				//echo 'IDempleado: '.$IDempleado.' | Antiguedad: '.$antiguedad.'<br/>';
...
header("Location: productividad_importar_update2.php?info=1"); 	

//echo "<a href='productividad_importar_update2.php?info=1'>Seguir...</a>";
