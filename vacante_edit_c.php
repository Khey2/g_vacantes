...
$ins_vac_vacante->registerTrigger("END", "Trigger_Default_Redirect", 99, "vacantes_cerradas.php?info=1");
// Add columns
...
$upd_vac_vacante->registerTrigger("END", "Trigger_Default_Redirect", 99, "vacantes_cerradas_bk.php?IDvacante={IDvacante}");
// Add columns
...
if ((isset($_GET['IDvacante_borrar'])) && ($_GET['IDvacante_borrar'] != "")) {
  ...
  header("Location: vacantes_cerradas.php?info=3");
}
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<select name="IDapoyo_<?php echo $cnt1; ?>" id="IDapoyo_<?php echo $cnt1; ?>" class="form-control" required="required">
												<option value="">Seleccione una opción</option> 
              <?php  do { ?>
              <option value="<?php echo $row_apoyo['IDapoyo']?>"<?php if (!(strcmp($row_apoyo['IDapoyo'], $row_rsvac_vacante['IDapoyo']))) 
			  {echo "SELECTED";} ?>><?php echo $row_apoyo['apoyo']?></option>
              <?php
