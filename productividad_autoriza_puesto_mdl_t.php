...
?>
                            <?php echo $row_puestos['emp_paterno']; ?> <?php echo $row_puestos['emp_materno']; ?> <?php echo $row_puestos['emp_nombre']; ?>                            
            					...
            					<form method="post" class="form-horizontal form-validate-jquery" name="form1" action="productividad_autoriza_puesto_t.php?IDpuesto=<?php echo $row_puestos['IDpuesto']; ?>" >
        ...
        <?php } while ($row_kpi63 = mysql_fetch_assoc($kpi63)); ?>
									...
									<div class="form-group">
									 ...
									 <?php if (in_array($el_puesto, $aplica_h_e)) {  ?>
									 <div class="form-group">
											<div class="form-group">
											 <div class="row">
