...
<body class= "<?php if (isset($_COOKIE["lmenu"])) { echo 'sidebar-xs';}?>  has-detached-right">
	...
	<div class="panel panel-flat">
		...
		<p>Selecciona al becario que deseas evaluar.</p>
		</div>

	<div class="media panel-body no-margin">
		<div class="media-body">
                                    
                <table class="table datatable-condensed table-bordered">
                    <thead> 
                    ...
                    <tbody>
						<?php do { ?>
						  <tr>
                            <td><?php echo $row_becarios_evaluar['IDempleado']; ?></td>
                            <td><?php echo $row_becarios_evaluar['emp_paterno']." ".$row_becarios_evaluar['emp_materno']." ".$row_becarios_evaluar['emp_nombre']; ?></td>
                            <td><?php echo $row_becarios_evaluar['tipo']; ?></td>
                            <td><?php echo $elmes; ?> <?php echo $anio; ?></td>
							<td><?php if ($row_becarios_evaluar['IDevaluacion'] == '') {echo "Sin evaluar";} else { echo "Evaluado";} ?></td>
                            <td>
							<a href="f_capa_becarios_evaluar.php?IDempleado=<?php echo $row_becarios_evaluar['IDempleado']; ?>&IDmes=<?php echo $el_mes; ?>&anio=<?php echo $anio; ?>&tipo=<?php echo $row_becarios_evaluar['IDtipo']; ?>" class="btn btn-info">Reporte Mensual</a>
							<a href="f_capa_becarios_evaluar_historico.php?IDempleado=<?php echo $row_becarios_evaluar['IDempleado']; ?>" class="btn btn-success">Histórico</a>
							<a href="#" class="btn btn-danger">Borrar</a>
							</td>
                          </tr>
						<?php } while ($row_becarios_evaluar = mysql_fetch_assoc($becarios_evaluar)); ?>
                     </tbody>
				</table>
