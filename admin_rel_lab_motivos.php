...
<div class="content">
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body">
							<p>Selecciona Motivo para editarlo.</p>
					</div>
                      ...
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_puestos['motivo']; ?></td>
                          <td><?php echo $row_puestos['tiempo']; ?></td>
                          <td><?php echo $row_puestos['instrucciones']; ?></td>
                         <td><button type="button" class="btn btn-primary" onClick="window.location.href='admin_rel_lab_motivos_edit.php?IDmotivo=<?php echo $row_puestos['IDmotivo']; ?>'">Editar</button> </td>
                        </tr>                       
                    ...
                    <a class="btn btn-primary" href="admin_rel_lab_motivos_edit.php">Agregar Motivo<i class="icon-arrow-right14 position-right"></i></a>
                    </div>
					</div>
					<!-- /colored button -->
