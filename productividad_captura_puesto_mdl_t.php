...
?>
                            ...
                            <?php if ($row_puestos['capturador'] == '') { ?>
            					...
            					<form method="post" class="form-horizontal form-validate-jquery" name="form1" action="productividad_captura_puesto_t.php?IDpuesto=<?php echo $row_puestos['IDpuesto']; ?>" >
