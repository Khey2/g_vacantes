								...
								<div class="tab-content">
										<div class="panel-body">
											<div class="content-group-lg">
												...
												<input type='submit' value='Terminar y Regresar' onclick="window.location='b_capa_cursos.php?IDmodulo=<?php echo $IDmodulo; ?>'" class="btn btn-success" id='button' disabled="disabled" name='button' data-time='<?php echo $row_capacitacionl['segundos']; ?>' />								
