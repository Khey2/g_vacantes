...
mysql_select_db($database_vacantes, $vacantes);
$query_matriz = "SELECT DISTINCT vac_matriz.matriz AS LaMatriz, vac_vacante.IDvacante, vac_vacante.ajuste_dias, vac_areas.dias, vac_areas.area, vac_vacante.IDestatus, vac_vacante.fecha_requi, vac_matriz.IDmatriz, vac_matriz.matriz, vac_usuarios.usuario_correo FROM  vac_vacante LEFT JOIN vac_areas ON vac_areas.IDarea = vac_vacante.IDarea LEFT JOIN vac_matriz ON vac_matriz.IDmatriz = vac_vacante.IDmatriz LEFT JOIN vac_usuarios ON vac_usuarios.IDmatriz = vac_matriz.IDmatriz WHERE  vac_usuarios.IDusuario_puesto = 128 OR  vac_usuarios.IDusuario_puesto = 121 GROUP BY vac_matriz.matriz";
...
$mail->addReplyTo('reporte_diario@gestionvacantes.com', 'Sistema de Gestion de Recursos Humanos');
...
<img width="100" border="0" style="display: block; width: 100px;" src="http://gestionvacantes.com/global_assets/images/logo_dark.png" alt="" />
</a>
</td>
</tr>
<tr>
...
<tr>
  <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
        <!-- section text ======-->
        <div style="line-height: 35px">Reporte de Vacantes <span style="color: #5caad2;">Diario</span></div>
    </td>
</tr>
<tr>
...
Estimado Usuario, a continuacion te enviamos el reporte diario de vacantes.</p>
<table  border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="ffffff" class="bg_color">
 <thead>
 <tr>
 <th>Matriz</th>
...
$elcorreo = $row_matriz['usuario_correo'];

mysql_select_db($database_vacantes, $vacantes);
$query_global = "SELECT vac_vacante.IDvacante, vac_vacante.ajuste_dias, vac_areas.dias, vac_areas.area, vac_vacante.IDestatus, vac_vacante.fecha_requi, vac_matriz.matriz FROM vac_vacante LEFT JOIN vac_areas ON vac_areas.IDarea = vac_vacante.IDarea INNER JOIN vac_matriz ON vac_matriz.IDmatriz = vac_vacante.IDmatriz WHERE vac_vacante.IDestatus = 1 AND vac_matriz.matriz = '$LaMatriz'";
