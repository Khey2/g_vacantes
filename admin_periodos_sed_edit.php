...
mysql_select_db($database_vacantes, $vacantes);
$query_puesto = "SELECT * FROM sed_periodos_sed WHERE IDperiodo = '$IDperiodo'";
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE sed_periodos_sed SET periodo=%s, visible=%s, estatus=%s WHERE IDperiodo=%s",
  ...
  $updateGoTo = "admin_periodos_sed.php?info=1";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  $insertSQL = sprintf("INSERT INTO sed_periodos_sed (periodo, visible, estatus) VALUES (%s, %s, %s)",
                       GetSQLValueString($_POST['periodo'], "text"),
                       GetSQLValueString($_POST['visible'], "int"),
                       GetSQLValueString($_POST['estatus'], "int"));
  ...
  $insertGoTo = "admin_periodos_sed.php?info=2";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['IDperiodo_borrar'])) {
  ...
  $deleteSQL = "DELETE FROM sed_periodos_sed WHERE IDperiodo ='$borrado'";

  mysql_select_db($database_vacantes, $vacantes);
  $result = mysql_query($deleteSQL, $vacantes) or die(mysql_error());
  header("Location: admin_periodos_sed.php?info=3");
}
                ...
                <div class="content">
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body">
                            ...
                            <form method="post" name="form1" action="admin_periodos_sed_edit.php" class="form-horizontal form-validate-jquery">
                        ...
                        required="required">
                              ...
                              <?php  if (isset($_GET['IDperiodo'])) { ?>
                                            ...
                                            <option value="0" <?php if (!(strcmp(0, htmlentities($row_puesto['visible'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>NO</option>
                              <?php } else { ?>
                              ...
                              <?php  if (isset($_GET['IDperiodo'])) { ?>
                                            ...
                                            <option value="1" <?php if (!(strcmp(1, htmlentities($row_puesto['estatus'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Captura</option>
                                            <option value="2" <?php if (!(strcmp(2, htmlentities($row_puesto['estatus'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Evaluacion</option>
                                            <option value="3" <?php if (!(strcmp(3, htmlentities($row_puesto['estatus'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Cerrado</option>
                              <?php } else { ?>
                                           <option value="">Seleccione...</option>
                                           <option value="1">Captura</option>
                                           <option value="2">Evaluacion</option>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="admin_periodos_sed_edit.php?IDperiodo_borrar=<?php echo $row_puesto['IDperiodo']; ?>">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
