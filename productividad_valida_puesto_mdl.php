...
?>
                            <?php echo $row_puestos['emp_paterno']; ?> <?php echo $row_puestos['emp_materno']; ?> <?php echo $row_puestos['emp_nombre']; ?>                            
            					...
            					<form method="post" class="form-horizontal form-validate-jquery" name="form1" action="productividad_valida_puesto.php?IDpuesto=<?php echo $row_puestos['IDpuesto']; ?>" >
                                    ...
                                    <input type="hidden" name="validador" value="<?php echo $row_usuario['IDusuario']; ?>" >
										...
										<label class="control-label col-sm-3" data-popup="tooltip-custom" title="QUITAR INCAPACIDADES O DESCANSOS CON PERMISO">DIAS LABORADOS</label>
											...
											<div class="form-group">
		 									 <div class="row">
												...
												<div class="col-sm-9">
											<select name="a1" class="form-control" required="required" <?php if ($prod_captura_tipo == 2) { echo "disabled"; }?>>
        <?php  do {  ?>
      ...
      <?php if ($prod_captura_tipo == 2) { echo "<input type='hidden' name='a1' value=".$row_puestos['a1'].">"; }?>
												</div>
											</div>
										</div>
										...
										<?php if($totalRows_kpi23 != 0) { ?>
											<div class="form-group">
		 									 <div class="row">
												...
												<div class="col-sm-9">
											<select name="a2" class="form-control" required="required" <?php if ($prod_captura_tipo == 2) { echo "disabled"; }?>>
        <?php  do {  ?>
      ...
      <?php if ($prod_captura_tipo == 2) { echo "<input type='hidden' name='a2' value=".$row_puestos['a2'].">"; }?>
												</div>
											</div>
										</div>
										<?php } ?>
										...
										<?php if($totalRows_kpi33 != 0) { ?>
											<div class="form-group">
		 									 <div class="row">
												...
												<div class="col-sm-9">
											<select name="a3" class="form-control" required="required" <?php if ($prod_captura_tipo == 2) { echo "disabled"; }?>>
        <?php  do {  ?>
      ...
      <?php if ($prod_captura_tipo == 2) { echo "<input type='hidden' name='a3' value=".$row_puestos['a3'].">"; }?>
												</div>
											</div>
										</div>
										<?php } ?>
										...
										<?php if($totalRows_kpi43 != 0) { ?>
											<div class="form-group">
		 									 <div class="row">
												...
												<div class="col-sm-9">
											<select name="a4" class="form-control" required="required" <?php if ($prod_captura_tipo == 2) { echo "disabled"; }?>>
        <?php  do {  ?>
      ...
      <?php if ($prod_captura_tipo == 2) { echo "<input type='hidden' name='a4' value=".$row_puestos['a4'].">"; }?>
												</div>
											</div>
										</div>
										<?php } ?>
										...
										<?php if($totalRows_kpi53 != 0) { ?>
											<div class="form-group">
		 									 <div class="row">
												...
												<div class="col-sm-9">
											<select name="a5" class="form-control" required="required" <?php if ($prod_captura_tipo == 2) { echo "disabled"; }?>>
        <?php  do {  ?>
      ...
      <?php if ($prod_captura_tipo == 2) { echo "<input type='hidden' name='a5' value=".$row_puestos['a5'].">"; }?>
												</div>
											</div>
										</div>
										<?php } ?>
										...
										<?php if($totalRows_kpi63 != 0) { ?>
											<div class="form-group">
		 									 <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="<?php echo $row_kpi52['c']?>"><?php echo $row_kpi51['c']?>:<span class="text-danger">*</span></label>
												<div class="col-sm-9">
											<select name="a6" class="form-control" required="required" <?php if ($prod_captura_tipo == 2) { echo "disabled"; }?>>
        <?php  do {  ?>
      ...
      <?php if ($prod_captura_tipo == 2) { echo "<input type='hidden' name='a6' value=".$row_puestos['a6'].">"; }?>
												</div>
											</div>
										</div>
										<?php } ?>
									...
									<?php if( $row_usuario['user_prod_adicionales'] == 1) { ?>
											<div class="form-group">
											 <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="% DE PAGO ADICIONAL">ADICIONAL ($)</label>
												<div class="col-sm-9">
													<input type="number" name="adicional"  value="<?php echo htmlentities($row_puestos['adicional'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
                                                </div>
											</div>
										</div>
									<?php } else { ?>
											<div class="form-group">
											 <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="% DE PAGO ADICIONAL">ADICIONAL ($)</label>
												<div class="col-sm-9">
													<input type="number" name="adicional" <?php if( $row_matriz['adicionales'] == 0) { echo "disabled='disabled'";} ?> value="<?php echo htmlentities($row_puestos['adicional'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
