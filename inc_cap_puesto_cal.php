...
$matrices_choferes2024 = array(13,16,17,18,19,1,21,26,3);
...
if (!in_array($el_puesto, $op_sistemas)) {
	...
	$horas = 0;
	$dias = $row_captura['dias2'];
	$sueldo_hora = $sueldo_diario / 2;
	$inc2 = $sueldo_hora * $dias;
...
elseif ($tipo == 3) {
	...
	$IDmotivo3 = $row_captura['IDmotivo3'];
	...
	if ($IDmotivo3 == 30 AND in_array($la_matriz, $matrices_choferes2024)) {
