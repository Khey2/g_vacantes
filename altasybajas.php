...
mysql_select_db($database_vacantes, $vacantes);
$query_puestos = "SELECT * FROM vac_puestos ORDER BY denominacion DESC";
$puestos = mysql_query($query_puestos, $vacantes) or die(mysql_error());
$row_puestos = mysql_fetch_assoc($puestos);
$totalRows_puestos = mysql_num_rows($puestos);

mysql_select_db($database_vacantes, $vacantes);
$query_lmatriz = "SELECT * FROM vac_matriz WHERE IDmatriz NOT IN (27, 31)";
$lmatriz = mysql_query($query_lmatriz, $vacantes) or die(mysql_error());
$row_lmatriz = mysql_fetch_assoc($lmatriz);
$totalRows_lmatriz = mysql_num_rows($lmatriz);

mysql_select_db($database_vacantes, $vacantes);
$query_lfech = "Select * from ind_bajas WHERE fecha_alta  = ( SELECT MAX(fecha_alta) FROM ind_bajas )";
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Consulta de movimientos</h5>
						</div>

						<div class="panel-body">
							<p class="content-group-lg">Selecciona los criterios de descarga de la consulta de empleados.</br>
                           La información se actualiza de forma mensual, a inicios de cada mes.</br>
                           <strong> Fecha de última actualización:</strong> <?php echo date('d/m/Y', strtotime($fecha_maxima));?></p>

							<form class="form-horizontal" action="altasybajas_reporte.php" method="POST">
								<fieldset class="content-group">
									<legend class="text-bold">Criterios</legend>

									<div class="form-group">
										<label class="control-label col-lg-2">Tipo de reporte:</label>
										<div class="col-lg-10">
											<select name="el_tipo" data-placeholder="Selecciona" class="select" required="required">
                                               <option value="1">ACTIVOS</option>
                                               <option value="2">BAJAS</option>
                                               <option value="3">ALTAS</option>
                                               <option value="4">ALTAS Y BAJAS</option>
											</select>
										</div>
									</div>

									<div class="form-group">
										<label class="control-label col-lg-2">Niveles:</label>
										<div class="col-lg-10">
										<select class="multiselect" multiple="multiple" id="nivel[]" name="nivel[]" required="required">
											<option value="1">DG Y VPS</option>
											<option value="2">DIRECTOR</option>
											<option value="3">GERENTE</option>
											<option value="4">JEFE DE AREA</option>
											<option value="5">COORDINADOR/SUPERVISOR/ENCARGADO</option>
											<option value="6">ANALISTA</option>
											<option value="7">AUXILIAR</option>
											<option value="8">OPERATIVO</option>
										</select>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<select class="multiselect" multiple="multiple" id="el_area[]" name="el_area[]" required="required">
											<?php do { ?>
									...
									<div class="form-group">
 									...
 									<div class="form-group">
										<label class="control-label col-lg-2">Puesto:</label>
										<div class="col-lg-10">
										<select class="multiselect" multiple="multiple" id="puesto[]" name="puesto[]" required="required">
                                               <?php do {  ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<select name="el_anio" data-placeholder="Selecciona" class="select" required="required">
                                               <?php do {  ?>
                                               <option value="<?php echo $row_anio['IDanio']?>"><?php echo $row_anio['anio']?></option>
                                               <?php
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<select name="el_mes" data-placeholder="Selecciona" class="select" required="required">
                                               <?php do {  ?>
...
<p>Para dudas o comentarios, contactanos por correo a <a href="mailto:jacardenas@sahuayo.mx">jacardenas@sahuayo.mx</a></p>
