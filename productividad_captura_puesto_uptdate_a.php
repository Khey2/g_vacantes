...
echo "Nivel Caja:".$IDnivel_caja."<br/><br/> ";
...
echo "monto_T: " . $monto_T . "</br>";
echo "porc_pago: " . $porc_pago . "</br>";

$query1 = "UPDATE prod_captura SET adicional3 = '$diferencia1', pago_resto = '$diferencia2', bono_asistencia = '$bono_asistencia', pago = '$porc_pago', pago_total = '$monto_T', reci = '$reci', carg = '$carg', esti = '$esti', dist = '$dist' WHERE IDcaptura = '$IDcaptura'"; 
