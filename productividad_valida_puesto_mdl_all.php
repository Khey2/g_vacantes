...
?>
                            <?php echo $row_puestos['emp_paterno']; ?> <?php echo $row_puestos['emp_materno']; ?> <?php echo $row_puestos['emp_nombre']; ?>                            
            					...
            					<form method="post" class="form-horizontal form-validate-jquery" name="form1" action="productividad_valida_puesto_all.php?IDpuesto=<?php echo $row_puestos['IDpuesto']; ?>" >
									...
									<?php if( $row_usuario['user_prod_adicionales'] == 1) { ?>
											<div class="form-group">
											 <div class="row">
												...
												<div class="col-sm-9">
													<input type="number" name="adicional" maxlength="2" value="<?php echo htmlentities($row_puestos['adicional'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
                                                </div>
											</div>
										</div>
									<?php } else { ?>
