...
mysql_select_db($database_vacantes, $vacantes);
$query_puestos = "SELECT * FROM sed_periodos_sed";
...
<div class="content">
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body">
                      ...
                      <?php do {   ?>
                        <tr>
                          ...
                          <td><?php if ($row_puestos['estatus'] == 1) {echo "Captura";} elseif ($row_puestos['estatus'] == 2) {echo "Evaluación";} else{ echo "Cerrado";} ?></td>
                         <td><button type="button" class="btn btn-primary" onClick="window.location.href='admin_periodos_sed_edit.php?IDperiodo=<?php echo $row_puestos['IDperiodo']; ?>'">Editar</button> </td>
                        </tr>                       
                    ...
                    <a class="btn btn-primary" href="admin_periodos_sed_edit.php">Agregar Periodo<i class="icon-arrow-right14 position-right"></i></a>
                    </div>
					</div>
					<!-- /colored button -->
