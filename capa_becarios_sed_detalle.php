...
$query_mis_metas = "SELECT * FROM capa_becarios_sed WHERE capa_becarios_sed.IDempleado = $IDempleado"; 
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  header("Location: capa_becarios_sed.php?IDempleado=$IDempleado&info=2");
}
...
$insertSQL = sprintf("INSERT INTO capa_becarios_sed (IDempleado, IDevaluador, mi_mi, mi_IDunidad, mi_3, mi_2, mi_1, fecha_captura, fecha_termino, estatus)
  ...
  header("Location: capa_becarios_sed.php?IDempleado=$IDempleado&info=1");
}
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  ...
  mysql_select_db($database_vacantes, $vacantes);
  $Result1 = mysql_query($updateSQL, $vacantes) or die(mysql_error());
  header("Location: capa_becarios_sed.php?IDempleado=$IDempleado&info=4");
}
...
if ((isset($_GET['borrar'])) && ($_GET['borrar'] != "")) {
  ...
  header("Location:  capa_becarios_sed.php?IDempleado=$IDempleado&info=3");
}
...
if ((isset($_GET['cerrar'])) && ($_GET['cerrar'] != "")) {
  ...
  mysql_select_db($database_vacantes, $vacantes);
  $result = mysql_query($deleteSQL, $vacantes) or die(mysql_error());
  header("Location:  capa_becarios_sed.php?IDempleado=$IDempleado&info=5");
}
...
<?php $count = 1;  do { $IDmeta = $row_mis_metas['IDmeta']; ?>
								...
								<div class="panel-heading">
									...
									<div class="heading-elements">
										<ul class="list-inline list-inline-separate">
											...
											<?php }  else if ($row_mis_metas['estatus'] == 9) { ?>
											<span class='label label-warning'>Borrado</span>
											<?php }  else { ?>
					...
					<div id="actualizar<?php echo $row_mis_metas['IDmeta']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog modal-lg">
							<div class="modal-content text-center">
            					...
            					<form method="post" class="form-horizontal form-validate-jquery" name="form1" action="capa_becarios_sed.php?IDempleado=<?php echo $IDempleado; ?>" > 
					...
					<div id="actualizar3<?php echo $row_mis_metas['IDmeta']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog modal-lg">
            				...
            				<form method="post" class="form-horizontal form-validate-jquery" name="form2" action="capa_becarios_sed.php?IDempleado=<?php echo $IDempleado; ?>" > 
                                <fieldset class="content-group">
                                <div class="modal-body">
					...
					<div id="borrar<?php echo $row_mis_metas['IDmeta']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                    <a class="btn btn-danger" href="capa_becarios_sed.php?IDempleado=<?php echo $IDempleado; ?>&IDmeta=<?php echo $row_mis_metas['IDmeta']; ?>&borrar=1">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
									<?php if ($row_mis_metas['estatus'] == 1) { ?>   
                                    <a class="btn btn-info" href="capa_becarios_sed.php?IDempleado=<?php echo $IDempleado; ?>&IDmeta=<?php echo $row_mis_metas['IDmeta']; ?>&estatus=0&cerrar=1">Si Cambiar</a>
									<?php } else { ?>   
                                    <a class="btn btn-info" href="capa_becarios_sed.php?IDempleado=<?php echo $IDempleado; ?>&IDmeta=<?php echo $row_mis_metas['IDmeta']; ?>&estatus=1&cerrar=1">Si Cambiar</a>
									<?php }  ?>   
								</div>
							</div>
						</div>
							...
							<div class="sidebar-content">
								...
								<div class="sidebar-category">
									...
									<div class="category-content">
										...
										<button type="button" onClick="window.location.href='capa_becarios_sed.php'" class="btn btn-info btn-block content-group">Regresar</button>

																	
										<form method="post" name="form1" action="capa_becarios_sed.php?IDempleado=<?php echo $IDempleado; ?>" > 
										<div class="col-lg-8">
											<select name="estatus" id="estatus" class="form-control">
												...
												<option value="9"<?php if ($estatus == 9) {echo "SELECTED";} ?>>Borrado</option> 
											</select>
										</div>
										<div class="col-lg-4">
