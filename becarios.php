...
<head>
	...
	<link href="assets/css/components.minb.css" rel="stylesheet" type="text/css">
				 ...
				 <div>&nbsp;</div>	
					...
					<form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>">
							<div class="text-center">
							 <div>&nbsp;</div>	
								<div><a href="index.php"><img src="assets/img/logo_sahuayo.png" width="219" height="60" alt="logo"></a></div>
							 <div>&nbsp;</div>	
							  <h5 class="content-group-lg">Acceso<small class="display-block">Becarios</small></h5>
							</div>

							<div class="form-group has-feedback has-feedback-left">
								<input type="text" class="form-control" name="kt_login_user" id="kt_login_user" placeholder="Correo" value="<?php if(isset($_POST['kt_login_user'])) {echo KT_escapeAttribute($_POST['kt_login_user']); } ?>" required="required">
							...
							<div class="form-group login-options">
								<div class="row">
									...
									<div class="col-sm-12 text-right">
									  <a href="mailto:jacardenas@sahuayo.mx">Olvidase tu Password?</a>
									</div>
								</div>
							</div>

						  <div class="form-group">
                              <button type="submit" name="kt_login1" id="kt_login1" class="btn btn-info btn-block">Acceder<i class="icon-circle-right2 position-right"></i></button>
						  </div>
						  
						<div>&nbsp;</div>
						<div class="content-divider text-muted form-group"><span>Aviso</span></div>
