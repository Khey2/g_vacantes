...
mysql_select_db($database_vacantes, $vacantes);
$query_lmatriz = "SELECT * FROM vac_matriz WHERE IDmatriz IN ($la_matriz)";
$lmatriz = mysql_query($query_lmatriz, $vacantes) or die(mysql_error());
$row_lmatriz = mysql_fetch_assoc($lmatriz);
$totalRows_lmatriz = mysql_num_rows($lmatriz);

//el examen contestado
if($row_lmatriz['nom35_g2'] == 2){$IDexmen = 3;} else {$IDexmen = 2;}
...
mysql_select_db($database_vacantes, $vacantes);
$query_resultados1 = "SELECT DISTINCT IDempleado FROM nom35_resultados WHERE IDmatriz IN ($la_matriz) AND IDexamen = 1";
...
mysql_select_db($database_vacantes, $vacantes);
$query_resultados3 = "SELECT DISTINCT IDempleado FROM nom35_resultados WHERE IDmatriz IN ($la_matriz) AND IDexamen = $IDexmen";
...
//activos
mysql_select_db($database_vacantes, $vacantes);
$query_resultadosa1 = "SELECT * FROM prod_activos WHERE IDmatriz IN ($la_matriz)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_resultadosa3 = "SELECT * FROM prod_activos WHERE IDmatriz IN ($la_matriz)";
...
//RESULTADOS TOTALES
mysql_select_db($database_vacantes, $vacantes);
$query_total_c = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_categoria1 = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND nom35_respuestas.IDcategoria = 1 AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_categoria2 = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND nom35_respuestas.IDcategoria = 2 AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_categoria3 = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND nom35_respuestas.IDcategoria = 3 AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_categoria4 = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND nom35_respuestas.IDcategoria = 4 AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_categoria5 = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND nom35_respuestas.IDcategoria = 5 AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_dominio1 = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND nom35_respuestas.IDdominio = 1 AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_dominio2 = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND nom35_respuestas.IDdominio = 2 AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_dominio3 = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND nom35_respuestas.IDdominio = 3 AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_dominio4 = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND nom35_respuestas.IDdominio = 4 AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_dominio5 = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND nom35_respuestas.IDdominio = 5 AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
//DOMINIO 6 Liderazgo
mysql_select_db($database_vacantes, $vacantes);
$query_dominio6 = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND nom35_respuestas.IDdominio = 6 AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_dominio7 = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND nom35_respuestas.IDdominio = 7 AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
//DOMINIO 8 Violencia
mysql_select_db($database_vacantes, $vacantes);
$query_dominio8 = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND nom35_respuestas.IDdominio = 8 AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_dominio9 = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND nom35_respuestas.IDdominio = 9 AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_dominio10 = "SELECT nom35_respuestas.IDrespuesta, nom35_respuestas.IDempleado, nom35_respuestas.IDexamen, nom35_respuestas.IDpregunta, nom35_respuestas.IDperiodo, SUM(nom35_respuestas.respuesta) AS Respuesta, nom35_respuestas.IDcategoria, nom35_respuestas.IDdominio, nom35_respuestas.IDdimension, prod_activos.IDmatriz FROM nom35_respuestas INNER JOIN prod_activos ON nom35_respuestas.IDempleado = prod_activos.IDempleado WHERE nom35_respuestas.IDexamen = $IDexmen AND nom35_respuestas.IDdominio = 10 AND prod_activos.IDmatriz IN ($la_matriz)  AND nom35_respuestas.pregunta_tipo <> 3  GROUP BY nom35_respuestas.IDempleado"; 
...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title">Resultados NOM035 por Sucursal</h5>
    </div>
        <div class="panel-body">
        <h5>Filtro</h5>
        
        <form method="POST" action="admins_n35s.php">
			<table class="table">
				<tr>
                <td>
					...
					<a href="admins_n35s.php" class="btn btn-default">Borrar filtro</a>	&nbsp;&nbsp;
                    <a href="admins_n35s_print.php?IDmartiz=<?php echo str_replace(' ', '', $la_matriz); ?>" target="_blank" class="btn btn-success">Imprimir</a>						
					</td>
					</tr>
		    </table>
		</form>
    ...
    <div class="panel-heading">
        ...
        <ul>
           ...
           $cadena3 = $la_matriz; $array3 = explode(", ", $cadena3); 
            ...
            <li><b>No. de Empleados evaludos:</b> <?php echo $totalRows_resultados1;?> (<?php echo round($totalRows_resultados1/$totalRows_resultadosa1*100,0);?>%)</li>
        </ul>
