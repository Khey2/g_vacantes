...
echo $el_usr = $row_usuario['IDusuario'];


   $sql_ = "UPDATE prod_captura SET validador = '$el_usr' WHERE semana = '$semana'  AND anio = '$anio'";
   $sql_ = mysql_query($sql_) or die(mysql_error());  
  
   $sql_2 = "UPDATE prod_captura SET validador = '$el_usr' WHERE semana = '$semana'  AND anio = '$anio'";
   $sql_2 = mysql_query($sql_2) or die(mysql_error());  
  
 header('Location:productividad_valida.php');
