...
$upd_vac_vacante->registerTrigger("END", "Trigger_Default_Redirect", 99, "vacantes_activas.php?info=2");
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Vacante Cerrada</h5>
						</div>

					<div class="panel-body">
					<p>Consulta de vacante cerrada.</br>
                  <p>&nbsp;</p>
                    <div>
                    <div>
                              ...
                              <?php } ?>
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<select name="IDrequi_<?php echo $cnt1; ?>" id="IDrequi_<?php echo $cnt1; ?>" class="form-control" readonly="readonly">
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<select name="IDarea_<?php echo $cnt1; ?>" id="IDarea_<?php echo $cnt1; ?>" class="form-control" readonly="readonly">
                                    ...
                                    <span class="input-group-addon"><i class="icon-calendar22"></i></span>
                                    	<input type="text" class="form-control  daterange-single" name="fecha_baja_<?php echo $cnt1; ?>" id="fecha_baja_<?php echo $cnt1; ?>" value="<?php if ($row_rsvac_vacante['fecha_baja'] == "") { echo "";} else  { echo KT_formatDate($row_rsvac_vacante['fecha_baja']); }?>" required="required" readonly="readonly">
									</div>
                                   </div>
                                  </div> 
									<!-- Fecha -->
			                        ...
			                        <div class="input-group">
                                    <span class="input-group-addon"><i class="icon-calendar22"></i></span>
                                    	<input type="text" class="form-control  daterange-single" name="fecha_requi_<?php echo $cnt1; ?>" id="fecha_requi_<?php echo $cnt1; ?>" value="<?php if ($row_rsvac_vacante['fecha_requi'] == "") { echo "";} else  { echo KT_formatDate($row_rsvac_vacante['fecha_requi']); }?>" required="required" readonly="readonly">
									</div>
                                   </div>
                                  </div> 
							<!-- Fecha -->
			                        ...
			                        <div class="input-group">
                                    <span class="input-group-addon"><i class="icon-calendar22"></i></span>
                                    	<input type="text" class="form-control  daterange-single" name="fecha_ocupacion_<?php echo $cnt1; ?>" id="fecha_ocupacion_<?php echo $cnt1; ?>" value="<?php if ($row_rsvac_vacante['fecha_ocupacion'] == "") { echo "";} else  { echo KT_formatDate($row_rsvac_vacante['fecha_ocupacion']); }?>" readonly="readonly">
									</div>
                                   </div>
                                  </div> 
									<!-- Fecha -->
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<select name="IDmotivo_v_<?php echo $cnt1; ?>" id="IDmotivo_v_<?php echo $cnt1; ?>" class="form-control" required="required" readonly="readonly">
												<option value="">Seleccione una opción</option> 
											  <?php  do { ?>
                               ...
                               <?php  if (@$_GET['IDvacante'] != "") { ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
						<input type="text" name="candidato_electo_<?php echo $cnt1; ?>" id="candidato_electo_<?php echo $cnt1; ?>" class="form-control" placeholder="Indica el nombre del candidato ganador." value="<?php echo KT_escapeAttribute($row_rsvac_vacante['candidato_electo']); ?>" readonly="readonly">
										</div>
									</div>
									<!-- /basic text input -->
                                    <?php }  ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
						<input type="text" name="reemplazo_de_<?php echo $cnt1; ?>" id="reemplazo_de_<?php echo $cnt1; ?>" class="form-control" placeholder="Indica el último ocupante." value="<?php echo KT_escapeAttribute($row_rsvac_vacante['reemplazo_de']); ?>" readonly="readonly">
										</div>
									</div>
									<!-- /basic text input -->
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
						<input type="number" name="ajuste_dias_<?php echo $cnt1; ?>" id="ajuste_dias_<?php echo $cnt1; ?>" class="form-control" placeholder="Indica los días de ajuste." value="<?php echo KT_escapeAttribute($row_rsvac_vacante['ajuste_dias']); ?>" readonly="readonly">
										</div>
									</div> 
									<!-- /basic text input -->
                                    <?php }  ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
						<input type="text" name="candidatos_reclutados_<?php echo $cnt1; ?>" id="candidatos_reclutados_<?php echo $cnt1; ?>" class="form-control" placeholder="Indique el número de candidatos reclutados." value="<?php echo KT_escapeAttribute($row_rsvac_vacante['candidatos_reclutados']); ?>" readonly="readonly">
										</div>
									</div>
									<!-- /basic text input -->
                                    <?php }  ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
						<input type="number" name="sueldo_<?php echo $cnt1; ?>" id="sueldo_<?php echo $cnt1; ?>" class="form-control" placeholder="Ingresa el sueldo autorizado."  required="required" value="<?php echo KT_escapeAttribute($row_rsvac_vacante['sueldo']); ?>" readonly="readonly">
										</div>
									</div>
									<!-- /basic text input -->
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<select name="IDmotivo_baja_<?php echo $cnt1; ?>" id="IDmotivo_baja_<?php echo $cnt1; ?>" class="form-control" required="required" readonly="readonly">
												<option value="">Seleccione una opción</option> 
												  <?php  do { ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<select name="IDmatriz_<?php echo $cnt1; ?>" id="IDmatriz_<?php echo $cnt1; ?>" class="form-control" required="required" readonly="readonly">
                                            	<option value="">Seleccione una opción</option> 
													  <?php do {  ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<select name="IDestatus_<?php echo $cnt1; ?>" id="IDestatus_<?php echo $cnt1; ?>" class="form-control" required="required" readonly="readonly">
												<option value="">Seleccione una opción</option> 
												  <?php  do { ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<select name="IDapoyo_<?php echo $cnt1; ?>" id="IDapoyo_<?php echo $cnt1; ?>" class="form-control" required="required" readonly="readonly">
                                            	<option value="">Seleccione una opción</option> 
													  <?php do {  ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<select name="IDturno_<?php echo $cnt1; ?>" id="IDturno_<?php echo $cnt1; ?>" class="form-control" required="required" readonly="readonly">
												<option value="">Seleccione una opción</option> 
												  <?php  do { ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<select name="IDfuente_<?php echo $cnt1; ?>" id="IDfuente_<?php echo $cnt1; ?>" class="form-control" readonly="readonly">
												<option value="">Seleccione una opción</option> 
													  <?php  do { ?>
                            ...
                            <!-- Basic text input -->
								  <div class="form-group">
										...
										<div class="col-lg-9">
                                          <textarea  readonly="readonly" name="observaciones_<?php echo $cnt1; ?>" rows="3" class="form-control" id="observaciones_<?php echo $cnt1; ?>" placeholder="Observaciones y si aplica, explicación de ajuste de dias."><?php echo KT_escapeAttribute($row_rsvac_vacante['observaciones']); ?></textarea>
                          ...
                          <div class="text-right">
                            <div>
                         <button type="button" onClick="window.location.href='vacantes_cerradas.php'" class="btn btn-default btn-icon">Regresar</button>
                            </div>
                          </div>
                       </fieldset>
                       </form>
