...
<div class="content">
                  ...
                  <div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Reporte de Resultado por Usuario</h5>
						</div>

					<div class="panel-body">
                            <p>A continuación podrás consultar el reporte de indicadores por Usuario (sucursal) y mes.</p>
                            <p>Selecciona el mes y usuario de filtrado.</p>
                            ...
                            <p><strong>Total: </strong><?php echo $f; ?></p>
							


                            <p>&nbsp;</p>
												<form method="POST" action="admin_indicadores.php">
					...
					<table class="table">
							...
							<td>
                                           ...
                                           <select name="IDusuario" class="form-control">
                                               <?php do {  ?>
                                               <option value="<?php echo $row_usuarios['IDusuario']?>"<?php if (!(strcmp($row_usuarios['IDusuario'], $userr))) {echo "selected=\"selected\"";} ?>><?php echo $row_usuarios['usuario_nombre'] . " " . $row_usuarios['usuario_parterno'] . " " .$row_usuarios['usuario_materno'] . " (" . $row_usuarios['matriz'] . ")";  ?></option>
                                               <?php
