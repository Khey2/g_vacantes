...
mysql_select_db($database_vacantes, $vacantes);
$query_periodos = "SELECT * FROM sed_clima_periodos";
mysql_query("SET NAMES 'utf8'");
...
$resultados = $row_lmatriz['clima'];

mysql_select_db($database_vacantes, $vacantes);
$query_elperiodo = "SELECT * FROM sed_clima_periodos WHERE IDmatriz = $IDmatriz";
...
$_SESSION['IDperiodo'] = $row_elperiodo['IDperiodo']; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_abiertos_mas = "SELECT IDrespuesta AS respuestas FROM sed_clima WHERE sed_clima.IDmatriz = '$IDmatriz' AND IDperiodo = $IDperiodo AND sed_clima.IDpregunta = 93 AND length(IDrespuesta) > 10 AND
(
IDrespuesta <> 'nada' 
OR IDrespuesta <> 'ninguna' 
OR IDrespuesta <> '.' 
OR IDrespuesta <> '..'
OR IDrespuesta <> '...'
OR IDrespuesta <> 'Nada'
...
mysql_select_db($database_vacantes, $vacantes);
$query_abiertos_menos = "SELECT IDrespuesta AS respuestas FROM sed_clima WHERE sed_clima.IDmatriz = '$IDmatriz' AND sed_clima.IDpregunta = 94 AND IDperiodo = $IDperiodo AND length(IDrespuesta) > 10 AND
(
IDrespuesta <> 'nada' 
OR IDrespuesta <> 'ninguna' 
OR IDrespuesta <> '.' 
...
<?php if ($resultados == 1) { ?>
					...
					<div class="row">
						...
						<div class="panel panel-flat">	
							<div class="panel-body">
								...
								<p><a href="clima_resultados_print2.php" class="btn btn-success btn-xs">Imprimir</a></p>
							</div>
						</div>
							...
							<div class="panel panel-flat">	
								<div class="panel-heading">
									<h1 class="panel-title text-danger">Dimensión Empresa</h1>
								</div>
							<div class="panel-body">
							...
							<div class="panel panel-flat">	
								<div class="panel-heading">
									<h1 class="panel-title text-success">Dimensión Colaboradores</h1>
								</div>
							<div class="panel-body">
						...
						<div class="panel panel-flat">	
							...
							<table class="table table-hover">
                    			<thead>
                                    ...
                                    <th>Positivos (<?php echo $totalRows_abiertos_mas; ?>)</th>
                                  </tr>
</thead>
                                <tbody>
								  <?php do { ?>
							...
							<table class="table table-hover">
                    			<thead>
                                	<tr class="bg-slate-700"> 
                                    <th>Negativos (<?php echo $totalRows_abiertos_menos; ?>)</th>
                                  </tr>
</thead>
                                <tbody>
								  <?php do { ?>
					...
					<div class="col-lg-3">
							...
							<div class="panel panel-flat">
								...
								<h2 class="progress-percentage mt-15 mb-5 text-semibold"><?php echo $calificacion_sucursal * 100;?>%</h2>
							...
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Dimensiones</h6>
								</div>

								<div class="panel-body">
									
										<img src="assets/img/circulo_clima.png" class="img-responsive" alt="Sahuayo">
                ...
                Universo Aplicable <span class="label border-right-danger label-striped label-striped-right"><?php echo $row_plantilla['plantilla']; ?></span></a>
                <a href="#" class="list-group-item"><i class="icon-user-check"></i>
                Encuestas <span class="label border-right-info label-striped label-striped-right"><?php  echo $totalRows_encuestas; ?></span></a>
                <a href="#" class="list-group-item"><i class="icon-reading"></i> % de Participación <span class="badge badge-danger pull-right"><?php  echo round(($totalRows_encuestas/$row_plantilla['plantilla']) * 10),0; ?>%</span></a>
                <div class="list-group-divider"></div>
                <a href="mailto:mahernandez@sahuayo.mx" class="list-group-item"><i class="icon-mail5"></i> Contacto</a>
								</div>
							</div>
							<!-- /navigation -->
