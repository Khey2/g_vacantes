...
$link = "asistencias_editA.php?anio=".$year."&mes=".$month."&IDfecha=".$day;
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							Selecciona el mes y el año para Filtrar el Calendario. <br />
							Da clic en el día para CAPTURAR la asistencia.<br />
