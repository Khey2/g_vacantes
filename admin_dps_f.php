...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  header("Location: admin_dps_f.php?info=1&IDpuesto=$IDpuesto");
}
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  header("Location: admin_dps_f.php?info=2&IDpuesto=$IDpuesto");
}
				...
				<!-- Detached content -->
                  ...
                  <div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Descriptivo de Puesto - Indicadores de Gestión</h5>
						</div>

					<div class="panel-body">

			<p><strong>Instrucciones</strong></p>
			<p>Los indicadores de gestión permiten evaluar los resultados obtenidos por el puesto.<br/>
            Para lo anterior, se requiere que se determinen claramente la unidad de medida y fórmula de cálculo.</p>

				<table class="table datatable-button-html5-basic">
		          <thead>
                    <tr> 
		              <th class="col-lg-4">Definición</th>
		              <th class="col-lg-4">Inidicador / Fórmula</th>
                ...
                <?php 	if ($totalRows_puesto_catalogos == 0) { ?>
                   <tr>
                     <td colspan="4">No se encontraron indicadores capturados.</td>
                   </tr>
                <?php } else { ?> 
                 <?php  do {  ?>
		          <tr>
		            <td><?php echo $row_puesto_catalogos['criterio_a'];?></td>
                    ...
                    <fieldset class="content-group">
								...
								<div class="modal-body">
								  ...
								  <div class="form-group">
										<label class="control-label col-lg-3">Definición:*</label>
										<div class="col-lg-9">
                                        <textarea rows="4" class="form-control" id="criterio_a" name="criterio_a" placeholder="Cómo lo hace"
                                             required="required"><?php echo $row_puesto_catalogos['criterio_a']; ?></textarea>                         
										</div>
									</div>
									<!-- /basic text input -->
<p>&nbsp;</p>
                                       ...
                                       <!-- Basic text input -->
								  <div class="form-group">
										<label class="control-label col-lg-3">Inidicador:*</label>
										<div class="col-lg-9">
                                        <textarea rows="4" class="form-control" id="criterio_b" name="criterio_b" placeholder="Para que lo hace"
...
<p>&nbsp;</p>
								  ...
								  <div class="form-group">
                                        ...
                                        <select name="criterio_c" id="criterio_c" class="form-control" required="required">
											<option value="Tiempo"<?php if (!(strcmp($row_puesto_catalogos['criterio_c'], 'Tiempo'))) {echo "SELECTED";} ?>>Tiempo</option>
											<option value="Calidad"<?php if (!(strcmp($row_puesto_catalogos['criterio_c'], 'Calidad'))) {echo "SELECTED";} ?>>Calidad</option>
											<option value="Cantidad"<?php if (!(strcmp($row_puesto_catalogos['criterio_c'], 'Cantidad'))) {echo "SELECTED";} ?>>Cantidad</option>
											<option value="Costo"<?php if (!(strcmp($row_puesto_catalogos['criterio_c'], 'Costo'))) {echo "SELECTED";} ?>>Costo</option>
											<option value="Tiempo-Calidad"<?php if (!(strcmp($row_puesto_catalogos['criterio_c'], 'Tiempo-Calidad'))) {echo "SELECTED";} ?>>Tiempo-Calidad</option>
											<option value="Calida-Costo"<?php if (!(strcmp($row_puesto_catalogos['criterio_c'], 'Calida-Costo'))) {echo "SELECTED";} ?>>Calida-Costo</option>
											<option value="Calida-Tiempo"<?php if (!(strcmp($row_puesto_catalogos['criterio_c'], 'Calida-Tiempo'))) {echo "SELECTED";} ?>>Calida-Tiempo</option>
											<option value="Cantidad-Tiempo"<?php if (!(strcmp($row_puesto_catalogos['criterio_c'], 'Cantidad-Tiempo'))) {echo "SELECTED";} ?>>Cantidad-Tiempo</option>
											<option value="Tiempo-Costo"<?php if (!(strcmp($row_puesto_catalogos['criterio_c'], 'Tiempo-Costo'))) {echo "SELECTED";} ?>>Tiempo-Costo</option>
                                            </select>            
										</div>
									</div>
...
<hr>
								...
								<div class="modal-footer">
                                    ...
                                    <input type="submit" class="btn btn-primary" value="Actualizar">
                                 	<input type="hidden" name="criterio" value="m">
					...
					<div id="modal_theme_danger<?php echo $row_puesto_catalogos['IDcriterio']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                     <a class="btn btn-danger" href="admin_dps_borrar.php?IDcriterio=<?php echo $row_puesto_catalogos['IDcriterio']; ?>&IDpuesto=<?php echo $IDpuesto; ?>&pagina=f">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
                    ...
                    <fieldset class="content-group">
								...
								<div class="modal-body">
								  ...
								  <div class="form-group">
										<label class="control-label col-lg-3">Definición:*</label>
										<div class="col-lg-9">
											<textarea rows="4" class="form-control" id="criterio_a" name="criterio_a" placeholder="Reclutamiento de vacantes de acuerdo al tiempo establecido de cobertura por tipo de puesto."
									...
									<!-- /basic text input -->
                                       ...
                                       <!-- Basic text input -->
								  <div class="form-group">
										<label class="control-label col-lg-3">Indicador:*</label>
										<div class="col-lg-9">
											<textarea rows="4" class="form-control" id="criterio_b" name="criterio_b" placeholder="Cantidad de vacantes cubiertas a tiempo"
                                             required="required"></textarea>
										</div>
									</div>
									<!-- /basic text input -->
								  ...
								  <div class="form-group">
                                        ...
                                        <select name="criterio_c" id="criterio_c" class="form-control" required="required">
											...
											<option value="Tiempo-Calidad">Tiempo-Calidad</option>
											<option value="Calida-Costo">Calida-Costo</option>
											<option value="Calida-Tiempo">Calida-Tiempo</option>
											<option value="Cantidad-Tiempo">Cantidad-Tiempo</option>
							...
							<div class="sidebar-content">
								...
								<div class="sidebar-category">
									...
									<div class="category-content">
										...
										<div class="form-group">
									<button type="button" data-target="#modal_theme_ver"  data-toggle="modal" class="btn btn-xs btn-warning btn-block content-grou">Agregar indicador</button>
										</div>
