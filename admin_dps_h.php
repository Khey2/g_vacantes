...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  header("Location: admin_dps_h.php?info=1&IDpuesto=$IDpuesto");
}
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  header("Location: admin_dps_h.php?info=2&IDpuesto=$IDpuesto");
}
				...
				<!-- Detached content -->
                  ...
                  <div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Descriptivo de Puesto - Capacitación</h5>
						</div>

					<div class="panel-body">

			<p><strong>Instrucciones</strong></p>
			<p>Describe los cursos de capacitación mínimos necesarios del Puesto.</p>

				<table class="table datatable-button-html5-basic">
		          <thead>
                    <tr> 
		              <th class="col-lg-8">Descripción del Curso</th>
                ...
                <?php 	if ($totalRows_puesto_catalogos == 0) { ?>
                   <tr>
                     <td colspan="2">No se encontraron cursos capturados.</td>
                   </tr>
                <?php } else { ?> 
                 <?php  do {  ?>
		          <tr>
		            <td><?php echo $row_puesto_catalogos['criterio_b'];?></td>
		            <td><?php if ($row_puesto_catalogos['criterio_a'] == 1) {echo "Interno";} else {echo "Externo";}?></td>
                    <td>
                    ...
                    <fieldset class="content-group">
								...
								<div class="modal-body">
								  ...
								  <div class="form-group">
										<label class="control-label col-lg-3">Descripción del Curso:*</label>
										<div class="col-lg-9">
                                        <input type="text" name="criterio_b" id="criterio_b" class="form-control" placeholder="Indicar el nombre del Curso" value="<?php echo $row_puesto_catalogos['criterio_b']; ?>" required="required">                                 
										</div>
									</div>
									<!-- /basic text input -->
<p>&nbsp;</p>
								  ...
								  <div class="form-group">
                                        ...
                                        <select name="criterio_a" id="criterio_a" class="form-control" required="required">
											<option value="1"<?php if (!(strcmp($row_puesto_catalogos['criterio_a'], 1))) {echo "SELECTED";} ?>>Interno</option>
											<option value="2"<?php if (!(strcmp($row_puesto_catalogos['criterio_a'], 2))) {echo "SELECTED";} ?>>Externo</option>
                                            </select>            
										</div>
									</div>
									<!-- /basic text input -->
...
<hr>
								...
								<div class="modal-footer">
                                    ...
                                    <input type="submit" class="btn btn-primary" value="Actualizar">
                                 	<input type="hidden" name="criterio" value="h">
					...
					<div id="modal_theme_danger<?php echo $row_puesto_catalogos['IDcriterio']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                     <a class="btn btn-danger" href="admin_dps_borrar.php?IDcriterio=<?php echo $row_puesto_catalogos['IDcriterio']; ?>&IDpuesto=<?php echo $IDpuesto; ?>&pagina=h">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
                    ...
                    <fieldset class="content-group">
								...
								<div class="modal-body">
								  ...
								  <div class="form-group">
										<label class="control-label col-lg-3">Descripción del Curso:*</label>
										<div class="col-lg-9">
											<input type="text" name="criterio_b" id="criterio_b" class="form-control" placeholder="Nombre del Curso" value="" required="required">
										</div>
									</div>
									<!-- /basic text input -->
							...
							<div class="sidebar-content">
								...
								<div class="sidebar-category">
									...
									<div class="category-content">
										...
										<div class="form-group">
									<button type="button" data-target="#modal_theme_ver"  data-toggle="modal" class="btn btn-xs btn-warning btn-block content-grou">Agregar curso</button>
										</div>
