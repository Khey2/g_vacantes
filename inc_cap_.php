...
mysql_select_db($database_vacantes, $vacantes);
$query_detalle = "SELECT DISTINCT Count(prod_activos.IDempleado) AS Ocupados, prod_activos.IDarea, vac_puestos.denominacion, vac_puestos.IDpuesto, vac_matriz.matriz, vac_matriz.IDmatriz, vac_areas.area, Count(inc_captura_2020.inc1) AS INC1, Count(inc_captura_2020.inc2) AS INC2, Count(inc_captura_2020.inc3) AS INC3, Count(inc_captura_2020.inc4) AS INC4, Count(inc_captura_2020.inc5) AS INC5, Count(inc_captura_2020.inc6) AS INC6 FROM prod_activos LEFT JOIN vac_puestos ON prod_activos.IDpuesto = vac_puestos.IDpuesto LEFT JOIN vac_matriz ON prod_activos.IDmatriz = vac_matriz.IDmatriz LEFT JOIN vac_areas ON vac_areas.IDarea = prod_activos.IDarea LEFT JOIN inc_captura_2020 ON inc_captura_2020.IDempleado = prod_activos.IDempleado AND inc_captura_2020.semana = '$la_semana' AND inc_captura.anio = '$anio' WHERE prod_activos.IDmatriz = '$IDmatriz' GROUP BY vac_puestos.denominacion, prod_activos.IDmatriz, prod_activos.IDarea, vac_matriz.matriz, vac_areas.area, prod_activos.IDpuesto, vac_puestos.IDaplica_INC, vac_puestos.modal"; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_detalle = "SELECT DISTINCT Count(prod_activos.IDempleado) AS Ocupados, prod_activos.IDarea, vac_puestos.denominacion, vac_puestos.IDpuesto, vac_matriz.matriz, vac_matriz.IDmatriz, vac_areas.area, Count(inc_captura.inc1) AS INC1, Count(inc_captura.inc2) AS INC2, Count(inc_captura.inc3) AS INC3, Count(inc_captura.inc4) AS INC4, Count(inc_captura.inc5) AS INC5, Count(inc_captura.inc6) AS INC6 FROM prod_activos LEFT JOIN vac_puestos ON prod_activos.IDpuesto = vac_puestos.IDpuesto LEFT JOIN vac_matriz ON prod_activos.IDmatriz = vac_matriz.IDmatriz LEFT JOIN vac_areas ON vac_areas.IDarea = prod_activos.IDarea LEFT JOIN inc_captura ON inc_captura.IDempleado = prod_activos.IDempleado AND inc_captura.semana = '$la_semana' AND inc_captura.anio = '$anio' WHERE prod_activos.IDmatriz = '$IDmatriz' GROUP BY vac_puestos.denominacion, prod_activos.IDmatriz, prod_activos.IDarea, vac_matriz.matriz, vac_areas.area, prod_activos.IDpuesto, vac_puestos.IDaplica_INC, vac_puestos.modal"; 
$detalle = mysql_query($query_detalle, $vacantes) or die(mysql_error());
$row_detalle = mysql_fetch_assoc($detalle);
$totalRows_detalle = mysql_num_rows($detalle);
			...
			<!-- Content area -->
				...
				<!-- Statistics with progress bar -->
                    ...
                    <tbody>
									    <?php do { 	?>
									      <tr>
									        <td><a href="inc_cap_puesto_dt.php?el_puesto=<?php echo $row_detalle['IDpuesto']; ?>&la_semana=<?php echo $la_semana; ?>"><?php echo $row_detalle['denominacion']; ?></a>&nbsp; </td>
									        <td><?php echo $row_detalle['matriz']; ?>&nbsp; </td>
									        <td><?php echo $row_detalle['area']; ?>&nbsp; </td>
									        <td><?php echo $row_detalle['Ocupados']; ?></td>
									        <td><?php echo $row_detalle['INC1']; ?></td>                                           
									        <td><?php echo $row_detalle['INC2']; ?></td>                                           
									        <td><?php echo $row_detalle['INC3']; ?></td>                                           
									        <td><?php echo $row_detalle['INC4']; ?></td>                                           
									        <td><?php echo $row_detalle['INC5']; ?></td>                                           
                    </tr>
