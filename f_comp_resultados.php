...
// autoevaluacion
mysql_select_db($database_vacantes, $vacantes);
$query_tipo1 = "SELECT sed_competencias_resultados.IDevaluacion FROM sed_competencias_resultados LEFT JOIN prod_activos ON sed_competencias_resultados.IDempleado = prod_activos.IDempleado WHERE sed_competencias_resultados.IDempleado = $el_usuario AND sed_competencias_resultados.IDtipo = 1 AND sed_competencias_resultados.anio = $anio AND sed_competencias_resultados.IDgrupo = $el_grupo";
...
// jefe
mysql_select_db($database_vacantes, $vacantes);
$query_tipo2 = "SELECT sed_competencias_resultados.IDevaluacion FROM sed_competencias_resultados LEFT JOIN prod_activos ON sed_competencias_resultados.IDempleado = prod_activos.IDempleado WHERE sed_competencias_resultados.IDempleado = $el_usuario AND sed_competencias_resultados.IDtipo = 2 AND sed_competencias_resultados.anio = $anio AND sed_competencias_resultados.IDgrupo = $el_grupo";
...
// pares
mysql_select_db($database_vacantes, $vacantes);
$query_tipo3 = "SELECT sed_competencias_resultados.IDevaluacion FROM sed_competencias_resultados LEFT JOIN prod_activos ON sed_competencias_resultados.IDempleado = prod_activos.IDempleado WHERE sed_competencias_resultados.IDempleado = $el_usuario AND sed_competencias_resultados.IDtipo = 3 AND sed_competencias_resultados.anio = $anio AND sed_competencias_resultados.IDgrupo = $el_grupo";
...
// cols
mysql_select_db($database_vacantes, $vacantes);
$query_tipo4 = "SELECT sed_competencias_resultados.IDevaluacion FROM sed_competencias_resultados LEFT JOIN prod_activos ON sed_competencias_resultados.IDempleado = prod_activos.IDempleado WHERE sed_competencias_resultados.IDempleado = $el_usuario AND sed_competencias_resultados.IDtipo = 4 AND sed_competencias_resultados.anio = $anio AND sed_competencias_resultados.IDgrupo = $el_grupo";
...
// clientes
mysql_select_db($database_vacantes, $vacantes);
$query_tipo5 = "SELECT sed_competencias_resultados.IDevaluacion FROM sed_competencias_resultados LEFT JOIN prod_activos ON sed_competencias_resultados.IDempleado = prod_activos.IDempleado WHERE sed_competencias_resultados.IDempleado = $el_usuario AND sed_competencias_resultados.IDtipo = 5 AND sed_competencias_resultados.anio = $anio AND sed_competencias_resultados.IDgrupo = $el_grupo";
...
$valiadores_totales = $totalRows_tipo1 + $totalRows_tipo2 + $totalRows_tipo3 + $totalRows_tipo4 + $totalRows_tipo5;
...
if ($Rcomp1 > 95) { $Tcomp1 = 4;} else if ($Rcomp1 < 95 && $Rcomp1 >= 80 ) {$Tcomp1 = 3; } else if ($Rcomp1 < 80 && $Rcomp1 >= 70 ) {$Tcomp1 = 2; } else if ($Rcomp1 < 70) { $Tcomp1 = 1;}  else { $Tcomp1 = 1;}
if ($Rcomp2 > 95) { $Tcomp2 = 4;} else if ($Rcomp2 < 95 && $Rcomp2 >= 80 ) {$Tcomp2 = 3; } else if ($Rcomp2 < 80 && $Rcomp2 >= 70 ) {$Tcomp2 = 2; } else if ($Rcomp2 < 70) { $Tcomp2 = 1;}  else { $Tcomp2 = 1;}
if ($Rcomp3 > 95) { $Tcomp3 = 4;} else if ($Rcomp3 < 95 && $Rcomp3 >= 80 ) {$Tcomp3 = 3; } else if ($Rcomp3 < 80 && $Rcomp3 >= 70 ) {$Tcomp3 = 2; } else if ($Rcomp3 < 70) { $Tcomp3 = 1;}  else { $Tcomp3 = 1;}
if ($Rcomp4 > 95) { $Tcomp4 = 4;} else if ($Rcomp4 < 95 && $Rcomp4 >= 80 ) {$Tcomp4 = 3; } else if ($Rcomp4 < 80 && $Rcomp4 >= 70 ) {$Tcomp4 = 2; } else if ($Rcomp4 < 70) { $Tcomp4 = 1;}  else { $Tcomp4 = 1;}
if ($Rcomp5 > 95) { $Tcomp5 = 4;} else if ($Rcomp5 < 95 && $Rcomp5 >= 80 ) {$Tcomp5 = 3; } else if ($Rcomp5 < 80 && $Rcomp5 >= 70 ) {$Tcomp5 = 2; } else if ($Rcomp5 < 70) { $Tcomp5 = 1;}  else { $Tcomp5 = 1;}
if ($Rcomp6 > 95) { $Tcomp6 = 4;} else if ($Rcomp6 < 95 && $Rcomp6 >= 80 ) {$Tcomp6 = 3; } else if ($Rcomp6 < 80 && $Rcomp6 >= 70 ) {$Tcomp6 = 2; } else if ($Rcomp6 < 70) { $Tcomp6 = 1;}  else { $Tcomp6 = 1;}
if ($Rcomp7 > 95) { $Tcomp7 = 4;} else if ($Rcomp7 < 95 && $Rcomp7 >= 80 ) {$Tcomp7 = 3; } else if ($Rcomp7 < 80 && $Rcomp7 >= 70 ) {$Tcomp7 = 2; } else if ($Rcomp7 < 70) { $Tcomp7 = 1;}  else { $Tcomp7 = 1;}
if ($Rcomp8 > 95) { $Tcomp8 = 4;} else if ($Rcomp8 < 95 && $Rcomp8 >= 80 ) {$Tcomp8 = 3; } else if ($Rcomp8 < 80 && $Rcomp8 >= 70 ) {$Tcomp8 = 2; } else if ($Rcomp8 < 70) { $Tcomp8 = 1;}  else { $Tcomp8 = 1;}
			...
			<!-- Content area -->
			  <div class="content">
				...
				<!-- Detached content -->
                    ...
                    <tbody>
					<?php if($completo == 5 and $evaluaciones > 0 and $ver_resultados == 1) { ?>
                         <tr>
					...
					<?php } else { ?>
						<tr>
						<td colspan="4"><span class="text text-warning text-semibold">Estimado Usuario, aún no se cuenta con las evaluaciones suficientes para poder generar el resultado. Regrese mas tarde.</span></td>
                        </tr>
                     <?php }  ?>
                     </tbody>
					</table>
					...
					<div class="sidebar-detached">
						<div class="sidebar sidebar-default sidebar-separate">
							<div class="sidebar-content">
								...
								<form method="POST" action="f_comp_resultados.php">
								...
								<div class="sidebar-category">
									...
									<div class="category-content">
										<ul class="media-list">
										 ...
										 <li>&nbsp; <?php echo $pond_tipo4; ?>% Pares</li>
										 <li>&nbsp; <?php echo $pond_tipo3; ?>% Colaboradores</li>
