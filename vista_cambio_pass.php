...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE vac_usuarios SET password=%s WHERE IDusuario=%s",
  ...
  $updateGoTo = "vista_mi_perfil.php?info=3";
  if (isset($_SERVER['QUERY_STRING'])) {
						...
						<div class="panel panel-body login-form">
							<div class="text-center">
								...
								<div class="form-control-feedback">
									...
									<div class="form-group has-feedback has-feedback-left">
										<div class="col-lg-12">
											<input type="password" name="repeat_password" class="form-control" required="required" placeholder="Repite tu nuevo password">
										<div class="form-control-feedback">
									<i class="icon-lock2 text-muted"></i>
								</div>
                                </div>
  							  ...
  							  <button type="submit" class="btn bg-blue btn-block">Cambiar password<i class="icon-arrow-right14 position-right"></i></button>
