...
$porcentaje_carga = ($porcentaje * $parap) * 100;
...
echo "Hextra: " . $horas_extras . "</br>";
    ...
    $query1 = "UPDATE prod_captura SET bono_asistencia = $bono_asistencia, pago = '$garantizado', pago_total = '$garantia_monto',  horas_extra_monto = $horas_extras, adicional2 = '$monto_adicional' WHERE IDcaptura = '$IDcaptura'"; 
    $result1 = mysql_query($query1) or die(mysql_error());  
	}  else {
    $query2 = "UPDATE prod_captura SET bono_asistencia = $bono_asistencia, pago = '$porcentaje_carga', pago_total = '$monto',  horas_extra_monto = $horas_extras, adicional2 = '$monto_adicional' WHERE IDcaptura = '$IDcaptura'"; 
    $result2 = mysql_query($query2) or die(mysql_error());  
		}
	//redirecto
	header("Location: productividad_autoriza_puesto_t.php?IDpuesto=$el_puesto"); 	
