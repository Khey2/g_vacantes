	         ...
	         <p class="text-semibold">Cuando hayas completado de capturar todas las secciones, da clic en "Terminar Captura", para concluir.</p>
                    ...
                    <table class="table table-condensed datatable-button-html5-columns">
                        ...
                        <tr>
                         ...
                         <button type="button" class="btn btn-primary" onClick="window.location.href='f_dps_a.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Actualizar</button>
                         <?php } else { ?>
                         <button type="button" class="btn bg-orange-600" onClick="window.location.href='f_dps_a.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Capturar</button>
                         <?php } ?>
                         </td>
                        </tr>
                        <tr>
                         ...
                         <button type="button" class="btn btn-primary" onClick="window.location.href='f_dps_b.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Actualizar</button>
                         <?php } else { ?>
                         <button type="button" class="btn bg-orange-600" onClick="window.location.href='f_dps_b.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Capturar</button>
                         <?php } ?>
                         </td>
                        </tr>
                        <tr>
                         ...
                         <button type="button" class="btn btn-primary" onClick="window.location.href='f_dps_c.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Actualizar</button>
                         <?php } else { ?>
                         <button type="button" class="btn bg-orange-600" onClick="window.location.href='f_dps_c.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Capturar</button>
                         <?php } ?>
                         </td>
                        </tr>                       
                        <tr>
                         ...
                         <button type="button" class="btn btn-primary" onClick="window.location.href='f_dps_d.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Actualizar</button>
                         <?php } else { ?>
                         <button type="button" class="btn bg-orange-600" onClick="window.location.href='f_dps_d.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Capturar</button>
                         <?php } ?>
                         </td>
                        </tr>                       
                        <tr>
                         ...
                         <button type="button" class="btn btn-primary" onClick="window.location.href='f_dps_e.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Actualizar</button>
                         <?php } else { ?>
                         <button type="button" class="btn bg-orange-600" onClick="window.location.href='f_dps_e.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Capturar</button>
                         <?php } ?>
                         </td>
                        </tr>                       
                        <tr>
                         ...
                         <button type="button" class="btn btn-primary" onClick="window.location.href='f_dps_f.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Actualizar</button>
                         <?php } else { ?>
                         <button type="button" class="btn bg-orange-600" onClick="window.location.href='f_dps_f.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Capturar</button>
                         <?php } ?>
                         </td>
                        </tr>                       
                        <tr>
                         ...
                         <button type="button" class="btn btn-primary" onClick="window.location.href='f_dps_g.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Actualizar</button>
                         <?php } else { ?>
                         <button type="button" class="btn bg-orange-600" onClick="window.location.href='f_dps_g.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Capturar</button>
                         <?php } ?>
                         </td>
                        </tr>                       
                        <tr>
                         ...
                         <button type="button" class="btn btn-primary" onClick="window.location.href='f_dps_h.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Actualizar</button>
                         <?php } else { ?>
                         <button type="button" class="btn bg-orange-600" onClick="window.location.href='f_dps_h.php?IDpuesto=<?php echo $row_puesto_1['IDpuesto']; ?>'">Capturar</button>
                         <?php } ?>
                         </td>
                        </tr>                       
                   	</tbody>							  
						...
						<div class="sidebar sidebar-default sidebar-separate">
							<div class="sidebar-content">
								...
								<div class="sidebar-category">
                                  ...
                                  <button type="button" data-target="#terminar" data-toggle="modal" class="btn btn-xs btn-warning btn-block content-group">Terminar Captura</button>
                                        </div>
									<?php } ?>

									<?php if ($row_puesto_1['descrito'] == 3) { ?>
										<div class="form-group">
                    ...
                    <!-- Modal Importar -->
					<div id="terminar" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header bg-warning">
									<button type="button" class="close" data-dismiss="modal">&times;</button>
									<h6 class="modal-title">Cerrar Captura de PD</h6>
								</div>

								<div class="modal-body">
									<p>¿Estas seguro de que quieres temriar la captura?.<br/>
                                    Se cerrara la captura  del puesto.</p>
                                </div>

								<div class="modal-footer">
								<a class="btn btn-warning" href="f_dps.php?IDpuesto=<?php echo $IDpuesto; ?>&descrito=2">Si terminar</a>
