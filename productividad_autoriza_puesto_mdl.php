...
?>
                            <?php echo $row_puestos['emp_paterno']; ?> <?php echo $row_puestos['emp_materno']; ?> <?php echo $row_puestos['emp_nombre']; ?>                            
            					...
            					<form method="post" class="form-horizontal form-validate-jquery" name="form1" action="productividad_autoriza_empleado.php?IDpuesto=<?php echo $row_puestos['IDpuesto']; ?>" >
										...
										<label class="control-label col-sm-3" data-popup="tooltip-custom" title="PAGO SEMANAL GARANTIZADO">GARANTIZADO</label>
											...
											<div class="form-group">
											 <div class="row">
												...
												<span class="help-block">Los montos adicionales solo los captura el Gerente Regional de Operaciones.</span>
                                                </div>
											</div>
										</div>
