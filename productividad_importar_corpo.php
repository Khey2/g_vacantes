				...
				foreach ($Reader as $Row)
				{
					...
					if (!empty($ELempleado) && is_numeric($ELempleado)) {
						...
						echo $ELempleado;
								...
								//carga		
								$query = "INSERT into inc_captura (IDempleado, semana, anio,  IDmatriz, IDpuesto, fecha_captura, inc3, IDmotivo3, obs3)	values ('".$ELempleado."','". $la_semana."','". $anio."','". $IDsmatriz ."','". $IDPuesto ."','". $fecha_captura ."','". $inc3 ."','". $IDmotivo3 ."','". $obs3 ."')";
							...
							// si ya existe en la base 		
								...
								// actualiza	
								$query = "UPDATE inc_captura SET IDmotivo3 = '$IDmotivo3', inc3 = '$inc3', obs3 = '$obs3', capturador = '$capturador' WHERE inc_captura.IDempleado = '$ELempleado' AND inc_captura.semana = '$semana'";
								$result = mysqli_query($conn, $query) or die(mysql_error());
