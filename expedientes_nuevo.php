...
mysql_select_db($database_vacantes, $vacantes);
$query_empleado = "SELECT exp_tipos.tipo, exp_files.nombre, prod_activos.IDempleado, prod_activos.fecha_alta, prod_activos.denominacion,  prod_activos.emp_paterno, prod_activos.emp_materno, prod_activos.emp_nombre, prod_activos.rfc   FROM prod_activos LEFT JOIN exp_files ON exp_files.IDempleado = prod_activos.IDempleado LEFT JOIN exp_tipos ON exp_tipos.IDTipo = exp_files.IDtipo WHERE prod_activos.IDempleado = '$IDempleado'";
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body text-center">
                            <a class="btn btn-primary" href="expendientes_file_cargar.php?IDempleado=<?php echo $IDempleado;?>">Agregar Documento</a>
                    </div>
					</div>
					<!-- /colored button -->
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="expendientes_file_cargar.php?IDempleado=<?php echo $IDempleado; ?>&id=<?php echo $row_file['id']; ?>">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
