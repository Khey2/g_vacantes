...
mysql_select_db($database_vacantes, $vacantes);
$query_reporte = "SELECT prod_activos.IDempleado, prod_activos.emp_paterno, prod_activos.emp_materno, prod_activos.emp_nombre, vac_puestos.denominacion, prod_activos.sueldo_total, prod_activos.sueldo_diario, prod_captura_2020.garantizado, prod_captura_2020.adicional, prod_captura_2020.adicional2, prod_captura_2020.reci, prod_captura_2020.carg, prod_captura_2020.dist, prod_captura_2020.esti, prod_captura_2020.pago, prod_captura_2020.pago_total, prod_captura_2020.capturador, prod_captura_2020.validador, prod_captura_2020.autorizador, prod_captura_2020.lun, prod_captura_2020.mar, prod_captura_2020.mie, prod_captura_2020.jue, prod_captura_2020.vie, prod_captura_2020.sab, prod_captura_2020.dom, vac_matriz.matriz FROM prod_activos LEFT JOIN prod_captura_2020 ON prod_captura_2020.IDempleado = prod_activos.IDempleado AND prod_captura_2020.semana = '$semana' LEFT JOIN vac_puestos ON prod_activos.IDpuesto = vac_puestos.IDpuesto LEFT JOIN vac_matriz ON vac_matriz.IDmatriz = prod_captura_2020.IDmatriz WHERE prod_activos.IDarea IN ($mis_areas) AND prod_activos.IDmatriz = '$IDmatriz' GROUP BY prod_activos.IDempleado, prod_activos.emp_paterno, prod_activos.emp_materno, prod_activos.emp_nombre, vac_puestos.denominacion, prod_activos.sueldo_total, prod_activos.sueldo_diario, prod_captura_2020.garantizado, prod_captura_2020.adicional, prod_captura_2020.adicional2, prod_captura_2020.reci, prod_captura_2020.carg, prod_captura_2020.dist, prod_captura_2020.esti, prod_captura_2020.pago, prod_captura_2020.pago_total, prod_captura_2020.capturador, prod_captura_2020.validador, prod_captura_2020.autorizador, prod_captura_2020.lun, prod_captura_2020.mar, prod_captura_2020.mie, prod_captura_2020.jue, prod_captura_2020.vie, prod_captura_2020.sab, prod_captura_2020.dom, vac_matriz.matriz HAVING SUM(prod_captura_2020.pago + prod_captura_2020.adicional) > 30";
$reporte = mysql_query($query_reporte, $vacantes) or die(mysql_error());

} else {
	
mysql_select_db($database_vacantes, $vacantes);
$query_reporte = "SELECT prod_activos.IDempleado, prod_activos.emp_paterno, prod_activos.emp_materno, prod_activos.emp_nombre, vac_puestos.denominacion, prod_activos.sueldo_total, prod_activos.sueldo_diario, prod_captura.garantizado, prod_captura.adicional, prod_captura.adicional2, prod_captura.reci, prod_captura.carg, prod_captura.dist, prod_captura.esti, prod_captura.pago, prod_captura.pago_total, prod_captura.capturador, prod_captura.validador, prod_captura.autorizador, prod_captura.lun, prod_captura.mar, prod_captura.mie, prod_captura.jue, prod_captura.vie, prod_captura.sab, prod_captura.dom, vac_matriz.matriz FROM prod_activos LEFT JOIN prod_captura ON prod_captura.IDempleado = prod_activos.IDempleado AND prod_captura.semana = '$semana'  AND prod_captura.anio = '$anio' LEFT JOIN vac_puestos ON prod_activos.IDpuesto = vac_puestos.IDpuesto LEFT JOIN vac_matriz ON vac_matriz.IDmatriz = prod_captura.IDmatriz WHERE prod_activos.IDarea IN ($mis_areas) AND prod_activos.IDmatriz = '$IDmatriz' GROUP BY prod_activos.IDempleado, prod_activos.emp_paterno, prod_activos.emp_materno, prod_activos.emp_nombre, vac_puestos.denominacion, prod_activos.sueldo_total, prod_activos.sueldo_diario, prod_captura.garantizado, prod_captura.adicional, prod_captura.adicional2, prod_captura.reci, prod_captura.carg, prod_captura.dist, prod_captura.esti, prod_captura.pago, prod_captura.pago_total, prod_captura.capturador, prod_captura.validador, prod_captura.autorizador, prod_captura.lun, prod_captura.mar, prod_captura.mie, prod_captura.jue, prod_captura.vie, prod_captura.sab, prod_captura.dom, vac_matriz.matriz HAVING SUM(prod_captura.pago + prod_captura.adicional) > 30";
$reporte = mysql_query($query_reporte, $vacantes) or die(mysql_error());
...
// Create new PHPExcel object
    ...
    $objPHPExcel->getActiveSheet()->SetCellValue('U1', 'Sucursal');
	...
	{ $asistencia = "NO"; } else { $asistencia = "SI"; }
        ...
        $objPHPExcel->getActiveSheet()->SetCellValue('U'.$rowCount, $row_reporte[26]);
		...
		foreach(range('A','U') as $columnID) {$objPHPExcel->getActiveSheet()->getColumnDimension($columnID)->setAutoSize(true);}
...
// Increment the Excel row counter
    ...
    header('Content-Disposition: attachment;filename="Productividad '.date('dmY') . " " . $mmatriz . '.xls"');
