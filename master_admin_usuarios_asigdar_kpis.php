...
$llmatriz = $row_usuario_['IDmatriz'];
...
mysql_select_db($database_vacantes, $vacantes);
$query_matriz = "SELECT * FROM kpi_matriz";
...
mysql_select_db($database_vacantes, $vacantes);
$query_lmatriz = "SELECT * FROM vac_matriz WHERE IDmatriz = '$llmatriz'";
$lmatriz = mysql_query($query_lmatriz, $vacantes) or die(mysql_error());
$row_lmatriz = mysql_fetch_assoc($lmatriz);
$lematriz = $lmatriz['matriz']; 
...
$upd_vac_usuarios->addColumn("IDmatriz_kpis", "STRING_TYPE", "POST", "IDmatriz_kpis");
...
<?php
//begin JSRecordset
$jsObject_matriz = new WDG_JsRecordset("matriz");
echo $jsObject_matriz->getOutput();
//end JSRecordset
?>
</head>
...
<div class="content">
                  ...
                  <div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Asignar Matrices</h5>
						</div>
                      ...
                      <form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" class="form-horizontal form-validate-jquery">
						...
						<?php echo $row_usuario_['usuario_nombre'] . " " . $row_usuario_['usuario_parterno'] . " ". $row_usuario_['usuario_materno']; ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
						                  <p><strong><?php echo $lematriz; ?> </strong></p>
										</div>
									</div>
									<!-- /basic text input -->
                                     ...
                                     <!-- Basic text input -->
									<div class="form-group">
										<label class="control-label col-lg-3">Matrices:</label>
										<div class="col-lg-9">
						<input name="IDmatriz_kpis" id="IDmatriz_kpis" value="<?php echo KT_escapeAttribute($row_rsvac_usuarios['IDmatriz_kpis']); ?>"
                        wdg:recordset="matriz" wdg:subtype="CommaCheckboxes" wdg:type="widget" wdg:displayfield="matriz" wdg:valuefield="IDmatriz" wdg:groupby="3" />
										</div>
									</div>
									<!-- /basic text input -->
                              
            <input type="submit" name="KT_Update1" id="KT_Update1"  value="Asigar Matrices" class="btn bg-success btn-icon" />
             <button type="button" onClick="window.location.href='master_admin_usuarios_edit.php?IDusuario=<?php echo $colname_usuario_; ?>'" class="btn btn-dafault btn-icon">Regresar</button>
                            </form>
                            <p>&nbsp;</p>
                            </p>
<p>&nbsp;</p>
