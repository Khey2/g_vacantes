...
<p align="center"><strong>Constancia de vacaciones</strong></p>
&nbsp; <br>
...
<p  class="justificar">De conformidad con el artículo 81 de la Ley Federal del Trabajo, por medio del presente se hace de su conocimiento que en razón de que su fecha de ingreso a esta empresa fue el '.$fecha_antiguedad.', usted cuenta con una antigüedad de '.$antiguedad.' años.</p>

<p  class="justificar">Por lo anterior, en términos del numeral 76 del mismo ordenamiento, tiene derecho a gozar, por concepto de vacaciones anuales '.$diasp.' días laborales.</p>

<p  class="justificar">Dicho otorgamiento podrá disfrutarse entre el '.$fecha3.' al '.$fecha1.' previo a su calendarización y aviso a su Jefe inmediato.</p>

<p  class="justificar">Sin más por el momento, quedamos a sus órdenes para cualquier aclaración al respecto.</p>
&nbsp; <br>
&nbsp; <br>
&nbsp; <br>
...
<p  class="justificar">Por medio del presente le informamos que tiene '.$fechap.'. de '.$diasp.' días de vacaciones pendientes de disfrutar correspondientes al periodo '.$periodo.' mismos que expiran el próximo '.$fecha1.'.</p>
...
if ($tipo == 1) {
$nombreDelDocumento = "ANEXO 2. CONSTANCIA DE VACACIONES ".date('dmY')." ".$IDempleado.".pdf";
}else{
