...
$formatos_permitidos =  array('PDF', 'pdf', 'xlsx', 'xls', 'jpeg', 'png', 'jpg');
					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-flat">
								...
								<p>A continuación se muestran los empleados de la Sucursal <strong><?php echo $row_matriz['matriz']; ?></strong> que están en Periodo de Prueba (PP).</p>
								<?php if ($row_usuario['user_prueba'] == 1) { ?>
								...
								<li>Para poder imprimir la notificación, el PP debe capturados los pagos.</li>
								...
								<ul>
								<li><a href="PPP/formato.xlsx"><i class="icon-file-download2 position-left"></i>Formato de Desempeño de PP.</a></li>
								<li><a href="PPP/Politica.pdf"><i class="icon-file-download2 position-left"></i>Política Promociones Internas.</a></li>
								<li><a href="PPP/formato1.xlsx"><i class="icon-file-download2 position-left"></i>Formato de Notificación de PP.</a></li>
