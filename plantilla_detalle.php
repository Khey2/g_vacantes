...
if($_POST['fecha_fin'] != '') {$fecha_fin = date('Y-m-d', strtotime($_POST['fecha_fin']));} else {$fecha_fin = '';}
if($_POST['fecha_congelada'] != '') {$fecha_congelada = date('Y-m-d', strtotime($_POST['fecha_congelada']));} else {$fecha_congelada = '';}
...
if(isset($_GET['fecha_filtro'])) {$fecha_filtro = $_GET['fecha_filtro'];} else {$fecha_filtro = date("m-Y");}
                                ...
                                <tbody>
								  ...
								  <?php do { ?>
                                    <tr>
                                      ...
                                      <td>
                                      <button type="button" data-target="#modal_theme_danger<?php echo $row_autorizados['IDplantilla']; ?>"  data-toggle="modal" class="btn btn-primary btn-icon">Ver detalles</button>
                                      </tr>
							...
							<div class="modal-content">
            					...
            					<form method="post" class="form-horizontal form-validate-jquery" name="form2"  action="<?php echo $editFormAction; ?>" >
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
											<input type="text" class="form-control" name="IDmatriz" id="IDmatriz"  value="<?php echo $row_lmatriz['matriz']; ?>" disabled="disabled">
												</div>
											</div>
	                                    </div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
											<select name="IDsucursal" id="IDsucursal" class="form-control"  disabled="disabled">
													  <?php do {  ?>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
											<select name="IDpuesto" id="IDpuesto" class="form-control"  disabled="disabled">
											...
											<div class="form-group">
			                                    <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom">Tipo:<span class="text-danger">*</span></label>
												<div class="col-sm-9">
											<select name="IDtipo_plaza" class="form-control"  disabled="disabled">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
											<input type="text" class="form-control pickadate" name="fecha_inicio" id="fecha_inicio" value="<?php if ($row_autorizados['fecha_inicio'] == "") {echo "";} else { echo  date('d-m-Y', strtotime($row_autorizados['fecha_inicio']));  }?>" placeholder="Selecciona" disabled="disabled">
												</div>
											</div>
	                                    </div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
											<input type="text" class="form-control pickadate" name="fecha_fin" id="fecha_fin"  value="<?php if ($row_autorizados['fecha_fin'] == "") {echo "";} else { echo  date('d-m-Y', strtotime($row_autorizados['fecha_fin']));  }?>" placeholder="Selecciona" disabled="disabled">
												</div>
											</div>
	                                    </div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
											<input type="text" class="form-control pickadate" name="fecha_congelada" id="fecha_congelada"  value="<?php if ($row_autorizados['fecha_congelada'] == "") {echo "";} else { echo  date('d-m-Y', strtotime($row_autorizados['fecha_congelada']));  }?>" placeholder="Selecciona" disabled="disabled">
												</div>
											</div>
	                                    </div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
											<input type="text" class="form-control" name="IDmotivo" id="IDmotivo"  value="<?php  echo $row_autorizados['IDmotivo']; ?>" disabled="disabled" placeholder="Indica el motivo.">
												</div>
											</div>
	                                    </div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
											<input type="text" class="form-control" name="observaciones" id="observaciones" disabled="disabled" value="<?php echo $row_autorizados['observaciones']; ?>" placeholder="Indica No. de Plaza y Comentarios." >
												</div>
											</div>
	                                    </div>
