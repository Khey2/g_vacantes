...
$IDempleadoJ = $row_becario['IDempleadoJ'];
...
// si se mandó archivo
if ($name != '') {	
if($extension != 'jpg' AND $extension != 'jpeg' AND $extension != 'png' AND $extension != 'JPG' AND $extension != 'JPEG' AND $extension != 'PNG')  { echo "error archivos"; 
...
// si se mandó archivo
if ($name != '') {	
if($extension != 'pdf' AND $extension != 'PDF')  { echo "error archivos"; 
header("Location: b_datos.php?info=9"); 
exit;
}
if (!file_exists($IDempleado_carpeta)) {mkdir($IDempleado_carpeta, 0777, true);}
					...
					<!-- Navigation widget -->
							<div class="panel panel-flat">
								...
								<div class="list-group no-border no-padding-top">
									...
									<a href="#" class="list-group-item"><strong>Asignado a: </strong> <?php echo $row_boss['emp_paterno']." ".$row_boss['emp_materno']." ".$row_boss['emp_nombre']; ?></a>
							<!-- /navigation widget -->
								</div>
