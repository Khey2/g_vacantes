                ...
                <form method="POST" action="admin_plantilla.php">
					<table class="table">
							...
							<td>Tipo Plaza:<select class="form-control" name="el_tipo">
                                               <option value="1,2"<?php if (!(strcmp($row_autorizados['IDtipo_plaza'], '1,2'))) {echo "selected=\"selected\"";} ?>>Todas</option>
							...
							<td>Estatus:<select class="form-control" name="el_estatus">
                                               <option value="1"<?php if (!(strcmp($row_autorizados['IDestatus'], 1))) {echo "selected=\"selected\"";} ?>>Activa</option>
                                               <option value="2"<?php if (!(strcmp($row_autorizados['IDestatus'], 2))) {echo "selected=\"selected\"";} ?>>Cerrada</option>
                                               <option value="3"<?php if (!(strcmp($row_autorizados['IDestatus'], 3))) {echo "selected=\"selected\"";} ?>>Congelada</option>
                                            </select>
                            </td>
							<td>
                                ...
                                <tbody>
								  ...
								  do { $totales = $totales + $row_autorizados['Autorizada'];  ?>
                                    <tr>
                                      ...
                                      <td><a href="admin_plantilla_detalle.php?IDpuesto=<?php echo $row_autorizados['IDpuesto']; ?>&IDmatriz=<?php echo $la_matriz; ?>&IDtipo_plaza=<?php echo $row_autorizados['IDtipo_plaza']; ?>&IDestatus=<?php echo $row_autorizados['IDestatus']; ?>" class="btn btn-primary">Ver detalles</a></tr>
