		...
		<?php require_once('assets/menu.php'); ?>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							d) Fecha de consulta actual: <b><?php echo $IDfecha." de ".$elmes." del ".$el_anio; ?>.</b></p>
			...
			<table class="table table-condensed datatable-button-html5-columns">				
                ...
                <tbody>
                  ...
                  <tr>
                   <td>
			 <div onClick="loadDynamicContentModal('<?php echo $row_activos['IDempleado']; ?>', '<?php echo $IDfecha; ?>')" class="btn btn-xs btn-info btn-icon">Ver</div>
					 </td>
				   ...
				   if ($row_activos['IDtipo'] > 0) { echo "<b>".$row_activos['tipo']."</b>";} else { echo "-"; } 
				   } else {echo "-";} ?></td>
                   <td><?php if ($row_activos['IDvalidador'] != ''){ 
				   if ($row_activos['Tipo2'] > 0) { echo "<b>".$row_activos['Tipo2']."</b>";} else { echo "-"; } 
				   } else {echo "-";} ?></td>
                  </tr>
...
function loadDynamicContentModal(modal, IDfecha){
	...
	$('#conte-modal').load('asistencias_mdlr.php?mes=' + el_mes + '&anio=' + el_anio + '&IDfecha=' + IDfecha + '&IDempleado='+ modal, function() {
