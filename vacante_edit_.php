...
$ins_vac_vacante->registerTrigger("END", "Trigger_Default_Redirect", 99, "vacantes_totales.php?info=1");
// Add columns
...
$ins_vac_vacante->addColumn("IDapoyo", "NUMERIC_TYPE", "POST", "IDapoyo");
...
$upd_vac_vacante->registerTrigger("END", "Trigger_Default_Redirect", 99, "vacantes_totales_bk.php?IDvacante={IDvacante}");
// Add columns
...
if ((isset($_GET['IDvacante_borrar'])) && ($_GET['IDvacante_borrar'] != "")) {
  ...
  header("Location: vacantes_totales.php?info=3");
}
