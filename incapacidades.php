...
mysql_select_db($database_vacantes, $vacantes);
$query_casos = "SELECT * FROM incapacidades_accidentes WHERE IDestatus IN ($IDestatus) AND anio = $anio AND IDmatriz = $la_matriz AND IDincapacidad_accidente = 1"; 
...
<!-- Page container -->
					...
					<div class="row">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Accidentes de Trabajo</h6>
								...
								<div class="panel-body">
									...
									<b>Accidentes:</b><br/>
									1. Utiliza el filtro para buscar los accidentes por año, matriz o estatus.</br>
                                    2. Da clic en el botón <span class="text-sucess">Agregar</span> para agregar un accidente.</br>
									3. Da clic en el botón <i class="icon-file-check text-primary"></i> para actualizar o cerrar el accidente de trabajo.</br>
									4. Da clic en el botón <i class="icon-file-plus text-success"></i> para agregar una incapacidad al accidente de trabajo.</br>
									...
									3. La incapacidad marcada con <i class="text text-danger icon-cross"></i> NO ha sido validada por Nómina.</br>
									4. La incapacidad marcada con <i class="text text-success icon-checkmark5"></i> SI ha sido validada por Nómina.</br>
	...
	<form method="POST" action="incapacidades.php">
		<table class="table">
			<tr>
			<td>Año:
			...
			<a href="incapacidades_edit.php" class="btn btn-success">Agregar</a>
			</td>
			</tr>
		</table>
	</form>
...
<table class="table">
	...
	?>
        <tr class="alpha-teal border-top-primary">
			...
			<td>
			<a href="incapacidades_edit_2.php?IDincapacidad=<?php echo $row_casos['IDincapacidad']; ?>"class="btn btn-primary btn-xs"><i class="icon-file-check"></i></a>
				<a href="incapacidades_certificados.php?IDincapacidad=<?php echo $row_casos['IDincapacidad']; ?>" class="btn btn-success btn-xs"><i class="icon-file-plus"></i></a>
              	...
              	<table class="table">
					...
					<?php if ($totalRows_casos_seguimientos > 0) { ?>
                        ...
                        <tr>
							...
							<?php } ?>
								<a href="incapacidades_certificados.php?IDincapacidad=<?php echo $IDincapacidad; ?>&IDcertificado=<?php echo $row_casos_seguimientos['IDcertificado']; ?>" class="btn btn-info btn-xs"><i class="icon-file-check"></i></a>
							</td>
						</tr>
