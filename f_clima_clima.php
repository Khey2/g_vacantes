...
// Resultados por Dimension sahuayo
mysql_select_db($database_vacantes, $vacantes);
...
// Resultados por Subdimension sahuayo
mysql_select_db($database_vacantes, $vacantes);
...
<?php if ($resultados == 1) { ?>
					...
					<div class="row">
						...
						<div class="panel panel-flat">	
							<div class="panel-body">
								...
								<p>Sahuayo ha diseñado un modelo para el estudio de su Clima Organizacional, basado en los modelos de la sahuayos Internacionales <strong>Great Place to Work</strong> y <strong>Top Companies</strong>, fundamentado en el desarrollo e interacción de cuatro principales relaciones en el lugar de trabajo.</p>
                ...
                <a href="#" class="list-group-item"><i class="icon-reading"></i> % de Participación <span class="badge badge-danger pull-right"><?php echo round(($totalRows_encuestas / $row_plantilla['plantilla'])*100,0); ?>%</span></a>
