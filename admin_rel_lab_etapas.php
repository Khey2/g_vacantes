...
$insertSQL = sprintf("INSERT INTO rel_lab_etapas (IDasesoria, IDetapa, IDempleado_jefe, IDempleado_rh, IDempleado_testigo, file, fecha_captura, fecha_inicio, fecha_fin, hora_inicio, texto_esperado, texto_observado, texto_acuerdos, texto_resultados, observaciones, politica1, politica2, politica3, politica4) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
if ((isset($_GET['borrar'])) && ($_GET['borrar'] == 1)) {
  ...
  header("Location: admin_rel_lab.php?info=4");
}
                                   ...
                                   <!-- Basic text input -->
									<div class="form-group">
										...
										<div class="col-lg-6">
											...
											<li><strong>Tiempo recomendado: </strong><?php echo $row_asesoria['tiempo']; ?>.</li>
											</ul>
										</div>
									</div>
									<!-- /basic text input -->
