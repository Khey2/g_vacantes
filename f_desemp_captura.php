...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  header("Location: f_desemp_captura.php?info=2&IDperiodo=$IDperiodo&IDempleado=$IDempleado&id=$id");
}
...
$insertSQL = sprintf("INSERT INTO sed_individuales (IDempleado, mi_mi, mi_IDunidad, mi_ponderacion, mi_IDindicador, mi_3, mi_2, mi_1, estatus, fecha_captura, fecha_termino, IDperiodo)
 ...
 header("Location: f_desemp_captura.php?info=1&IDperiodo=$IDperiodo&IDempleado=$IDempleado&id=$id");
}
...
if ((isset($_GET['IDmeta'])) && ($_GET['IDmeta'] != "")) {
  ...
  header("Location:  f_desemp_captura.php?info=3&IDperiodo=$IDperiodo&IDempleado=$IDempleado&id=$id");
}
...
if ((isset($_GET['terminacaptura'])) && ($_GET['terminacaptura'] != "")) {
  ...
  header("Location:  f_desemp_captura.php?info=$terminacaptura&IDperiodo=$IDperiodo&IDempleado=$IDempleado&id=$id");
}
					...
					<div id="actualizar<?php echo $row_mis_metas['IDmeta']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog modal-lg">
							<div class="modal-content text-center">
            					...
            					<form method="post" class="form-horizontal form-validate-jquery" name="form1" action="f_desemp_captura.php?IDperiodo=<?php echo $IDperiodo; ?>&IDempleado=<?php echo $IDempleado; ?>&id=<?php echo $_GET['id']; ?>" > 
					...
					<div id="borrar<?php echo $row_mis_metas['IDmeta']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                    <a class="btn btn-warning" href="f_desemp_captura.php?IDmeta=<?php echo $row_mis_metas['IDmeta']; ?>&borrar=1&IDperiodo=<?php echo $IDperiodo; ?>&IDempleado=<?php echo $el_usuario;?>&id=<?php echo $_GET['id']; ?>">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
                                    ...
                                    <a class="btn btn-warning" href="f_desemp_captura.php?IDperiodo=<?php echo $IDperiodo; ?>&IDempleado=<?php echo $el_usuario;?>&id=<?php echo $_GET['id']; ?>&terminacaptura=1">Si Cerrar</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div id="abrir" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Regresar</button>
                                    <a class="btn btn-warning" href="f_desemp_captura.php?IDperiodo=<?php echo $IDperiodo; ?>&IDempleado=<?php echo $el_usuario;?>&id=<?php echo $_GET['id']; ?>&terminacaptura=0">Si Habilitar</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div id="importar2" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
								<a class="btn btn-warning" href="f_desemp_importar.php?IDperiodo=<?php echo $IDperiodo; ?>&IDempleado=<?php echo $el_usuario;?>&id=<?php echo $_GET['id']; ?>&importar=1">Si recuperar</a>
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
								</div>
							</div>
						</div>
					...
					<div id="importar3" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
								<a class="btn btn-warning" href="f_desemp_importar.php?IDperiodo=<?php echo $IDperiodo; ?>&IDempleado=<?php echo $el_usuario;?>&id=<?php echo $_GET['id']; ?>&importar=2">Si recuperar</a>
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
								</div>
							</div>
						</div>
