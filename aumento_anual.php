...
$fecha_limite = date( 'Y-m-d' , strtotime("2022-07-01"));
...
header('Location: aumento_anual.php?primary=2');
}
...
if ((isset($_GET["borrarfiltro"])) && ($_GET["borrarfiltro"] == "1")) {
$_SESSION['filtro1'] = "";
$_SESSION['filtro2'] = "";
$_SESSION['filtro3'] = "";
$_SESSION['filtro4'] = "";
...
header('Location: aumento_anual.php?primary=x');
}
...
{ $_SESSION['IDajustes'] = $_POST['IDajustes']; $_SESSION['filtro2'] = " AND prod_activos_anual.ajustado != 0 ";}
...
$updateSQL = "UPDATE prod_activos_anual SET estatus = 1 WHERE (prod_activos_anual.IDL1 = $el_usuario OR prod_activos_anual.IDL2 = $el_usuario OR prod_activos_anual.IDL3 = $el_usuario OR prod_activos_anual.IDL4 = $el_usuario OR prod_activos_anual.IDL5 = $el_usuario) ".$filtro1.$filtro2.$filtro3.$filtro4.$filtro5;
mysql_select_db($database_vacantes, $vacantes);
$Result1 = mysql_query($updateSQL, $vacantes) or die(mysql_error());
header('Location: aumento_anual.php?primary=8');
}

if ((isset($_GET["cerrar"])) && ($_GET["cerrar"] == "2")) {
$updateSQL = "UPDATE prod_activos_anual SET estatus = 0 WHERE (prod_activos_anual.IDL1 = $el_usuario OR prod_activos_anual.IDL2 = $el_usuario OR prod_activos_anual.IDL3 = $el_usuario OR prod_activos_anual.IDL4 = $el_usuario OR prod_activos_anual.IDL5 = $el_usuario) ".$filtro1.$filtro2.$filtro3.$filtro4.$filtro5;
mysql_select_db($database_vacantes, $vacantes);
$Result1 = mysql_query($updateSQL, $vacantes) or die(mysql_error());
header('Location: aumento_anual.php?primary=8');
}
...
mysql_select_db($database_vacantes, $vacantes);
$query_detalle = "SELECT * FROM prod_activos_anual WHERE (prod_activos_anual.IDL1 = $el_usuario OR prod_activos_anual.IDL2 = $el_usuario OR prod_activos_anual.IDL3 = $el_usuario OR prod_activos_anual.IDL4 = $el_usuario OR prod_activos_anual.IDL5 = $el_usuario)".$filtro1.$filtro2.$filtro3.$filtro4.$filtro5;
mysql_query("SET NAMES 'utf8'");
...
mysql_select_db($database_vacantes, $vacantes);
$query_detalleT = "SELECT SUM(prod_activos_anual.sueldo_mensual) AS sueldo_mensualT, SUM(prod_activos_anual.aumento_monto) AS aumento_montoT,  AVG(prod_activos_anual.aumento_porcentaje) AS aumento_porcentajeT FROM prod_activos_anual WHERE (prod_activos_anual.IDL1 = $el_usuario OR prod_activos_anual.IDL2 = $el_usuario OR prod_activos_anual.IDL3 = $el_usuario OR prod_activos_anual.IDL4 = $el_usuario OR prod_activos_anual.IDL5 = $el_usuario) AND prod_activos_anual.ajustado <> 2"; 
mysql_query("SET NAMES 'utf8'");
...
$aumento_porcentajeT = (round((($row_detalleT['sueldo_mensualT'] + $row_detalleT['aumento_montoT']) / $row_detalleT['sueldo_mensualT']),3) * 100)-100;

// filtros
$query_matrix = "SELECT vac_matriz.matriz, vac_matriz.IDmatriz, prod_activos_anual.IDempleado FROM prod_activos_anual LEFT JOIN vac_matriz ON prod_activos_anual.IDmatriz = vac_matriz.IDmatriz WHERE prod_activos_anual.IDL1 = $el_usuario OR prod_activos_anual.IDL2 = $el_usuario OR prod_activos_anual.IDL3 = $el_usuario OR prod_activos_anual.IDL4 = $el_usuario OR prod_activos_anual.IDL5 = $el_usuario GROUP BY vac_matriz.matriz"; 
mysql_query("SET NAMES 'utf8'");
$matrix = mysql_query($query_matrix, $vacantes) or die(mysql_error());
$row_matrix = mysql_fetch_assoc($matrix);

$query_puestox = "SELECT vac_puestos.denominacion, vac_puestos.IDpuesto, prod_activos_anual.IDpuesto FROM prod_activos_anual LEFT JOIN vac_puestos ON prod_activos_anual.IDpuesto = vac_puestos.IDpuesto WHERE prod_activos_anual.IDL1 = $el_usuario OR prod_activos_anual.IDL2 = $el_usuario OR prod_activos_anual.IDL3 = $el_usuario OR prod_activos_anual.IDL4 = $el_usuario OR prod_activos_anual.IDL5 = $el_usuario GROUP BY vac_puestos.denominacion"; 
mysql_query("SET NAMES 'utf8'");
$puestox = mysql_query($query_puestox, $vacantes) or die(mysql_error());
$row_puestox = mysql_fetch_assoc($puestox);

$query_areax = "SELECT vac_areas.area, vac_areas.IDarea, prod_activos_anual.IDarea FROM prod_activos_anual LEFT JOIN vac_areas ON prod_activos_anual.IDarea = vac_areas.IDarea WHERE prod_activos_anual.IDL1 = $el_usuario OR prod_activos_anual.IDL2 = $el_usuario OR prod_activos_anual.IDL3 = $el_usuario OR prod_activos_anual.IDL4 = $el_usuario OR prod_activos_anual.IDL5 = $el_usuario GROUP BY vac_areas.area"; 
mysql_query("SET NAMES 'utf8'");
$areax = mysql_query($query_areax, $vacantes) or die(mysql_error());
$row_areax = mysql_fetch_assoc($areax);

$query_subareax = "SELECT vac_subareas.subarea, vac_subareas.IDsubarea, prod_activos_anual.IDsubarea FROM prod_activos_anual LEFT JOIN vac_subareas ON prod_activos_anual.IDsubarea = vac_subareas.IDsubarea WHERE prod_activos_anual.IDL1 = $el_usuario OR prod_activos_anual.IDL2 = $el_usuario OR prod_activos_anual.IDL3 = $el_usuario OR prod_activos_anual.IDL4 = $el_usuario OR prod_activos_anual.IDL5 = $el_usuario GROUP BY vac_subareas.subarea"; 
mysql_query("SET NAMES 'utf8'");
		...
		<?php require_once('assets/menu.php'); ?>
			...
			<!-- Content area -->
				...
				<div class="content">
				        ...
				        <!-- Basic alert -->
                        <?php if((isset($_GET['primary']) && ($_GET['primary'] == 2))) { ?>
                        ...
                        <!-- Basic alert -->
                        <?php if((isset($_GET['primary']) && ($_GET['primary'] == 8))) { ?>
					    <div class="alert bg-success alert-styled-left">
							<button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Cerrar</span></button>
                        ...
                        <!-- Basic alert -->
                        <?php if($aumento_porcentajeT > 4.0) { ?>
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body">
							<p>
							En la siguiente tabla se muestran los ajustes anuales predeterminados <b>(4.0% anual)</b> para el personal Administrativo en Corporativo y Sucursales.<br/>
							Asimismo, se tiene contemplado el incremento de aguinaldo que pasará de 15 hasta 22 días para todos los administrativos.<br/><br/>
							...
							<ul>
							<li>Color<span class='text-primary text-semibold'> Azul</span> en el nombre. No cubre el criterio A o B.</li>
							...
							<li>Texto<span class="text-grey"> na</span>. No aplica evaluación del desempeño por tener otro esquema de compensación variable.</li>
							</ul>
						...
						<div class="col-sm-4 col-md-4">
							<div class="panel panel-body">
								...
								<div class="progress progress-micro mb-10">
									<div class="progress-bar primary" style="width: 100%">
									</div>
								</div>
							...
							<div class="panel panel-body">
								...
								<div class="progress progress-micro mb-10">
									<div class="progress-bar primary" style="width: 100%">
										...
										<?php if ($aumento_porcentajeT > 4.0){  ?>
										<span class="text text-semibold text-danger">
										
										<?php echo "$".number_format($row_detalleT['aumento_montoT'], 2, '.', ',') ?><i class="icon icon-primary22"></i> &nbsp;&nbsp; = &nbsp;&nbsp; 
										
										<?php echo $aumento_porcentajeT;?>%</span>
										
										<?php } else {  ?>
										
										<?php echo "$".number_format($row_detalleT['aumento_montoT'], 2, '.', ',') ?> &nbsp;&nbsp; = &nbsp;&nbsp; 
										<?php echo $aumento_porcentajeT;?>%
										<?php } ?>
							</div>
						</div>
				...
				<!-- Statistics with progress bar -->
					<div class="row">
						...
						<div class="col-sm-12 col-md-12">
							<div class="panel panel-body">
								...
								<form action="aumento_anual.php" class="form-inline" method="POST">
										...
										<a href="aumento_anual.php?borrarfiltro=1" class="btn btn-default"> Borrar Filtro </a>&nbsp;
										<a href="aumento_anual_reporte.php" class="btn btn-success"> Descargar Reporte</a>&nbsp;
										<?php if ($row_detalle['estatus'] == 0) {?>
										<button type="button" data-target="#modal_theme_danger_terminar"  data-toggle="modal" class="btn btn-danger">Terminar</button>
										<?php } else { ?>
										<button type="button" data-target="#modal_theme_danger_terminar"  data-toggle="modal" class="btn btn-danger">Abrir Captura</button>
										<?php }  ?>
										</div>
								</form>
							</div>
					...
					<!-- /statistics with progress bar -->
                     ...
                     <!-- danger modal -->
					<div id="modal_theme_danger_terminar" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<?php if($aumento_porcentajeT < 4.0) { ?>
									<?php if ($row_detalle['estatus'] == 0) {?>
										<p>¿Estas seguro que quieres terminar la captura?, se tomarán como finales los ajustes aplicados.</p>
									<?php } else { ?>
										<p>¿Estas seguro que quieres re abrir la captura?.</p>								
									<?php } ?>
								<?php }  else { ?>
										<p><span class="text text-danger">El presupuesto está rebasado, favor de validar.</span></p>
								<?php }   ?>
								...
								<?php if($aumento_porcentajeT < 4.0) { ?>
									...
									<?php if ($row_detalle['estatus'] == 0) {?>
										<a class="btn btn-danger" href="aumento_anual.php?cerrar=1">Si terminar</a>
									<?php } else { ?>
										<a class="btn btn-danger" href="aumento_anual.php?cerrar=2">Si abrir</a>
									<?php } ?></div>
				...
				<table class="table table-bordered table-hover datatable-highlight">				
                    ...
                    <tr class="bg-primary"> 
                      ...
                      <th class="bg-primary text-center">Criterios (A.B.C)</th>
                      <th class="bg-danger  text-center">Sueldo Actual</th>
                      <th class="bg-danger  text-center">Inc. $</th>
                      <th class="bg-danger  text-center">Inc. %</th>
                    ...
                    <tbody>
						...
						//validamos si le aplica criterior de desempeño		
						if ($row_detalle['criterio3'] == 9) {$criterio3 = 9;} else { 

						// vemos si cumplio desempeno
						$query_sed = "SELECT estatus FROM sed_individuales_resultados WHERE IDempleado = $IDempleado AND IDperiodo = 12"; 
						$sed = mysql_query($query_sed, $vacantes) or die(mysql_error());
						$row_sed = mysql_fetch_assoc($sed);
						$totalRows_sed = mysql_num_rows($sed);

						if ($totalRows_sed > 0) {
						$estatus = $row_sed['estatus'];	
						if ($estatus == 3 OR $estatus == 2 OR $row_detalle['fecha_antiguedad'] > $fecha_limite) {$criterio3 = 1;} } }  
                        ...
                        <tr>
							...
							<?php if ($row_detalle['estatus'] == 1) { echo "Cerrado"; } else { //CERRADO ?>
							<?php if ($criterio3 == 1 OR $criterio3 == 9) { ?>
							
							<div onClick="loadDynamicContentModal('<?php echo $IDempleado; ?>', '1')" class="btn btn-xs btn-primary">$</div>
							<div onClick="loadDynamicContentModal('<?php echo $IDempleado; ?>', '2')" class="btn btn-xs btn-primary">%</div>

							<?php } ?>
							<?php } ?>
							
							</td>
							<td><?php if ($row_detalle['ajustado'] != 0){ ?>
							<span class='text-success'><?php echo $nombre; ?></span>
							<?php } else if (($row_detalle['criterio1'] == 0 OR $row_detalle['criterio2'] == 0 ) AND ($criterio3 == 1 OR $criterio3 == 9)){ ?>
							<span class='text-primary'><?php echo $nombre; ?></span>
							<?php } else if ($criterio3 == 0){ ?>
							<span class='text-danger'><?php echo $nombre; ?></span>
							<?php } else { ?>
							...
							<?php if ($criterio3 == 1){ ?><i class="text-success-600 icon-checkmark2"></i><?php } else if ($criterio3 == 9){ ?><span class="text-grey">na</span>
							<?php } else { ?><i class="text-danger-600 icon-cross3"></i>
							<?php } ?>
							</td>
...
function loadDynamicContentModal(modal, Tipo){
	...
	$('#conte-modal').load('aumento_anual_mdl.php?Tipo=' + Tipo + '&IDempleado='+ modal, function() {
