...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  header("Location: admin_indiv_edit.php?info=1&IDperiodo=$IDperiodo&IDempleado=$el_usuario&id=$id");
...
// ya hay resultados cargados
 ...
 //$result = mysql_query($MYSQL2, $vacantes) or die(mysql_error());
  ...
  header("Location:  admin_indiv_edit.php?info=$terminacaptura&IDperiodo=$IDperiodo&IDempleado=$IDempleado&id=$id");
}
					...
					<div id="actualizar<?php echo $row_mis_metas['IDmeta']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog modal-lg">
							<div class="modal-content text-center">
            					...
            					<form method="post" class="form-horizontal form-validate-jquery" name="form1" action="admin_indiv_edit.php?IDperiodo=<?php echo $IDperiodo; ?>&IDempleado=<?php echo $IDempleado; ?>&id=<?php echo $_GET['id']; ?>" > 
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
                                    ...
                                    <a class="btn btn-warning" href="admin_indiv_edit.php?IDperiodo=<?php echo $IDperiodo; ?>&IDempleado=<?php echo $el_usuario;?>&id=<?php echo $_GET['id']; ?>&terminacaptura=0">Si Cerrar</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div id="abrir" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Regresar</button>
                                    <a class="btn btn-warning" href="admin_indiv_edit.php?IDperiodo=<?php echo $IDperiodo; ?>&IDempleado=<?php echo $el_usuario;?>&id=<?php echo $_GET['id']; ?>&terminacaptura=1">Si Habilitar</a>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="sidebar-content">
								...
								<div class="sidebar-category">
									...
									<div class="category-content">
										...
										<a class="btn btn-default  btn-xs btn-block content-group" href="admin_desemp.php">Regresar</a>
                                    	...
                                    	<p><a class="btn btn-primary  btn-xs btn-block content-group" href="admin_desemp_imprimir.php?IDperiodo=<?php echo $IDperiodo; ?>&IDempleado=<?php echo $el_usuario; ?>&print=1"><i class="icon-printer4"></i> Imprimir Resultados</a></p>
                                        <?php } ?> 
