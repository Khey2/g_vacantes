...
mysql_select_db($database_vacantes, $vacantes);
$query_beneficiarios = "SELECT *, con_parentesco.parentesco FROM con_dependientes LEFT JOIN con_parentesco ON con_dependientes.IDtipo = con_parentesco.IDparentesco WHERE con_dependientes.IDempleado = $IDempleado AND con_dependientes.emergencias IN(2,3)";
...
<p align="center"><strong>FICHA DE EMERGENCIAS</strong></p>

<p align="right">'.$ubicacionfirma.', a '.$ini_cont_d.' de '.$ini_cont_m.' de '.$ini_cont_y.'.</p>

<P><strong>Nombre: </strong>'.$row_contratos['a_nombre'].' '.$row_contratos['a_paterno'].' '.$row_contratos['a_materno'].'.</p>
<P><strong>Puesto: </strong>'.$row_contratos['denominacion'].'.</p>
<P><strong>No. Emp: </strong>'.$noemp.'</p>
&nbsp; <br>

<table border="1" width="100%">
<tr>
<td width="15%"><p align="center">PARENTESCO</p></td>
<td width="35%"><p align="center">NOMBRE</p></td>
<td width="35%"><p align="center">DOMICILIO</p></td>
<td width="15%"><p align="center">TELEFONO</p></td>
</tr>';
$body .= '<tbody>';
do {
$body .= '<tr>';
...
$body .= '</p></td>';
$body .= '<td><p align="center">';
$body .=  $row_beneficiarios['direccion'];
$body .= '</p></td>';
$body .= '<td><p align="center">';
$body .=  $row_beneficiarios['telefono'];
$body .= '</p></td>';
...
<strong>C. ' .$row_contratos['a_nombre'].' '.$row_contratos['a_paterno'].' '.$row_contratos['a_materno'].'</strong></p>
</body>';
...
$nombreDelDocumento = "FICHA EMERGENCIA ".date('dmY')." ".$IDempleado.".pdf";
