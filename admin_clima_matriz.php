...
mysql_select_db($database_vacantes, $vacantes);
$query_puestos = "SELECT * FROM vac_matriz WHERE IDmatriz NOT IN(27,31)";
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body">
							<p>Selecciona la Matriz que requiera editar.</p>
					</div>
...
//plantilla
mysql_select_db($database_vacantes, $vacantes);
$query_plantilla = "SELECT DISTINCT Count(prod_activos.IDempleado) as plantilla FROM prod_activos WHERE prod_activos.IDmatriz = $la_matriz";
...
//periodo
mysql_select_db($database_vacantes, $vacantes);
$query_periodos = "SELECT * FROM sed_clima_periodos WHERE IDmatriz = $la_matriz";
...
$totalRows_encuestas = mysql_num_rows($encuestas);
					  ...
					  ?>
                        <tr>
                          ...
                          <td><?php echo $row_puestos['minimas']; ?></td>
                          <td><?php if ($row_puestos['clima'] == 1) {echo "SI";} else {echo "NO";} ?></td>
                          <td><?php echo $row_plantilla['plantilla']; ?></td>
                          <td><?php echo $totalRows_encuestas; ?></td>
                         <td>
						 <button type="button" class="btn btn-primary" onClick="window.location.href='admin_matriz_edit.php?IDmatriz=<?php echo $row_puestos['IDmatriz']; ?>'">Editar</button> 
						 <button type="button" class="btn btn-info" onClick="window.location.href='admin_matriz_edit_periodos.php?IDmatriz=<?php echo $row_puestos['IDmatriz']; ?>'">Periodos</button> 
						</td>
                        </tr>                       
                    ...
                    <a class="btn btn-primary" href="admin_matriz_edit.php">Agregar Matriz<i class="icon-arrow-right14 position-right"></i></a>
                    </div>
					</div>
					<!-- /colored button -->
