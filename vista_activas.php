...
if(!isset($_SESSION['el_estatus2'])){$_SESSION['el_estatus2'] = 1;}
...
$e1 = " AND vac_vacante.IDestatus = '$el_estatus2'"; }
	 ...
	 if (isset($_POST['el_estatus3']) && $_POST['el_estatus3'] == 3) {	$_SESSION['el_estatus3'] = 3; $a3 = ' AND vac_vacante.IDmotivo_v IN (3) '; } 
else if (isset($_POST['el_estatus3']) && $_POST['el_estatus3'] == 2) {	$_SESSION['el_estatus3'] = 2; $a3 = ' AND vac_vacante.IDmotivo_v IN (1,2,4) ';}
else if (isset($_POST['el_estatus3']) && $_POST['el_estatus3'] == 5) {	$_SESSION['el_estatus3'] = 5; $a3 = ' AND vac_vacante.IDmotivo_v IN (5) ';}
else if (isset($_POST['el_estatus3']) && $_POST['el_estatus3'] == 1) {	$_SESSION['el_estatus3'] = 1; $a3 = ' AND vac_vacante.IDmotivo_v IN (1,2,3,4,5) ';}
else  {	$_SESSION['el_estatus3'] = 1; $a3 = ' AND vac_vacante.IDmotivo_v IN (1,2,3,4,5) '; }
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body">
							<p>Selecciona la sucursal, área, mes, estatus específico y si la vacante está vencida para aplicar un filtro avanzado. </p>
                     ...
                     <form method="POST" action="vista_activas.php">
						...
						<thead>
							<tr>
							<th style="width: 12%;">Temporal</th>
							<th style="width: 12%;">Con Requi</th>
							<th style="width: 12%;">Sucursal</th>
							<th style="width: 12%;">Área</th>
							<th style="width: 14%;">Estatus General</th>
							<th style="width: 14%;">Estatus Específico</th>
							<th style="width: 14%;">A tiempo / Vencida</th>
							<th style="width: 10%;">Filtrar</th>
						    </tr>
					    </thead>
						<tbody>							  
							<tr>
							<td>
                             <select class="form-control"  name="el_estatus3">
                                               <option value="1" <?php if ($el_estatus3 == 1) {echo "selected=\"selected\"";} ?>>Todas</option>
                                               <option value="2" <?php if ($el_estatus3 == 2) {echo "selected=\"selected\"";} ?>>Permanentes</option>
                                               <option value="3" <?php if ($el_estatus3 == 3) {echo "selected=\"selected\"";} ?>>Temporales</option>
                                               <option value="5" <?php if ($el_estatus3 == 5) {echo "selected=\"selected\"";} ?>>Pull Vacaciones</option>
                                               </select>
                            </td>
							<td>
                             <select class="form-control"  name="el_estatus4">
                                               <option value="1" <?php if ($el_estatus4 == 1) {echo "selected=\"selected\"";} ?>>Todas</option>
                                               <option value="2" <?php if ($el_estatus4 == 2) {echo "selected=\"selected\"";} ?>>Con requi</option>
                                               <option value="3" <?php if ($el_estatus4 == 3) {echo "selected=\"selected\"";} ?>>Sin requi</option>
                                               </select>
                            </td>
							<td>
							...
							<td>
                            <select name="el_apoyo" class="multiselect" multiple="multiple" >
                                               <?php do {  ?>
   ...
   <p>&nbsp;</p>                 
					...
					<table class="table table-condensed datatable-button-html5-columns">
						...
						<?php do { $dias4 = $row_vacantes['fecha_usr4']; ?>
							...
							<td><?php if ($row_vacantes['IDmotivo_v'] == 3 OR $row_vacantes['IDmotivo_v'] == 5) {echo "Si";} else {echo "No";} ?>&nbsp; </td>
							<td><?php if ($row_vacantes['IDmotivo_v'] == 5) {echo "Si";} else {echo "No";} ?>&nbsp; </td>
