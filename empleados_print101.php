...
if($row_contratos['a_estado_civil'] == 1) {$edo_civil = "Soltero"; $laX = 68;} else {$edo_civil = "Casado"; $laX = 49;}
$IDestado = $row_contratos['IDestado'];
$la_fecha_lugar = $ubicacionfirma.', a '.$ini_cont_d.' de '.$ini_cont_m.' de '.$ini_cont_y.'.';
$d_calle = $row_contratos['d_calle'];
$d_numero_calle = $row_contratos['d_numero_calle'];
$d_colonia = $row_contratos['d_colonia'];
$d_codigo_postal = $row_contratos['d_codigo_postal'];
$d_delegacion_municipio = $row_contratos['d_delegacion_municipio'];
...
filter_html($d_colonia);
filter_html($d_calle);

$concat1 = html_entity_decode($d_calle." ".$d_numero_calle, ENT_QUOTES, "UTF-8");
$concat2 = html_entity_decode($d_colonia.", ".$d_codigo_postal.",  ".$d_delegacion_municipio.",  ".$d_estado, ENT_QUOTES, "UTF-8");
...
$pdf->AddPage();
// set the source file
$pdf->setSourceFile('CONTS/fianza_1.pdf');
// import page 1
...
$pdf->SetXY(118, 79);
$pdf->Write(0, iconv('UTF-8', 'windows-1252//TRANSLIT//IGNORE', $concat1));

$pdf->SetXY(20, 90);
$pdf->Write(0, iconv('UTF-8', 'windows-1252//TRANSLIT//IGNORE', $concat2));

$pdf->SetXY(45, 100);
$pdf->Write(0, $telefono_1);

$pdf->SetXY(62, 169);
$pdf->Write(0, $denominacion);

$pdf->AddPage();
$pdf->setSourceFile('CONTS/fianza_2.pdf');
// import page 2
$tplIdx = $pdf->importPage(1);
// use the imported page and place it at position 10,10 with a width of 100 mm
$pdf->useTemplate($tplIdx, 0, 5, 215);

$nombreDelDocumento = "FIANZA ".date('dmY')." ".$IDempleado.".pdf";
