				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body">
						...
						<p><b>Evento:</b> <?php echo $row_elevento['evento']; ?></p>
				...
				<div class="table-responsive">
                    ...
                    <thead> 
					  <tr>
						...
						<td class="bg-primary text-center">Cursos</td>
                    ...
                    <tbody>
					  ...
					  <tr>
						...
						<?php do {
							...
							if ($totalRows_detalle > 0 ){ 
							$el_curso = $row_detalle['IDC_capa_cursos'];
							$query_repetidos = "SELECT * FROM capa_avance WHERE ".$filtrador." AND capa_avance.IDC_capa_cursos = $el_curso AND IDempleado = $IDempleado"; 
							...
							?>
						<?php  if ($totalRows_detalle > 0) { echo "<li>".$row_detalle['nombre_cargado'].": ".date( 'd/m/Y', strtotime($row_detalle['fecha_evento']))."</li>"; } else {echo "-";} ?>
						<?php } while ($row_detalle = mysql_fetch_assoc($detalle)); ?>	
						</ul></td>
						<td class="text-center"><?php if ($totalRows_detalle > 1) {echo "<a class='text text-danger text-semibold' href='capa_reporte_3d.php?IDempleado=".$row_altas['IDempleado']."&IDCcurso=".$IDCcurso."'>".$IDempleado."</a>";} else {echo $row_altas['IDempleado'];} ?></td>
