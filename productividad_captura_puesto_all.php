...
if ($_POST['a28'] == ''){$_a28 = 0;} else {$_a28 = $_POST['a28'];}
  ...
  $updateGoTo = "productividad_captura_puesto_uptdate_all.php?IDcaptura=$captura";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (!isset($_POST['observaciones'])) {$_observaciones = 0;} else {$_observaciones = $_POST['observaciones'];}
  ...
  $insertSQL = sprintf("INSERT INTO prod_captura (IDempleado, emp_paterno, emp_materno, emp_nombre, denominacion, sueldo_total, IDpuesto, fecha_captura, semana, anio,  IDmatriz, IDsucursal, IDarea, a1, a2, a3, a4, a5, a6, a7, a25, a26, a27, a28, capturador, garantizado, adicional, observaciones, lun, mar, mie, jue, vie, sab, dom) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "productividad_captura_puesto_uptdate_all.php?IDcaptura=$captura";
  if (isset($_SERVER['QUERY_STRING'])) {
...
function loadDynamicContentModal(modal){
	...
	$('#conte-modal').load('productividad_captura_puesto_mdl_all.php?IDpuesto=' + IDpuesto + '&semana=' + semana + '&IDsucursal=' + IDsucursal + '&IDmatriz=' + IDmatriz + '&IDempleado='+ modal, function() {
