...
?>
			    	  ...
			    	  <div class="panel panel-flat">
                                    <div class="text-left">
                                    <ul>
                                        <li><strong>Nombre</strong>: <?php echo $row_candidatos['a_nombre']. " " .$row_candidatos['a_paterno']." " . $row_candidatos['a_materno'];?></li>
                                        <li></i><strong>Dia</strong>: <?php echo date('d/m/Y', strtotime($row_candidatos['fecha_entrevista']));?></li>
                                        <li><strong>Hora</strong>: <?php echo date('g:i A', strtotime($row_candidatos['hora_entrevista'])) ;?></li>
                                        <li><strong>Vacante</strong>: <?php echo $row_candidatos['denominacion'];?></a>
								...
								<div class="text-left">
                                  <ul>
                                        ...
                                        <li><a href="<?php echo $row_ubiacion['ubicacion'];?>"><?php echo $row_ubiacion['ubicacion'];?></a></li>
                                  </ul>
                				</div>
                                ***Obligatorio uso de cubre bocas***</br>
