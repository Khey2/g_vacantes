...
// Increment the Excel row counter
    ...
    header('Content-Disposition: attachment;filename="Horas Extra - Semana ' . $semana . " del " . $anio . ' global.xls"');
