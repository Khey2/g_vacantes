...
mysql_select_db($database_vacantes, $vacantes);
$query_candidatos = "SELECT cv_activos.IDusuario, cv_activos.a_paterno, cv_activos.a_materno, cv_activos.a_nombre,  cv_activos.fecha_captura, cv_activos.IDmatriz, cv_activos.IDpuesto, cv_activos.estatus, cv_activos.tipo, vac_puestos.denominacion, vac_puestos.IDarea, vac_areas.area FROM cv_activos left JOIN vac_puestos ON vac_puestos.IDpuesto = cv_activos.IDpuesto LEFT JOIN vac_areas ON vac_areas.IDarea = vac_puestos.IDarea  WHERE cv_activos.IDmatriz = '$la_matriz'";
                ...
                <div class="content">
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body">
							<p>Sucursal <?php echo $row_matriz['matriz']?>.</br>
							<p>Candidatos por mes.</p>
							<p>Candidatos contratados Vs reclutados.</p>
							<p>Candidatos por tipo de plaza.</p>
							<p>Candidatos por Área.</p>
							<p>Candidatos por Fuente de Reclutamiento.</p>
							<p>Candidatos por estatus.</p>
                            <p>&nbsp;</p>
                    </div>
			</div>
					<!-- /Contenido -->
