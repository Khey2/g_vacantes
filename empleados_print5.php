...
if ($tipo_nomina == 1){$tipo_nomina = "de manera semanal";} else {$tipo_nomina = "de forma quincenal";}
if ($IDmatriz == 25 OR $IDmatriz == 7){$costo_comedor = "<li>Servicio de comedor, éste es opcional y tiene un costo por día, mismos que se descontarán ".$tipo_nomina." vía nómina (consta de una comida corrida completa).</li>";} else {$costo_comedor = "";}
if ($row_contratos['IDempresa'] == 1 OR $row_contratos['IDempresa'] == 2)
	{
	$prestaciones = '<li>Tendr&#225;s derecho a que la empresa contrate y pagu&#233; la prima de un Seguro de Vida para ti, 
	con una suma asegurada de 24 veces el monto de tu sueldo base mensual.</li>'.$costo_comedor;
	$logotipo = 'CONTS/logo.jpg';
	} else {
	$logotipo = 'https://www.gestionvacantes.com/CONTS/logo2.jpg';
	$prestaciones = '';
	} 
...
<p><strong>Sr (a). '.$row_contratos['a_nombre'].' '.$row_contratos['a_paterno'].' '.$row_contratos['a_materno'].'</strong>
&nbsp; <br>

<p><strong>P r e s e n t e</strong></p>

<p>Por este medio nos complace informarte que has sido seleccionado para ocupar el puesto de <strong>'.$row_contratos['denominacion'].'</strong>.</p>

<p>El paquete de compensaciones correspondiente a esta posici&#243;n es el que a continuaci&#243;n se describe:</p>

<ul>
<li>Prestaciones de Ley Desde el Primer d&#237;a de acuerdo a Ley Federal de Trabajo.
<br>(Vacaciones al primer a&#241;o, equivalentes a 12 d&#237;as, Seguro Social y Aguinaldo de 15 d&#237;as)</li>
<li>Sueldo Mensual de <strong>'.$sueldo_mensual.'</strong> equivalente a un sueldo diario de <strong>'.$sueldo_diario.'</strong>.</li>
<li>Pago de '.$tipo_nomina.'</li>
'.$prestaciones.'

<p>A nombre de la compa&#241;&#237;a, te deseamos &#233;xito en tus nuevas funciones.</p>

&nbsp; <br>
<p align="center"> Aceptaci&#243;n </p>
&nbsp; <br>
&nbsp; <br>
<p align="center">________________________</p>
<p align="center"><strong>'.$row_contratos['a_nombre'].' '.$row_contratos['a_paterno'].' '.$row_contratos['a_materno'].'</strong>
...
$nombreDelDocumento = "FORMATO DE PRESTACIONES ".date('dmY')." ".$IDempleado.".pdf";
