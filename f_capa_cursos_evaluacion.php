...
$updateSQL = "INSERT INTO capa_curso_seguridad_respuestas (IDempleado, preg1, preg2, preg3, preg4, preg5, preg6, preg7, preg8, preg9, preg10, preg11, preg12, preg13, preg14, preg15, preg16, preg17, preg18, preg19, preg20, preg21, fecha) values ($el_usuario, $preg1, $preg2, $preg3, $preg4, $preg5, $preg6, $preg7, $preg8, $preg9, $preg10, $preg11, $preg12, $preg13, $preg14, $preg15, $preg16, $preg17, $preg18, $preg19, $preg20, $preg21, NOW())"; 
mysql_select_db($database_vacantes, $vacantes);
...
$updateSQL = "UPDATE capa_curso_seguridad SET evaluacion = 1, calificacion = $calificacion, evaluacion_fecha =  NOW() WHERE IDempleado = $el_usuario"; 
mysql_select_db($database_vacantes, $vacantes);
$Result1 = mysql_query($updateSQL, $vacantes) or die(mysql_error());
		...
		<?php require_once('assets/f_menu.php'); ?>
            ...
            <?php require_once('assets/f_pheader.php'); ?>
				...
				<div class="content">
                    ...
                    <form method="post" name="form1" action="f_capa_cursos_evaluacion.php" class="form-horizontal form-validate-jquery">
