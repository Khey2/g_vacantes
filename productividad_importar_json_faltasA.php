...
$query_revisar = "SELECT * FROM prod_activosfaltas WHERE IDempleado = $IDempleado";
$revisar = mysql_query($query_revisar, $vacantes) or die(mysql_error());
$row_revisar = mysql_fetch_assoc($revisar);
$totalRows_revisar = mysql_num_rows($revisar);

if ($totalRows_revisar == 0) {
