...
mysql_select_db($database_vacantes, $vacantes);
$query_mes = "SELECT DISTINCT 	vac_meses.mes,  vac_meses.IDmes FROM vac_meses RIGHT JOIN com_vd ON vac_meses.IDmes = com_vd.IDmes WHERE com_vd.anio = 2021";
			...
			<!-- Content area -->
				<div class="content">
                  ...
                  <div class="panel panel-flat">
                    ...
                    <form method="POST" action="vd_captura.php">
					<table class="table">
						<tbody>							  
							<tr>
							<td>
								<div class="col-lg-9">Mes
							...
							<td>
                            <div class="col-lg-9">Año
								 <select name="el_anio" class="form-control">
								   <option value="2021" <?php if (2021 == $el_anio) { echo "selected=\"selected\"";} ?>>2021</option>
								   <option value="2022" <?php if (2022 == $el_anio) { echo "selected=\"selected\"";} ?>>2022</option>
								   <option value="2023" <?php if (2023 == $el_anio) { echo "selected=\"selected\"";} ?>>2023</option>
								   <option value="2024" <?php if (2024 == $el_anio) { echo "selected=\"selected\"";} ?>>2024</option>
								   <option value="2025" <?php if (2025 == $el_anio) { echo "selected=\"selected\"";} ?>>2025</option>
								  </select>
						    </div>
                            </td>
							<td>
