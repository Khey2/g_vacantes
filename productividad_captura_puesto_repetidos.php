...
//repetidos
mysql_select_db($database_vacantes, $vacantes);
$query_repetidos = "SELECT  Count(prod_captura.IDempleado) AS repetidos, prod_captura.IDempleado FROM prod_captura WHERE prod_captura.IDmatriz = '$la_matriz' AND prod_captura.semana = '$semana' AND prod_captura.anio = '$anio' GROUP BY prod_captura.IDempleado HAVING repetidos > 1"; 
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Captura de Productividad (duplicados). </h5></br>
				  </div>
					...
					<table class="table table-condensed datatable-button-html5-columns">
						...
						//repetidos
						mysql_select_db($database_vacantes, $vacantes);
						$query_repetido = "SELECT * FROM prod_captura WHERE prod_captura.IDempleado = '$empleao' AND prod_captura.semana = '$semana'"; 
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="prod_captura_borrar.php?IDcaptura=<?php echo $row_repetido['IDcaptura']; ?>">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
