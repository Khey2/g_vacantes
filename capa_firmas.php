...
mysql_select_db($database_vacantes, $vacantes);
$query_autorizados = "SELECT * FROM capa_firmas";
				...
				<div class="content">
					...
					<div class="row">
					    ...
					    <div class="alert bg-danger-600 alert-styled-left">
							...
							Se borró correctamente la firma.
					    </div>
                        <?php } ?>
					    <!-- /basic alert -->
					    ...
					    <div class="alert bg-success-600 alert-styled-left">
							<button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Cerrar</span></button>
							Se guardó correctamente la firma.
					    </div>
                        <?php } ?>
					    <!-- /basic alert -->
					    ...
					    <!-- /basic alert -->
								...
								<a href="capa_firmas_cargar.php" class='btn btn-success btn-sm'>Agregar</a>
                     <p>&nbsp;</p>
					...
					<div class="form-group pt-2">
							...
							<table class="table datatable-reorder-state-saving">
                                ...
                                <tbody>
								  <?php do { ?>
									<tr>
                                    <td><?php echo $row_autorizados['IDfirma']; ?></td>
                                    <td><?php echo $row_autorizados['firma']; ?></td>
									<td>
									<a href="capa/<?php echo $row_autorizados['file']; ?>" class='btn btn-primary btn-sm' target="_blank">Descargar</a>
									<button type="button" data-target="#modal_theme_danger<?php echo $row_autorizados['IDfirma']; ?>"  data-toggle="modal" class="btn btn-danger btn-sm">Borrar</button>
									</td>
                                    </tr>

                     <!-- danger modal -->
					 <div id="modal_theme_danger<?php echo $row_autorizados['IDfirma']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<p>¿Estas seguro que quieres borrar la firma?.</p>
								</div>
