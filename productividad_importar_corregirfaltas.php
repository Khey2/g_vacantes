...
$insertSQL = sprintf("INSERT INTO prod_llave (llave, denominacion, empresa, descripcion_nivel, IDmatriz, IDsucursal, IDarea, IDpuesto, IDllaveJ) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $actualizarSQL = "UPDATE prod_activosfaltas SET IDmatriz = '$IDmatriz', IDsucursal = '$IDsucursal', IDpuesto = '$IDpuesto', IDarea = '$IDarea',  IDllave = '$IDllave', activo = 1  WHERE IDempleado = '$IDempleado'";
  $result = mysql_query($actualizarSQL, $vacantes) or die(mysql_error());
  
  
  header("Location: productividad_importarfaltas.php?info=1&info=4");
}
...
if (isset($_GET['borrar']) && $_GET['borrar'] == 1) {
  ...
  $deleteSQL = "DELETE FROM prod_activosfaltas WHERE IDempleado = '$IDempleado'";

  mysql_select_db($database_vacantes, $vacantes);
  $result = mysql_query($deleteSQL, $vacantes) or die(mysql_error());
  header("Location:  productividad_importarfaltas.php?info=1&info=5");
}
...
<?php } ?>
					...
					<div class="row">
							<div class="panel panel-flat">
                             ...
                             <form action="productividad_importar_corregirfaltas.php" method="post" name="importar" id="importar"  class="form-horizontal form-validate-jquery">
