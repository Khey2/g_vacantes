...
?>
                            ...
                            <?php if ($row_puestos['capturador'] == '') { ?>
            					...
            					<form method="post" class="form-horizontal form-validate-jquery" name="form1" action="productividad_captura_puesto.php?IDpuesto=<?php echo $row_puestos['IDpuesto']; ?>" >
									...
									<div class="form-group">
											<div class="form-group">
											 <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="$ DE PAGO ADICIONAL">ADICIONAL ($)</label>
												<div class="col-sm-9">
													<input type="number" <?php if( $row_matriz['adicionales'] == 0) { echo "disabled='disabled'";} ?> name="adicional" value="<?php echo htmlentities($row_puestos['adicional'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
