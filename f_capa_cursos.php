...
$query_evaluacioncurso = "SELECT AVG(preg21) AS Total FROM capa_curso_seguridad_respuestas";
...
$query_evaluacioncurso2 = "SELECT preg21 FROM capa_curso_seguridad_respuestas";
...
if (isset($_GET['IDmodulo'])) {
	...
	$deleteSQL = "UPDATE capa_curso_seguridad SET $modulo$IDmodulo = 1, $modulo$IDmodulo$fecha =  NOW() WHERE IDempleado = $el_usuario";
	mysql_select_db($database_vacantes, $vacantes);
	...
	$deleteSQL = "INSERT INTO capa_curso_seguridad (IDempleado, $modulo$IDmodulo, $modulo$IDmodulo$fecha) VALUES ($el_usuario, 1, NOW())";
	mysql_select_db($database_vacantes, $vacantes);
	$result = mysql_query($deleteSQL, $vacantes) or die(mysql_error());
	
	}

	header("Location: f_capa_cursos.php?info=1");
  }
											...
											<table class="table table-striped">
												...
												<tbody>
													<tr>
														...
														<td>
															<a class="btn btn-xs btn-primary" href="f_capa_cursos_detalle.php?IDmodulo=1">Acceder</a>
														</td>
													</tr>
													<tr>
														<td>Lección 2</td>
														...
														<td>
														<?php if ($modulo1 == 1) { ?>											
															<a class="btn btn-xs btn-primary" href="f_capa_cursos_detalle.php?IDmodulo=2">Acceder</a>
														<?php } else { ?>
													...
													<tr>
														...
														<td>
														<?php if ($modulo2 == 1) { ?>											
														<a class="btn btn-xs btn-primary" href="f_capa_cursos_detalle.php?IDmodulo=3">Acceder</a>
														<?php } else { ?>
															<a class="btn btn-xs btn-default" disabled="disabled">Acceder</a>
														<?php } ?>		
														</td>
													...
													<tr>
														...
														<td>
														<?php if ($modulo3 == 1) { ?>											
															<a class="btn btn-xs btn-primary" href="f_capa_cursos_detalle.php?IDmodulo=4">Acceder</a>
														<?php } else { ?>
															<a class="btn btn-xs btn-default" disabled="disabled">Acceder</a>
														<?php } ?>		
														</td>
													...
													<tr>
														...
														<td>
														<?php if ($modulo4 == 1) { ?>											
															<a class="btn btn-xs btn-primary" href="f_capa_cursos_detalle.php?IDmodulo=5">Acceder</a>
														<?php } else { ?>
															<a class="btn btn-xs btn-default" disabled="disabled">Acceder</a>
														<?php } ?>		
														</td>
											...
											<thead>
												...
												<tbody>
													<tr>
														...
														<a class="btn btn-xs btn-primary" href="f_capa_cursos_evaluacion.php">Acceder</a>
														<?php } else  if ( $evaluacion> 0) { ?>
														<a class="btn btn-xs btn-success" href="f_capa_cursos_evaluacion_respuestas.php">Ver Respuestas</a>
														<?php } else { ?>
