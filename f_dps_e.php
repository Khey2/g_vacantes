...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  header("Location: f_dps_e.php?info=1&IDpuesto=$IDpuesto");
}
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  header("Location: f_dps_e.php?info=2&IDpuesto=$IDpuesto");
}
					...
					<div id="modal_theme_danger<?php echo $row_puesto_catalogos1['IDcriterio']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                    <a class="btn btn-danger" href="f_dps_borrar.php?IDcriterio=<?php echo $row_puesto_catalogos1['IDcriterio']; ?>&IDpuesto=<?php echo $IDpuesto; ?>&pagina=e">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div id="modal_theme_danger<?php echo $row_puesto_catalogos2['IDcriterio']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                    <a class="btn btn-danger" href="f_dps_borrar.php?IDcriterio=<?php echo $row_puesto_catalogos2['IDcriterio']; ?>&IDpuesto=<?php echo $IDpuesto; ?>&pagina=e">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div id="modal_theme_danger<?php echo $row_puesto_catalogos3['IDcriterio']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                    <a class="btn btn-danger" href="f_dps_borrar.php?IDcriterio=<?php echo $row_puesto_catalogos3['IDcriterio']; ?>&IDpuesto=<?php echo $IDpuesto; ?>&pagina=e">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div id="modal_theme_danger<?php echo $row_puesto_catalogos4['IDcriterio']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                    <a class="btn btn-danger" href="f_dps_borrar.php?IDcriterio=<?php echo $row_puesto_catalogos4['IDcriterio']; ?>&IDpuesto=<?php echo $IDpuesto; ?>&pagina=e">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div id="modal_theme_danger<?php echo $row_puesto_catalogos5['IDcriterio']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                    <a class="btn btn-danger" href="f_dps_borrar.php?IDcriterio=<?php echo $row_puesto_catalogos5['IDcriterio']; ?>&IDpuesto=<?php echo $IDpuesto; ?>&pagina=e">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
