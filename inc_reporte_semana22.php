...
// Increment the Excel row counter
    ...
    header('Content-Disposition: attachment;filename="Compensacion por Suplencia - Semana ' . $semana . " del " . $anio .  ' global.xls"');
