...
$correo = $_POST['email'];
mysql_select_db($database_vacantes, $vacantes);
$query_usuario = "SELECT * FROM vac_usuarios WHERE usuario_correo = '$correo'";
...
//mandamos llave
$query1 = "INSERT into vac_key (usuario, llave) VALUE ('$elusuario', '$llave')";
							...
							<div class="form-group has-feedback has-feedback-left">
							 ...
							 { echo $_POST['email']; } else { echo "Tu correo";} ?>">
								<div class="form-control-feedback">
                                    ...
                                    <div class="g-recaptcha" data-sitekey="6LeT7fwUAAAAAJ3I8bclRXAgfuBATT987x3DvVsQ"></div>
