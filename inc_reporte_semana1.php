...
mysql_select_db($database_vacantes, $vacantes);
$query_reporte = "SELECT prod_activos.IDempleado, prod_activos.emp_paterno, prod_activos.emp_materno, prod_activos.emp_nombre, vac_puestos.denominacion, prod_activos.sueldo_diario, inc_captura_2020.dias1, inc_captura_2020.horas1, inc_motivos.motivo, inc_captura_2020.inc1, inc_captura_2020.validador, inc_captura_2020.obs1, prod_activos.descripcion_nomina FROM prod_activos LEFT JOIN vac_puestos ON prod_activos.IDpuesto = vac_puestos.IDpuesto LEFT JOIN vac_matriz ON prod_activos.IDmatriz = vac_matriz.IDmatriz INNER JOIN inc_captura_2020 ON inc_captura_2020.IDempleado = prod_activos.IDempleado AND inc_captura_2020.semana = '$semana' LEFT JOIN inc_motivos ON inc_captura_2020.IDmotivo1 = inc_motivos.IDmotivo WHERE prod_activos.IDmatriz = '$IDmatriz' AND inc_captura_2020.inc1 > 0";
...
mysql_select_db($database_vacantes, $vacantes);
$query_reporte = "SELECT prod_activos.IDempleado, prod_activos.emp_paterno, prod_activos.emp_materno, prod_activos.emp_nombre, vac_puestos.denominacion, prod_activos.sueldo_diario, inc_captura.dias1, inc_captura.horas1, inc_motivos.motivo, inc_captura.inc1, inc_captura.validador, inc_captura.obs1, prod_activos.descripcion_nomina FROM prod_activos LEFT JOIN vac_puestos ON prod_activos.IDpuesto = vac_puestos.IDpuesto LEFT JOIN vac_matriz ON prod_activos.IDmatriz = vac_matriz.IDmatriz INNER JOIN inc_captura ON inc_captura.IDempleado = prod_activos.IDempleado AND inc_captura.semana = '$semana'  AND inc_captura.anio = '$anio' LEFT JOIN inc_motivos ON inc_captura.IDmotivo1 = inc_motivos.IDmotivo WHERE prod_activos.IDmatriz = '$IDmatriz' AND inc_captura.inc1 > 0";
mysql_query("SET NAMES 'utf8'"); 
$reporte = mysql_query($query_reporte, $vacantes) or die(mysql_error());
...
// Increment the Excel row counter
    ...
    header('Content-Disposition: attachment;filename="Horas Extra '.date('dmY') . " " . $matriz . '.xls"');
