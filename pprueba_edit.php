...
//activo?
$query_empleado_act = "SELECT * FROM prod_activos WHERE IDempleado = $IDempleado AND IDmatriz = $la_matriz";
...
if($totalRows_empleado_dob > 0) { header("Location: pprueba_edit.php?info=8"); $avalidar = 2;}
...
} else { header("Location: pprueba_edit.php?info=9"); $avalidar = 2;}
...
$insertSQL = sprintf("INSERT INTO pp_prueba (IDempleado, IDpuesto, IDarea, IDmatriz, IDestatus, sueldo_actual) VALUES (%s, %s, %s, %s, %s, %s)",
 ...
 header("Location: pprueba_edit_2.php?IDpprueba=$last_id&info=1");
}
		...
		<?php require_once('assets/menu.php'); ?>
			...
			<?php require_once('assets/pheader.php'); ?>
				...
				<div class="content">
					    ...
					    <div class="alert bg-warning-600 alert-styled-left">
							<button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Cerrar</span></button>
							El No. de empleado capturado ya tiene un PP capturado.
					    </div>
                        <?php } ?>
					    <!-- /basic alert -->
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body">
							<p>PASO 1. Ingresa el No. de Empelado a proverse para validar que el empleado esté activo y sus datos básicos.<br/>
							Si no aparece el sueldo, solicitalo a Desarrollo Organizacional.<br/>
							No puedes agregar a empleados de otra Sucursal.</p>
                            <p>&nbsp;</p>
						...
						<legend class="text-semibold">Resultado</legend>
                         ...
                         <input type="submit" name="KT_insert1" class="btn btn-primary" id="KT_insert1" value="Agregar PP" />
                    	 <button type="button" onClick="window.location.href='pprueba_edit.php'" class="btn btn-warning btn-icon">Buscar otro</button>
