...
<body class="has-detached-right <?php if (isset($_COOKIE["lmenu"])) { echo 'sidebar-xs';}?>">
            ...
            <?php  } ?>
				...
				<div class="panel panel-flat">
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<form action="b_procedimientos.php" method="post" class="main-search">
                        ...
                        ?>
							...
							<ul class="media-list">
                                ...
                                <div class="media-left">
									...
									<?php } else { ?>
									<a href="b_procedimientos_file.php?IDdocumento=<?php echo $row_documentos['IDdocumento'] ?>" class="btn bg-success-400 mt-15 btn-block"><i class="icon-file-download2 position-left"></i>Descargar</a>
									<?php } ?>
	...
	<div class="sidebar-category">
		...
		$totalRows_direcciones_count = mysql_num_rows($direcciones_count);
				?>
						...
						<li style="list-style: none;">
							<strong><a style="color:#352C2C;" href="b_procedimientos.php?IDdireccion=<?php echo $row_direcciones['IDdireccion'] ?>"><i class="icon-forward3"></i> <?php echo $row_direcciones['direccion'] ?></a> (<?php echo $totalRows_direcciones_count; ?>)</strong>
		...
		$totalRows_areas_count = mysql_num_rows($areas_count);
					...
					<a href="b_procedimientos.php?IDdireccion=<?php echo $row_direcciones['IDdireccion'] ?>&IDDarea=<?php echo $row_areas['IDDarea'] ?>"><i class="icon-arrow-right5"></i> <?php echo $row_areas['area'] ?> (<?php echo $totalRows_areas_count; ?>)</a>
					<?php if ($row_areas['IDDarea'] == 93) { echo "</strong>"; } ?>					
		...
		$totalRows_subareas_count = mysql_num_rows($subareas_count);
						?>
									...
									<li style="list-style: none;"><i class="icon-arrow-right22"></i> <a href="b_procedimientos.php?IDdireccion=<?php echo $row_direcciones['IDdireccion'] ?>&IDDarea=<?php echo $row_areas['IDDarea'] ?>&IDsubarea=<?php echo $row_subarea['IDsubarea'] ?>"><?php echo $row_subarea['subarea'] ?> (<?php echo $totalRows_subareas_count; ?>)</a></li>
...
function loadDynamicContentModal(modal){
	...
	$('#conte-modal').load('b_procedimientos_mdl.php?IDdocumento='+ modal, function() {
