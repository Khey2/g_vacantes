...
<div class="content">
					...
					<!-- /colored button -->                   
                      ...
                      <?php do { ?>
                        <tr>
                         ...
                         <button type="button" class="btn btn-primary btn-xs" onClick="window.location.href='master_admin_usuarios_edit.php?IDusuario=<?php echo $row_usuarios['IDusuario']; ?>'"><i class="icon-pencil"></i></button> 
                         <button type="button" data-target="#modal_theme_danger<?php echo $row_usuarios['IDusuario']; ?>"  data-toggle="modal" class="btn btn-danger btn-xs"><i class="icon-trash"></i></button>
                         <button type="button" data-target="#modal_theme_danger2<?php echo $row_usuarios['IDusuario']; ?>"  data-toggle="modal" class="btn btn-warning btn-xs"><i class="icon-key"></i></button>
						 </td>
                        </tr>      
                  ...
                  <!-- danger modal -->
					...
					<!-- /danger modal -->
					                  ...
					                  <!-- danger modal -->
					<div id="modal_theme_danger2<?php echo $row_usuarios['IDusuario']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header bg-danger">
									<button type="button" class="close" data-dismiss="modal">&times;</button>
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                    <a class="btn btn-danger" href="master_admin_usuarios_reset.php?IDusuario=<?php echo $row_usuarios['IDusuario']; ?>">Si restaurar</a>
								</div>
							</div>
						</div>
					</div>
