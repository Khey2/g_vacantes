					...
					<div class="row">
							<div class="panel panel-flat">
								...
								<div class="panel-body">
                                    ...
                                    1. Da clic en los eventos indicados en cada etapa para ver el detalle de cada uno al dar clic en la fecha del evento.</br>
					...
					<table class="table table-condensed datatable-button-html5-columns">
						...
						?>
                          <tr>
                            ...
                            <td><?php echo $row_asesorias['mes']."/".$row_asesorias['anio']; ?></td>
							<td>
