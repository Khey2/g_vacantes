...
// redireccionar
header("Location: capa_becarios_evaluar_update.php?IDempleado=$IDempleado&IDmes=$el_mes&anio=$anio"); 
}
...
<body>
	...
	<form>
	<p class="ocultar"><strong>Intrucciones</strong>: Haz click en imprimir para imprimir</p>
	<input type="button" value="Imprimir" onclick="javascript:window.print()" class="btn btn-success ocultar"/>
	</form>
