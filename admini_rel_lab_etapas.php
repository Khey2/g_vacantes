...
mysql_select_db($database_vacantes, $vacantes);
$query_asesoria = "SELECT rel_lab_etapas.IDasesoria_etapa, rel_lab_etapas.IDasesoria, rel_lab_etapas.IDetapa, rel_lab_etapas.IDestatus, rel_lab_etapas.IDempleado_jefe, rel_lab_etapas.IDempleado_rh, rel_lab_etapas.IDempleado_testigo, rel_lab_etapas.file, rel_lab_etapas.fecha_captura, rel_lab_etapas.fecha_inicio, rel_lab_etapas.fecha_fin, rel_lab_etapas.texto_esperado, rel_lab_etapas.texto_observado, rel_lab_etapas.observaciones, rel_lab_asesorias.IDempleado, rel_lab_asesorias.emp_paterno, rel_lab_asesorias.emp_materno, rel_lab_asesorias.fecha_antiguedad, rel_lab_asesorias.emp_nombre, rel_lab_asesorias.denominacion, rel_lab_asesorias.rfc, rel_lab_asesorias.IDpuesto, rel_lab_asesorias.IDsucursal, rel_lab_asesorias.IDarea, rel_lab_asesorias.anio, rel_lab_asesorias.IDmatriz, rel_lab_asesorias.IDestatus, rel_lab_etapas.politica1, rel_lab_etapas.politica2, rel_lab_etapas.politica3, rel_lab_etapas.politica4 FROM rel_lab_etapas LEFT JOIN rel_lab_asesorias ON rel_lab_etapas.IDasesoria = rel_lab_asesorias.IDasesoria WHERE rel_lab_etapas.IDasesoria_etapa = $IDasesoria_etapa";
...
mysql_select_db($database_vacantes, $vacantes);
$query_asesoria = "SELECT rel_lab_asesorias.IDempleado, rel_lab_asesorias.emp_paterno, rel_lab_asesorias.emp_materno, rel_lab_asesorias.fecha_antiguedad, rel_lab_asesorias.emp_nombre, rel_lab_asesorias.denominacion, rel_lab_asesorias.rfc, rel_lab_asesorias.IDpuesto, rel_lab_asesorias.IDsucursal, rel_lab_asesorias.IDarea, rel_lab_asesorias.anio, rel_lab_asesorias.IDmatriz, rel_lab_asesorias.IDestatus FROM rel_lab_asesorias WHERE rel_lab_asesorias.IDasesoria = $IDasesoria";
$asesoria = mysql_query($query_asesoria, $vacantes) or die(mysql_error());
$row_asesoria = mysql_fetch_assoc($asesoria);
$totalRows_asesoria = mysql_num_rows($asesoria);
...
header('Location: admin_rel_lab_etapas.php?info=9&IDempleado='.$IDempleado.'&IDetapa='.$IDetapa.'&IDasesoria='.$IDasesoria.'');
exit;
} 
...
$insertSQL = sprintf("INSERT INTO rel_lab_etapas (IDasesoria, IDetapa, IDempleado_jefe, IDempleado_rh, IDempleado_testigo, file, fecha_captura, fecha_inicio, fecha_fin, texto_esperado, texto_observado, observaciones, politica1, politica2, politica3, politica4) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
 ...
 header("Location: admin_rel_lab.php?IDasesoria=$IDasesoria&info=1");
 }
...
$updateSQL = sprintf("UPDATE rel_lab_etapas SET file=%s, IDempleado_jefe=%s, IDempleado_rh=%s, IDempleado_testigo=%s, fecha_captura=%s,  fecha_inicio=%s, fecha_fin=%s, texto_esperado=%s, texto_observado=%s, observaciones=%s, politica1=%s, politica2=%s, politica3=%s, politica4=%s WHERE IDetapa = $IDetapa AND IDasesoria_etapa=%s",
                       GetSQLValueString($name_new, "text"),
                       GetSQLValueString($_POST['IDempleado_jefe'], "text"),
                       GetSQLValueString($_POST['IDempleado_rh'], "text"),
                       GetSQLValueString($_POST['IDempleado_testigo'], "text"),
 ...
 $last_id =  mysql_insert_id();
 header("Location: admin_rel_lab.php?IDasesoria=$IDasesoria&info=2");
 }
...
echo "123".$row_asesoria['IDestatus'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<?php if ($IDetapa == 1) {?>
						...
						<legend class="text-semibold">Etapa 1: Reorientación Eficaz</legend>
								  ...
								  <div class="form-group">
										...
										<div class="col-lg-9">
                                          <textarea name="texto_esperado" rows="3" class="wysihtml5 wysihtml5-min form-control" id="texto_esperado" placeholder="Indique los acuerdos verbales que se hayan comprometidos en la reorientación eficaz."><?php if (isset($row_asesoria['texto_esperado'])) { echo $row_asesoria['texto_esperado']; } ?></textarea>
								  ...
								  <div class="form-group">
										...
										<div class="col-lg-9">
                                          <textarea name="texto_observado" rows="3" class="wysihtml5 wysihtml5-min form-control" id="texto_observado" placeholder="Indique los acuerdos que se hayan cumplido y los que no se hayan logrado cubrir y las razones."><?php if (isset($row_asesoria['texto_observado'])) { echo $row_asesoria['texto_observado']; } ?></textarea>
								  ...
								  <div class="form-group">
										...
										<div class="col-lg-9">
                                          <textarea name="observaciones" rows="3" class="wysihtml5 wysihtml5-min form-control" id="observaciones" placeholder="Indique observaciones relevantes de la Asesoría."><?php if (isset($row_asesoria['observaciones'])) { echo $row_asesoria['observaciones']; } ?></textarea>
...
<?php } else if ($IDetapa == 2) {?>
						...
						<legend class="text-semibold">Etapa 2: Asesoría para Mejorar</legend>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
						<input type="text" name="IDempleado_jefe" id="IDempleado_jefe" class="form-control" value="<?php if (isset($row_asesoria['IDempleado_jefe'])) { echo $row_asesoria['IDempleado_jefe']; } ?>" placeholder="Indique el nombre del jefe inmediato del Empleado" >
										</div>
									</div>
									<!-- /basic text input -->
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
						<input type="text" name="IDempleado_rh" id="IDempleado_rh" class="form-control" value="<?php if (isset($row_asesoria['IDempleado_rh'])) { echo $row_asesoria['IDempleado_rh']; } ?>" placeholder="Indique el nombre del representante de RH">
										</div>
									</div>
									<!-- /basic text input -->
...
<?php } else if ($IDetapa == 3) {?>
						...
						<input type="text" name="IDempleado_jefe" id="IDempleado_jefe" class="form-control" value="<?php if (isset($row_asesoria['IDempleado_jefe'])) { echo $row_asesoria['IDempleado_jefe']; } ?>" placeholder="Indique el nombre del jefe inmediato del Empleado" >
									...
									<div class="form-group">
										<label class="control-label col-lg-3">Recursos Humanos:</label>
										<div class="col-lg-9">
						<input type="text" name="IDempleado_rh" id="IDempleado_rh" class="form-control" value="<?php if (isset($row_asesoria['IDempleado_jefe'])) { echo $row_asesoria['IDempleado_rh']; } ?>" placeholder="Indique el nombre del representante de RH">
										</div>
									</div>
									<!-- /basic text input -->
						...
						<input type="text" name="IDempleado_testigo" id="IDempleado_testigo" class="form-control" value="<?php if (isset($row_asesoria['IDempleado_jefe'])) { echo $row_asesoria['IDempleado_testigo']; } ?>" placeholder="Indique el nombre del testigo">
								  ...
								  <div class="form-group">
										<label class="control-label col-lg-3">Acuerdos establecidos:</label>
										<div class="col-lg-9">
                                          <textarea name="texto_esperado" rows="3" class="wysihtml5 wysihtml5-min form-control" id="texto_esperado" placeholder="Indique los acuerdos verbales que se hayan comprometidos en la reorientación eficaz."><?php if (isset($row_asesoria['IDempleado_jefe'])) { echo $row_asesoria['texto_esperado']; }?></textarea>
								  ...
								  <div class="form-group">
										<label class="control-label col-lg-3">Acuerdos logrados:</label>
										<div class="col-lg-9">
                                          <textarea name="texto_observado" rows="3" class="wysihtml5 wysihtml5-min form-control" id="texto_observado" placeholder="Indique los acuerdos que se hayan cumplido y los que no se hayan logrado cubrir y las razones."><?php if (isset($row_asesoria['IDempleado_jefe'])) { echo $row_asesoria['texto_observado']; } ?></textarea>
...
<?php } ?>
								...
								<?php if(isset($_GET['IDasesoria_etapa']) AND  $row_asesoria['IDestatus'] != 2) { ?>
								<?php if(isset($_GET['IDasesoria_etapa'])) { ?>
										<button type="submit"  class="btn btn-primary">Actualizar111</button>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="admin_rel_lab_etapas.php?IDasesoria_etapa=<?php echo $IDasesoria_etapa; ?>&borrar=1">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
