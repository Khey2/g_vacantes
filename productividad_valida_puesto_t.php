...
if ($_POST['horas_extra'] == ''){$horas_extra = 0;} else {$horas_extra = $_POST['horas_extra'];}
  ...
  $updateGoTo = "productividad_valida_puesto_update_t.php?IDcaptura=$captura";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$updateGoTo = "productividad_valida_puesto_t.php?IDpuesto=".$el_puesto."&info=1";
if (isset($_SERVER['QUERY_STRING'])) {
  $updateGoTo .= (strpos($updateGoTo, '?')) ? "&" : "?";
  $updateGoTo .= $_SERVER['QUERY_STRING'];
}
...
<!-- Page container -->
	<div class="page-container">
		...
		<?php require_once('assets/menu.php'); ?>
            ...
            <?php if((isset($_GET['info']) && ($_GET['info'] == 1))) { ?>
              ...
              <!-- Basic alert -->
                    ...
                    <p>Selecciona el nombre del empleado para ver su histórico de pago de productividad. Da clic en el botón para validar su productividad.</p>
      ...
      <form method="POST" name="form3" action="productividad_valida_puesto_t.php?IDpuesto=<?php echo $el_puesto; ?>">
					...
					<table class="table table-condensed datatable-button-html5-columns">
                        ...
                        <?php } ?>
                            ...
                            <td><a href="prod_empleado_detalle.php?IDempleado=<?php echo $row_puestos['IDempleado']; ?>">
							              <?php echo $row_puestos['emp_paterno']; ?> <?php echo $row_puestos['emp_materno']; ?> <?php echo $row_puestos['emp_nombre']; ?></a>                                      
                            </td>
						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content text-center">
								...
								<button type="button" class="close" data-dismiss="modal">&times;</button>
               					  <h5 class="modal-title">Validación de productividad</h5>
								</div>
...
function loadDynamicContentModal(modal){
	...
	$('#conte-modal').load('productividad_valida_puesto_mdl_t.php?IDpuesto=' + IDpuesto + '&semana=' + semana  + '&IDturno=' + IDturno + '&IDmatriz=' + IDmatriz + '&IDempleado='+ modal, function() {
...
function loadDynamicContentModal_t(modal){
	...
	$('#conte-modal').load('productividad_turno_valida.php?IDempleado='+ modal, function() {
		$('#bootstrap-modal').modal({show:true});
    });    
}
</script> 
