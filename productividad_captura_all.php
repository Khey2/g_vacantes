                    ...
                    <tbody>
									    <?php do {  ?>
									      <tr>
                                            ...
                                            onClick="window.location.href='productividad_captura_puesto_all.php?IDpuesto=<?php echo $row_detalle['IDpuesto']; ?>'"><i class="icon-arrow-right6"></i> Ver Empleados</button>
                                            </td>                                            
