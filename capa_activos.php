...
<!-- Content area -->
				<div class="content">
 				...
 				<form method="POST" action="capa_activos.php">
                	<table class="table">
						<tbody>							  
							<tr>
							<td>
                                ...
                                <tbody>
								  <?php do { ?>
                                    <tr>
                                      ...
                                      <td><button type="button" data-target="#modal_theme_danger<?php echo $row_autorizados['IDempleado']; ?>"  data-toggle="modal" class="btn btn-warning btn-icon">Password </button>
									</td>
                                    </tr>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
                                    ...
                                    <a class="btn btn-warning" href="capa_activos_pass.php?IDempleado=<?php echo $row_autorizados['IDempleado']; ?>">Si restaurar</a>
								</div>
							</div>
						</div>
					</div>
