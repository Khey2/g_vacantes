...
if ($_POST['a28'] == ''){$_a28 = 0;} else {$_a28 = $_POST['a28'];}
  ...
  $updateGoTo = "productividad_valida_puesto_uptdate.php?IDcaptura=$captura";
  if (isset($_SERVER['QUERY_STRING'])) {
...
function loadDynamicContentModal(modal){
	...
	$('#conte-modal').load('productividad_valida_puesto_mdl.php?IDpuesto=' + IDpuesto + '&semana=' + semana + '&IDsucursal=' + IDsucursal + '&IDmatriz=' + IDmatriz + '&IDempleado='+ modal, function() {
