...
<p align="center"><strong>RECIBO DE REGLAMENTO INTERIOR DE TRABAJO</strong></p>
&nbsp; <br>
...
<p><strong>SUCURSAL: </strong>'.$estado.'</p>
<p><strong>NOMBRE: </strong>'.$row_contratos['a_nombre'].' '.$row_contratos['a_paterno'].' '.$row_contratos['a_materno'].'</p>
<p><strong>No. Empleado: </strong>'.$noemp.'</p>
<p><strong>FECHA DE ALTA: </strong>'.$ini_cont_d.' de '.$ini_cont_m.' de '.$ini_cont_y.'</p>

<p>RECIB&#205; DE '.$empresa.'. el REGLAMENTO INTERIOR DE TRABAJO, quedando obligado al cumplimiento en sus t&#233;rminos por formar parte de mi Contrato Individual de Trabajo.</p>
&nbsp; <br>
&nbsp; <br>
...
$nombreDelDocumento = "CONOCIMIENTO RIT ".date('dmY')." ".$IDempleado.".pdf";
