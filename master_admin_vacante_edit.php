...
$upd_vac_vacante->registerTrigger("END", "Trigger_Default_Redirect", 99, "master_admin_vacantes.php?info=2");
    ...
    <form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" enctype="multipart/form-data" class="form-horizontal form-validate-jquery">
                    ...
                    <?php $cnt1++; ?>
						...
						<input type="file" name="archivo_<?php echo $cnt1; ?>" id="archivo_<?php echo $cnt1; ?>" class="file-styled">
                         ...
                         <button type="button" onClick="window.location.href='master_admin_vacantes.php'" class="btn btn-default btn-icon">Regresar</button>
                                <?php }  ?>
                            </div>
                          </div>
                       </fieldset>
