...
$updateSQL = sprintf("UPDATE prod_captura SET IDempleado=%s, emp_paterno=%s,  emp_materno=%s,  emp_nombre=%s, denominacion=%s, sueldo_total=%s, IDpuesto=%s, fecha_captura=%s, semana=%s, IDmatriz=%s, IDsucursal=%s, IDturno=%s, IDarea=%s, a1=%s, a2=%s, a3=%s, a4=%s, a5=%s, a6=%s, a7=%s, a8=%s, a9=%s, a10=%s, a11=%s, a12=%s, a13=%s, a14=%s, a15=%s, a16=%s, a17=%s, a18=%s, a19=%s, a20=%s, a21=%s, a22=%s, a23=%s, a24=%s, a25=%s, a26=%s, a27=%s, a28=%s, a29=%s, horas_extra=%s, validador=%s, garantizado=%s, adicional=%s, observaciones=%s, lun=%s, mar=%s, mie=%s, jue=%s, vie=%s, sab=%s, dom=%s, lun_g=%s, mar_g=%s, mie_g=%s, jue_g=%s, vie_g=%s, sab_g=%s WHERE IDcaptura='$captura'",
  ...
  $updateGoTo = "productividad_valida_puesto_uptdate_a_t.php?IDcaptura=$captura";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  ...
  $updateGoTo = "productividad_valida_puesto_a_t.php?IDpuesto=".$el_puesto."&info=1";
  if (isset($_SERVER['QUERY_STRING'])) {
    $updateGoTo .= (strpos($updateGoTo, '?')) ? "&" : "?";
    $updateGoTo .= $_SERVER['QUERY_STRING'];
  }
		...
		<?php require_once('assets/menu.php'); ?>
            ...
            <?php if((isset($_GET['info']) && ($_GET['info'] == 1))) { ?>
              ...
              <!-- Basic alert -->
                    ...
                    <p>Selecciona el nombre del empelado para ver su histórico de pago de productividad. Da clic en el botón para validar su productividad.</p>
                    <p>Da clic en el incono de <i class=" icon-sort-time-asc text-info"></i> para cambiar el turno del colaborador.</p>
				
                    
    <form method="POST" name="form3" action="productividad_valida_puesto_a_t.php?IDpuesto=<?php echo $el_puesto; ?>">
...
function loadDynamicContentModal(modal){
	...
	$('#conte-modal').load('productividad_valida_puesto_amdl_t.php?IDpuesto=' + IDpuesto + '&semana=' + semana + '&IDturno=' + IDturno + '&IDmatriz=' + IDmatriz + '&IDempleado='+ modal, function() {
...
function loadDynamicContentModal_t(modal){
	...
	$('#conte-modal').load('productividad_turno_valida_a.php?IDempleado='+ modal, function() {
		$('#bootstrap-modal').modal({show:true});
    });    
}
</script> 
