					...
					<div class="row">
							<div class="panel panel-flat">
								<div class="panel-heading">
									<h6 class="panel-title">Importar Productividad Faltas V3.0</h6>
									<div class="heading-elements">
				                	</div>
								</div>
							
								<div class="panel-body">
								<p><a class="btn btn-success" href="productividad_importar_json_faltas.php">Importar <i class="icon icon-file-download"></i></a></p>
