                                ...
                                <tbody>
								  ...
								  do { $totales = $totales + $row_autorizados['Autorizada'];  ?>
                                    <tr>
                                      ...
                                      <td><a href="plantilla_detalle.php?IDpuesto=<?php echo $row_autorizados['IDpuesto']; ?>&IDmatriz=<?php echo $row_autorizados['IDmatriz']; ?>&IDtipo_plaza=<?php echo $row_autorizados['IDtipo_plaza']; ?>&fecha_filtro=<?php echo $fecha_filtro; ?>" class="btn btn-primary">Ver detalles</a></tr>
