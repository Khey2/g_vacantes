...
mysql_select_db($database_vacantes, $vacantes);
$query_faq = "SELECT * FROM vac_faqs WHERE tipo = 1";
						...
						<div class="col-lg-3">
							...
							<div class="panel panel-flat">
								...
								<div class="list-group no-border mb-5">
									<a href="cambio_pass.php" class="list-group-item"><i class="icon-lock2"></i>Cambiar Password</a>
									<a href="mi_matriz.php" class="list-group-item"><i class="icon-city"></i> Cambiar Matriz</a>
									<a href="mi_perfil.php" class="list-group-item"><i class="icon-user-check"></i>  Editar Perfil</a>
