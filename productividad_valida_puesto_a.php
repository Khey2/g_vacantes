						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content text-center">
								...
								<button type="button" class="close" data-dismiss="modal">&times;</button>
               					  <h5 class="modal-title">Valida indicadores de productividad</h5>
								</div>
...
function loadDynamicContentModal(modal){
	...
	$('#conte-modal').load('productividad_valida_puesto_amdl.php?IDpuesto=' + IDpuesto + '&semana=' + semana + '&IDsucursal=' + IDsucursal + '&IDmatriz=' + IDmatriz + '&IDempleado='+ modal, function() {
