...
$query1 = "UPDATE prod_captura SET adicional3 = '$diferencia1', pago_resto = '$diferencia2', bono_asistencia = '$bono_asistencia', validador = '$el_usuario', pago = '$porc_pago', pago_total = '$monto_T', reci = '$reci', carg = '$carg', esti = '$esti', dist = '$dist' WHERE IDcaptura = '$IDcaptura'"; 
