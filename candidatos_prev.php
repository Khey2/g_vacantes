...
mysql_select_db($database_vacantes, $vacantes);
$query_candidatos = "SELECT * FROM cv_activos WHERE cv_activos.IDmatriz = '$la_matriz'";
...
$query_candidatos_1 = "SELECT Count(cv_activos.IDusuario) as Total, cv_activos.IDusuario, cv_dependientes.IDref FROM cv_activos INNER JOIN cv_dependientes ON cv_dependientes.IDusuario = cv_activos.IDusuario WHERE cv_dependientes.IDref = 'f' AND cv_activos.IDusuario = '$IDusuario' AND borrado = 0";
$candidatos_1 = mysql_query($query_candidatos_1, $vacantes) or die(mysql_error());
$row_candidatos_1 = mysql_fetch_assoc($candidatos_1);

$query_candidatos_2 = "SELECT Count(cv_activos.IDusuario) as Total, cv_activos.IDusuario, cv_dependientes.IDref FROM cv_activos INNER JOIN cv_dependientes ON cv_dependientes.IDusuario = cv_activos.IDusuario WHERE cv_dependientes.IDref = 'e' AND cv_activos.IDusuario = '$IDusuario' AND borrado = 0";
$candidatos_2 = mysql_query($query_candidatos_2, $vacantes) or die(mysql_error());
$row_candidatos_2 = mysql_fetch_assoc($candidatos_2);

$query_candidatos_3 = "SELECT Count(cv_activos.IDusuario )as Total, cv_activos.IDusuario, cv_dependientes.IDref FROM cv_activos INNER JOIN cv_dependientes ON cv_dependientes.IDusuario = cv_activos.IDusuario WHERE cv_dependientes.IDref = 'r' AND cv_activos.IDusuario = '$IDusuario' AND borrado = 0";
