					    ...
					    <div class="alert bg-danger-600 alert-styled-left">
						 Primero se debe asignar turno.
							...
							<?php } else  { ?>
            					...
            					<form method="post" name="form1<?php echo $row_puestos['IDempleado']; ?>" action="productividad_valida_puesto_a_t.php?IDpuesto=<?php echo $row_puestos['IDpuesto']; ?>" 
                                class="form-horizontal form-validate-jquery">
									...
									<div class="form-group">
									 <div class="row">
										<label class="control-label col-sm-2" data-popup="tooltip-custom" title="REPORTE DIARIO DE ASISTENCIA">PUNTUALIDAD Y ASISTENCIA</label>
											<div class="col-sm-1">
											<div class="checkbox">
												<label>
								...
								<div class="form-group">
		 							<div class="row">
										...
										<div class="col-sm-4">
											...
											<label class="control-label col-sm-2" data-popup="tooltip-custom" title="HORAS EXTRAS">HORAS EXTRAS (No.)</label>
										<div class="col-sm-3">
