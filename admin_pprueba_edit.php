...
$query_empleado_dob = "SELECT * FROM pp_prueba WHERE IDempleado = $IDempleado AND IDestatus != 6";
...
if($totalRows_empleado_dob > 0) { header("Location: admin_pprueba_edit.php?info=8"); $avalidar = 2;}
...
} else { header("Location: admin_pprueba_edit.php?info=9"); $avalidar = 2;}

// si no he mandado a validar
} else { $avalidar = 0; }

if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
$insertSQL = sprintf("INSERT INTO pp_prueba (IDempleado, IDpuesto, IDarea, IDmatriz, IDestatus, sueldo_actual) VALUES (%s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($row_empleado['sueldo_total'], "text"));

 mysql_select_db($database_vacantes, $vacantes);
 $Result1 = mysql_query($insertSQL, $vacantes) or die(mysql_error());

 $last_id =  mysql_insert_id();
 header("Location: admin_pprueba_edit_2.php?IDpprueba=".$last_id."&info=1");
}
		...
		<?php require_once('assets/menu.php'); ?>
			...
			<?php require_once('assets/pheader.php'); ?>
				...
				<div class="content">
						...
						<!-- Basic alert -->
                        <?php if((isset($_GET['info']) && ($_GET['info'] == 8) && $avalidar == 0)) { ?>
					    <div class="alert bg-warning-600 alert-styled-left">
							<button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Cerrar</span></button>
							El No. de empleado capturado ya tiene un periodo de prueba capturado.
					    </div>
                        <?php } ?>
					    <!-- /basic alert -->
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body">
							<p>PASO 1. Ingresa el No de Empelado a proverse para validar que el empleado esté activo y sus datos básicos.</p>
                            <p>&nbsp;</p>
						...
						<legend class="text-semibold">Resultado</legend>
                                   ...
                                   <!-- Basic text input -->
									<div class="form-group">
										...
										<div class="col-lg-9">
											<input type="text"  class="form-control" value="<?php echo round($row_empleado['sueldo_total'],2); ?>"  readonly="readonly">
										</div>
									</div>
									<!-- /basic text input -->
                         ...
                         <input type="submit" name="KT_insert1" class="btn btn-primary" id="KT_insert1" value="Agregar Periodo de Prueba" />
                    	 <button type="button" onClick="window.location.href='admin_pprueba_edit.php'" class="btn btn-warning btn-icon">Buscar otro</button>
