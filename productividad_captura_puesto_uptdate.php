...
mysql_select_db($database_vacantes, $vacantes);
$query_resultado = "SELECT prod_activos.*, prod_captura.* FROM prod_captura LEFT JOIN prod_activos ON prod_captura.IDempleado = prod_activos.IDempleado WHERE prod_captura.IDcaptura = '$la_captura'"; 
...
$monto_previo = ($monto_tabulador * $suma ) / 100; echo "monto previo: ".$monto_previo."<br/>";
$porcentaje_carga = ($monto_previo * $parap); echo "porcentaje_carga: ".$porcentaje_carga."<br/>";
$monto =  round($monto_previo, 2);  echo "monto: ".$monto."<br/>";
if ( $monto < 0) { $monto = 0; } echo "monto: ".$monto."<br/>";
...
echo "monto adicional: ".$monto_adicional."<br/>";
    ...
    $query1 = "UPDATE prod_captura SET bono_asistencia = '$bono_asistencia', adicional = '$monto_adicional', pago_total = '$pago_total', pago = '$pago' WHERE IDcaptura = '$IDcaptura'"; 
    $result1 = mysql_query($query1) or die(mysql_error());  

	}  else { echo"No garantizado<br/>";
