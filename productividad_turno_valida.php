...
?>
                            <?php echo $row_puestos['emp_paterno']; ?> <?php echo $row_puestos['emp_materno']; ?> <?php echo $row_puestos['emp_nombre']; ?>                            
            					...
            					<form method="post" class="form-horizontal form-validate-jquery" name="form2" action="productividad_valida_puesto_t.php?IDpuesto=<?php echo $row_puestos['IDpuesto']; ?>" >
