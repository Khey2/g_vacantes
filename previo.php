...
$IDsucursales = $row_usuario['IDsucursales'];
$la_sucursal = $row_usuario['IDsucursal'];
...
$la_sucursal = $row_sucursal['sucursal']; 


mysql_select_db($database_vacantes, $vacantes);
$query_sucursales = "SELECT * FROM vac_sucursal WHERE IDsucursal IN ($IDsucursales)";
$sucursales = mysql_query($query_sucursales, $vacantes) or die(mysql_error());
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown dropdown-user">
						...
						<ul class="dropdown-menu dropdown-menu-right">
							<li><a href="mi_perfil.php"><i class="icon-user-plus"></i>Mi Perfil</a></li>							<li><a href="mi_matriz.php"><i class="icon-cog5"></i>Matrizes</a></li>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										<li><a href="#">Por sucursal<span class="label bg-warning-400">:)</span></a></li>
						...
						<input type="text" name="usuario_telefono" id="usuario_telefono" class="form-control format-phone-number" value="<?php echo htmlentities($row_usuario['usuario_telefono'], ENT_COMPAT, ''); ?>" required="required">
                                   ...
                                   <!-- Basic text input -->
									...
									<!-- /basic text input -->
                                     ...
                                     <!-- Basic text input -->
									<div class="form-group">
										<label class="control-label col-lg-3">Sucursal Actual:</label>
										<div class="col-lg-9">
					                    <?php echo $la_sucursal; ?> (<a href="mi_matriz.php">cambiar</a>) </div>
									</div>
									<!-- /basic text input -->
                                   ...
                                   <!-- Basic text input -->
									<div class="form-group">
										<label class="control-label col-lg-3">Sucursales Asignadas:</label>
										<div class="col-lg-9">
						                    <?php do { ?>
						                    <?php echo $row_sucursales['sucursal'] . ". "; ?>
								...
								<div class="sidebar-category">
									...
									<div class="category-content no-padding">
										<ul class="navigation navigation-alt navigation-accordion">
											...
											<li><a href="cambio_pass.php"><i class="icon-lock2"></i>Cambiar Password</a></li>
											<li><a href="mi_matriz.php"><i class="icon-city"></i> Cambiar Sucursal</a></li>
