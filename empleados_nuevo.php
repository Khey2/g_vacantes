...
$insertSQL = sprintf("INSERT INTO con_empleados (a_paterno, a_materno, a_nombre, manual, a_rfc, a_correo, a_curp, a_sexo, a_imss, IDnacionalidad, a_estado_civil, fecha_alta, c_fecha_nacimiento, d_calle, d_numero_calle, d_numero_calle_int, d_colonia, d_delegacion_municipio, d_estado, estatus, IDmatriz, IDempresa, password, IDcuenta, IDsubcuenta, IDempleado_real, IDestatus, d_codigo_postal) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
if ($row_usuario['IDmatriz'] == 7 OR $row_usuario['IDmatriz'] == 31) {
mysql_select_db($database_vacantes, $vacantes);
...
mysql_select_db($database_vacantes, $vacantes);
$query_empresas = "SELECT * FROM vac_empresas WHERE IDempresa <> 2";
$empresas = mysql_query($query_empresas, $vacantes) or die(mysql_error());
$row_empresas = mysql_fetch_assoc($empresas);
$totalRows_empresas = mysql_num_rows($empresas);
}
		...
		<?php require_once('assets/menu.php'); ?>
			...
			<!-- Content area -->
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
					...
					Al momento de capturar el Código Postal, se carga automáticamente el Estado y la Alcaldía o Municipio.</p>
                    <p>&nbsp;</p>
                    <div>
                    <div>
                      ...
                      <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="form-horizontal form-validate-jquery">
						...
						<legend class="text-semibold">Datos Básicos</legend>
									...
									<div class="form-group">
										<label class="control-label col-lg-3">Número de Empleado de Nómina (Solo si ya lo tiene asignado):</label>
										<div class="col-lg-9">
											<input type="number" name="IDempleado_real" id="IDempleado_real" class="form-control" placeholder="No. Empleado" value="">
										</div>
									</div>
									<!-- /basic text input -->
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<input type="text" name="a_paterno" id="a_paterno" class="form-control" onKeyUp="this.value=this.value.toUpperCase()" placeholder="Apellido Paterno" value="" required="required">
										</div>
									</div>
									<!-- /basic text input -->
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<input type="text" name="a_materno" id="a_materno" class="form-control" onKeyUp="this.value=this.value.toUpperCase()" placeholder="Apellido Materno" value="">
										</div>
									</div>
									<!-- /basic text input -->
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<input type="text" name="a_nombre" id="a_nombre" class="form-control" onKeyUp="this.value=this.value.toUpperCase()"  placeholder="Nombres" value="" required>
										</div>
									</div>
									<!-- /basic text input -->
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<input name="a_rfc" id="a_rfc" type="text" class="form-control" id="a_rfc" onKeyUp="this.value=this.value.toUpperCase()" value=""  maxlength="18" placeholder="RFC a 13 posiciones, sin espacios ni guiones" required="required">
										</div>
									</div>
									<!-- /basic text input -->
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<input name="a_curp" id="a_curp" type="text" class="form-control" id="a_curp" onKeyUp="this.value=this.value.toUpperCase()" value="" maxlength="18" placeholder="CURP" required="required">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<input type="text" name="a_imss" id="a_imss" class="form-control" placeholder="Cedula IMSS a 11 posiciones" maxlength="12" value="" required>
										</div>
									</div>
									<!-- /basic text input -->
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<select name="IDmatriz" id="IDmatriz" class="form-control" required="required">
												<option value="">Seleccione una opción</option> 
												  <?php  do { ?>
												  <option value="<?php echo $row_matriz1['IDmatriz']?>"<?php if (!(strcmp($row_matriz1['IDmatriz'], $row_usuario['IDmatriz']))) {echo "SELECTED";} ?>><?php echo $row_matriz1['matriz']?></option>
												  <?php
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<select name="IDempresa" id="IDempresa" class="form-control" required="required">
												<option value="">Seleccione una opción</option> 
												  <?php  do { ?>
												  <option value="<?php echo $row_empresas['IDempresa']?>"><?php echo $row_empresas['empresa']?></option>
												  <?php
            ...
            <legend class="text-semibold">Dirección</legend>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
										  <input type="text" name="d_numero_calle" id="d_numero_calle" class="form-control" placeholder="Numero exterior" value="" required>
										</div>
									</div>
									<!-- /basic text input -->
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
										  <input type="text" name="d_numero_calle_int" id="d_numero_calle_int" class="form-control" placeholder="Numero interior" value="">
										</div>
									</div>
									<!-- /basic text input -->
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
										  <input type="number" id="d_codigo_postal" name="d_codigo_postal" onKeyUp="showUser(this.value)" class="form-control" placeholder="Codigo Postal" value=""  maxlength="5" required>
                                        <span class="help-block">El resultado puede tardar unos segundos en aparecer. Solo si no se encuentra el C.P. puedes capturarlo manualmente.</span>
										</div>
									</div>
									<!-- /basic text input -->
