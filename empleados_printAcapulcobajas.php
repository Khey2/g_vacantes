...
mysql_select_db($database_vacantes, $vacantes);
$query_contratos = "SELECT prod_activos_aca.*, vac_matriz.matriz, vac_matriz.matriz_cv, vac_matriz.direccion, vac_puestos.IDarea FROM prod_activos_aca LEFT JOIN vac_matriz ON prod_activos_aca.IDmatriz = vac_matriz.IDmatriz LEFT JOIN vac_puestos ON prod_activos_aca.IDpuesto = vac_puestos.IDpuesto WHERE prod_activos_aca.IDempleado = $IDempleado";
