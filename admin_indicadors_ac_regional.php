...
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_ms1k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_ms1k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms1 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 1 AND YEAR(fecha_baja) = $anio_actual)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_ms2k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_ms2k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 2 AND YEAR(fecha_baja) = $anio_actual)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_ms3k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_ms3k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms3 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 3 AND YEAR(fecha_baja) = $anio_actual)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_ms4k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_ms4k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms4 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 4 AND YEAR(fecha_baja) = $anio_actual)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_ms5k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_ms5k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms5 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 5 AND YEAR(fecha_baja) = $anio_actual)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_ms6k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_ms6k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms6 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 6 AND YEAR(fecha_baja) = $anio_actual)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_ms7k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_ms7k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms7 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 7 AND YEAR(fecha_baja) = $anio_actual)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_ms8k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_ms8k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms8 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 8 AND YEAR(fecha_baja) = $anio_actual)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_ms9k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_ms9k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms9 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 9 AND YEAR(fecha_baja) = $anio_actual)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_ms10k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_ms10k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms10 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 10 AND YEAR(fecha_baja) = $anio_actual)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_ms11k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_ms11k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms11 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 11 AND YEAR(fecha_baja) = $anio_actual)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_ms12k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_ms12k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms12 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 12 AND YEAR(fecha_baja) = $anio_actual)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_msa1k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_msa1k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_msa1 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 1 AND YEAR(fecha_baja) = $anio_anterior)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_msa2k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_msa2k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_msa2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 2 AND YEAR(fecha_baja) = $anio_anterior)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_msa3k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_msa3k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_msa3 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 3 AND YEAR(fecha_baja) = $anio_anterior)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_msa4k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_msa4k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_msa4 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 4 AND YEAR(fecha_baja) = $anio_anterior)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_msa5k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_msa5k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_msa5 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 5 AND YEAR(fecha_baja) = $anio_anterior)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_msa6k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_msa6k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_msa6 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 6 AND YEAR(fecha_baja) = $anio_anterior)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_msa7k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_msa7k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_msa7 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 7 AND YEAR(fecha_baja) = $anio_anterior)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_msa8k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_msa8k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_msa8 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 8 AND YEAR(fecha_baja) = $anio_anterior)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_msa9k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_msa9k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_msa9 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 9 AND YEAR(fecha_baja) = $anio_anterior)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_msa10k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_msa10k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_msa10 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 10 AND YEAR(fecha_baja) = $anio_anterior)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_msa11k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_msa11k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_msa11 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 11 AND YEAR(fecha_baja) = $anio_anterior)";
...
sum(case when IDarea = 11 then 1 else 0 end) as Area11,
sum(case when IDarea = 12 then 1 else 0 end) as Area12,
Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE fecha_alta < '$fter_msa12k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini_msa12k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_msa12 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) = 12 AND YEAR(fecha_baja) = $anio_anterior)";
...
//resultados por area
mysql_select_db($database_vacantes, $vacantes);
$query_ar1an1 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 1 AND ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) <= $el_mes AND YEAR(fecha_baja) = $anio_actual)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_ar1an2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 1 AND ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) <= $el_mes AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_ar2an1 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 2 AND ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) <= $el_mes AND YEAR(fecha_baja) = $anio_actual)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_ar2an2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 2 AND ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) <= $el_mes AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_ar3an1 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 3 AND ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) <= $el_mes AND YEAR(fecha_baja) = $anio_actual)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_ar3an2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 3 AND ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) <= $el_mes AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_ar4an1 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 4 AND ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) <= $el_mes AND YEAR(fecha_baja) = $anio_actual)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_ar4an2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 4 AND ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) <= $el_mes AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_ar5an1 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 5 AND ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) <= $el_mes AND YEAR(fecha_baja) = $anio_actual)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_ar5an2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 5 AND ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) <= $el_mes AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_ar6an1 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 6 AND ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) <= $el_mes AND YEAR(fecha_baja) = $anio_actual)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_ar6an2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 6 AND ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) <= $el_mes AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_ar7an1 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea IN (7,8,9,10,11,12) AND ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) <= $el_mes AND YEAR(fecha_baja) = $anio_actual)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_ar7an2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea IN (7,8,9,10,11,12) AND ind_bajas.IDmotivo < 14 AND (MONTH(fecha_baja) <= $el_mes AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_Toar1an2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 1 AND ind_bajas.IDmotivo < 14 AND fecha_alta <= '$Tfter_msk2' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja >= '$Tfini_msk2')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_Toar2an2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 2 AND ind_bajas.IDmotivo < 14 AND fecha_alta <= '$Tfter_msk2' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja >= '$Tfini_msk2')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_Toar3an2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 3 AND ind_bajas.IDmotivo < 14 AND fecha_alta <= '$Tfter_msk2' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja >= '$Tfini_msk2')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_Toar4an2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 4 AND ind_bajas.IDmotivo < 14 AND fecha_alta <= '$Tfter_msk2' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja >= '$Tfini_msk2')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_Toar5an2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 5 AND ind_bajas.IDmotivo < 14 AND fecha_alta <= '$Tfter_msk2' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja >= '$Tfini_msk2')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_Toar6an2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea = 6 AND ind_bajas.IDmotivo < 14 AND fecha_alta <= '$Tfter_msk2' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja >= '$Tfini_msk2')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_Toar7an2 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE IDarea IN (7,8,9,10,11,12) AND ind_bajas.IDmotivo < 14 AND fecha_alta <= '$Tfini_msk2' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja >= '$Tfini_msk2')";
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Indicadores de Recursos Humanos acumulado.</h5>
						</div>
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<h5>Resultado Obtenido <?php echo $anio_anterior; ?>:<strong> <?php echo $row_resultados_anterior['objetivo']; ?>%</strong> </h5>
							<h5> Objetivo de Reducción 2020:<strong> <?php echo $row_resultados['reduccion']; ?>%</strong></h5>
