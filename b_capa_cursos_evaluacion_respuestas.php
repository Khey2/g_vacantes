...
$query_larespuesta = "SELECT DISTINCT * FROM capa_becarios_seguridad_respuestas WHERE IDempleado = $el_usuario"; 
				...
				<div class="content">
					...
					<div class="container-detached">
						<div class="content-detached">
                            ...
                            <div>
                            <button type="button" onClick="window.location.href='b_capa_cursos.php'" class="btn btn-default btn-icon">Regresar</button>
                            </div>
                            </div>
