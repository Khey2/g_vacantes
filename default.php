				...
				<div class="content">
					...
					<div class="tabbable panel login-form width-400">
						<ul class="nav nav-tabs nav-justified">
							<li class="active"><a href="default.php"><h6>Acceso Empleados</h6></a></li>
							<li><a href="f_index.php"><h6>Acceso Gestión RH</h6></a></li>
						</ul>
						...
						<div class="tab-content panel-body">
							<div class="tab-pane fade in active" id="basic-tab1">
									...
									<div class="alert bg-info alert-styled-left">
										...
										<a href="becarios.php" class="alert-link">¿Eres Becario? Accede aqui</a>.
									</div>
					...
					<form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>">
							<div class="text-center">
							 ...
							 <div>&nbsp;</div>	
							  <h5 class="content-group-lg">Acceso<small class="display-block">Empleados</small></h5>
							</div>

							<div class="form-group has-feedback has-feedback-left">
								<input type="text" class="form-control" name="kt_login_user" id="kt_login_user" placeholder="RFC" maxlength="10" value="<?php if(isset($_POST['kt_login_user'])) {echo KT_escapeAttribute($_POST['kt_login_user']); } ?>" onKeyUp="this.value=this.value.toUpperCase(); this.value=this.value.replace(/ /g,'');" required="required">
