...
$_SESSION['la_matriz'] = $_POST['la_matriz']; } else { $_SESSION['la_matriz'] = $mamatriz;}


$el_mes = $_SESSION['el_mes'];
$el_anio = $_SESSION['el_anio'];
$anio_actual = $_SESSION['el_anio'];
$anio_anterior = $el_anio - 1; // la fecha actual
$IDmatriz = $_SESSION['la_matriz'];
		...
		<div class="page-content">
			...
			<?php require_once('assets/pheader.php'); ?>
				...
				<div class="table-responsive">
 				...
 				<form method="POST" action="admin_indicadors.php">
                	<table class="table">
						<tbody>							  
							<tr>
							<td>
