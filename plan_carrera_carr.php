			...
			<!-- Content area -->
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
                   ...
                   <form method="POST" action="plan_carrera_carr.php">
					<table class="table">
						<tbody>							  
							<tr>
							<td>
