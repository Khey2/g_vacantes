				...
				<div class="sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							...
							<?php } elseif( $row_usuario['productividad'] == 2) {?>
										<li class="active"><a href="productividad_autoriza.php">Autorizar</a></li>
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Autorizar Productividad</h5></br>
                               Sucursal: <span class="text-primary"><?php echo $row_matriz['matriz']; ?></span> </p>
                               Puesto: <span class="text-primary"><?php echo $row_puestos['denominacion']; ?></span> </p>
						</div>
					...
					<table class="table datatable-button-html5-columns">
						...
						?>
                          <tr>
                            ...
                            <td><?php echo "$" . number_format($row_puestos['sueldo_diario'] * 7); ?></td>
                          ...
                          <td>
                           <?php if ($row_puestos['IDcaptura'] == "") { ?>
							Sin captura
						   <?php } else {  ?>  
                          <button type="button" data-target="#modal_form_inline<?php echo $row_puestos['IDcaptura']; ?>"  data-toggle="modal" class="btn btn-success btn-icon">Ver detalle</button>
                           <?php } ?>
                           </td>  
                           </tr>
