...
mysql_select_db($database_vacantes, $vacantes);
$query_usuarios = "SELECT vac_usuarios.usuario_correo FROM vac_usuarios WHERE vac_usuarios.user_prod = 2 AND FIND_IN_SET('$la_matriz', IDmatrizes)";
...
if($totalRows_cierre == 0) {
    ...
    $query1 = "INSERT into prod_semana_cierre (anio, semana, fecha, IDusuario, IDmatriz, estatus, captura) values ('$anio', '$semana', '$fecha', '$IDusuario', '$la_matriz', 1, 1)"; 
    $result1 = mysql_query($query1) or die(mysql_error());  

} else {
 
    $updateSQL = "UPDATE prod_semana_cierre SET estatus = 1, captura = 1 WHERE IDmatriz = '$la_matriz' AND semana = '$semana' AND anio = $anio"; 
}
