...
$ins_vac_vacante->registerTrigger("END", "Trigger_Default_Redirect", 99, "vista_activas.php?info=1");
...
$upd_vac_vacante->registerTrigger("END", "Trigger_Default_Redirect", 99, "vista_activas.php?info=2");
...
if ((isset($_GET['IDvacante_borrar'])) && ($_GET['IDvacante_borrar'] != "")) {
  ...
  header("Location: vista_activas.php?info=3");
}
						...
						<input type="file" name="archivo_<?php echo $cnt1; ?>" id="archivo_<?php echo $cnt1; ?>" class="file-styled">
                          ...
                          <div class="text-right">
                            <div>
                              ...
                              <?php } else { ?>
                         <button type="button" onClick="window.location.href='vista_activas.php'" class="btn btn-default btn-icon">Regresar</button>
                                <?php }  ?>
                            </div>
                          </div>
                       </fieldset>
