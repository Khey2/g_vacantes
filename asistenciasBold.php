...
if(!isset($_SESSION['anio'])) {$_SESSION['anio'] = 2023;}
...
function generar_calendario($month,$year,$lang,$holidays = null){
    ...
    for($list_day = 1; $list_day <= $days_in_month; $list_day++):
		...
		$query_activosvalidados = "SELECT prod_activosfaltas.*, ind_asistencia.* FROM prod_activosfaltas LEFT JOIN ind_asistencia ON prod_activosfaltas.IDempleado = ind_asistencia.IDempleado WHERE prod_activosfaltas.IDmatriz = '$IDmatriz' AND ind_asistencia.IDvalidador <> '' AND ind_asistencia.IDfecha = '$list_day' AND ind_asistencia.mes = '$month' AND ind_asistencia.anio = '$year'";
        ...
        $calendar.= "<div><a href='asistencias_editB.php?anio=".$year."&mes=".$month."&IDfecha=".$list_day."'><div style='height:100%;width:100%'>".$list_day;
