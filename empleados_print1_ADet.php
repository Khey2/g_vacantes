...
mysql_select_db($database_vacantes, $vacantes);
$query_contratos = "SELECT con_empleados.*, con_bancos.banco, vac_matriz.matriz, vac_matriz.matriz_cv, vac_matriz.firma_contratos, vac_matriz.direccion, vac_puestos.denominacion FROM con_empleados LEFT JOIN vac_matriz ON con_empleados.IDmatriz = vac_matriz.IDmatriz LEFT JOIN vac_puestos ON con_empleados.IDpuesto = vac_puestos.IDpuesto LEFT JOIN con_bancos ON con_empleados.a_banco = con_bancos.IDbanco WHERE con_empleados.IDempleado = $IDempleado";
