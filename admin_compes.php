...
elseif (isset($_POST['el_estatus']) && $_POST['el_estatus'] == 2) {$_SESSION['el_estatus'] = '1,0';} 
	...
	if (!isset($_SESSION['el_estatus'])) {$_SESSION['el_estatus'] = '1,0';}
...
<div class="content">
                  ...
                  <div class="panel panel-flat">
                    ...
                    <form method="POST" action="admin_compes.php">
					<table class="table">
						<tbody>							  
							<tr>
							<td>
					...
					$totalRows_evaluaciones_ok = mysql_num_rows($evaluaciones_ok);
					  ...
					  ?>
                        <tr>
                          ...
                          <td>
							<?php  if ( $row_resultados['IDempleadoOr'] != '') {?>
						(<?php echo $row_resultados['IDempleadoOr']; ?>) <?php echo $row_resultados['emp_paternoOr'] . " " . $row_resultados['emp_maternoOr'] . " " . $row_resultados['emp_nombreOr']; ?>
							<?php } else { ?>  
						<a href="prev_admin_comp.php?IDempleado=<?php echo $row_resultados['IDempleadoO']; ?>">REVISAR</a>
							<?php } ?>  
						  </td>
                          <td><?php  if ($row_resultados['IDtipo'] == 1) { echo "Autoevaluación";} 
						     	else if ($row_resultados['IDtipo'] == 2) { echo "Jefe";} 
						     	else if ($row_resultados['IDtipo'] == 4) { echo "Colaborador";} 
						     	else if ($row_resultados['IDtipo'] == 3) { echo "Par";} 
