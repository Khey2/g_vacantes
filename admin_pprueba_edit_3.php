...
header("Location: admin_pprueba_edit_3.php?IDpprueba=$IDpprueba&info=1");
}
...
if ((isset($_GET['IDpprueba_borrar'])) && ($_GET['IDpprueba_borrar'] != "")) {
  ...
  header("Location: admin_pprueba_pagos.php?info=3");
}
...
<!-- Page container -->
	...
	<legend class="text-semibold">Puesto destino</legend>
				...
				<legend class="text-semibold">Fechas</legend>
			                        ...
			                        <div class="input-group">
                                    <span class="input-group-addon"><i class="icon-calendar22"></i></span>
                                    	<input type="text" class="form-control pickadate" placeholder="Capturar fecha" name="fecha_cierre" id="fecha_cierre" value="<?php if ($row_pprueba['fecha_cierre'] == "") { echo "";} else { echo date('d-m-Y', strtotime($row_pprueba['fecha_cierre'])); }?>">
									</div>
								   </div>
			                        <div class="col-lg-1">
                                   <input type="button" id="rangeDemoClear" class="btn btn-danger" value="Borrar">
								   </div>
                                  </div> 
									<!-- Fecha -->
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="admin_pprueba_edit_3.php?IDpprueba_borrar=<?php echo $IDpprueba; ?>">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
