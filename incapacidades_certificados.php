...
header('Location: incapacidades.php?info=10&IDincapacidad='.$IDincapacidad.'');
exit;
} 
...
$insertSQL = sprintf("UPDATE incapacidades_certificados SET nss=%s, IDempleado=%s, IDusuario=%s, fecha_carga=%s, file_certificado=%s, IDtipo_certificado=%s, folio_certificado=%s, fecha_inicio=%s, fecha_fin=%s, dias=%s WHERE IDcertificado = $IDcertificado",
	...
	header("Location: incapacidades.php?info=12");
}
...
$insertSQL = sprintf("INSERT INTO incapacidades_certificados (file_certificado, nss, IDempleado, IDusuario, fecha_carga, IDincapacidad, IDtipo_certificado, folio_certificado, fecha_inicio, fecha_fin, IDestatus, dias) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
						GetSQLValueString($name_new, "text"),
						GetSQLValueString($nss, "text"),
						GetSQLValueString($IDempleado, "text"),
						GetSQLValueString($el_usuario, "text"),
 ...
 header("Location: incapacidades.php?info=11");
}
...
if ((isset($_GET['borrar'])) && ($_GET['borrar'] == 1)) {
  ...
  header("Location: incapacidades.php?info=13");
}
...
mysql_select_db($database_vacantes, $vacantes);
$query_tipos_incapacidad = "SELECT * FROM incapacidades_tipo_incapacidad";
					...
					<div class="panel-body">
						...
						<legend class="text-semibold">Datos de Accidente</legend>
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
									<?php if($candado == 1) { ?>
                                    	<input type="number" name="dias" id="dias" class="form-control" required="required" placeholder="Ingresa los dias de la incapacidad" 
										value ="<?php echo $row_elcertificado['dias'] ?>">
									<?php } else {  ?>
										<input type="number" name="dias" id="dias" class="form-control" value="" required="required" placeholder="Ingresa los dias de la incapacidad">
									<?php } ?>
									</div>
								</div>
								<!-- /basic text input -->
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="incapacidades_certificados.php?IDincapacidad=<?php echo $IDincapacidad; ?>&IDcertificado=<?php echo $IDcertificado; ?>&borrar=1">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
