...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title">Resultados NOM035 Sucursal <?php echo $row_matriz['matriz'];?></h5>
    </div>
        ...
        <a href="admin_n35s_print.php" target="_blank" class="btn btn-success">Imprimir</a>
