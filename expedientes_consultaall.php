...
mysql_select_db($database_vacantes, $vacantes);
$query_contratos = "SELECT DISTINCT  prod_activos.IDempleado, prod_activos.IDmatriz, prod_activos.emp_paterno, prod_activos.emp_materno, prod_activos.denominacion, prod_activos.emp_nombre, prod_activos.rfc, Count(exp_files.id) AS Docs FROM prod_activos LEFT JOIN exp_files ON prod_activos.IDempleado = exp_files.IDempleado GROUP BY prod_activos.IDempleado, prod_activos.emp_paterno, prod_activos.emp_materno, prod_activos.emp_nombre, prod_activos.rfc";
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
                    ...
                    <tbody>
						...
						$query_zmatriz = "SELECT * FROM vac_matriz WHERE IDmatriz = $IDmatriz";
						$zmatriz = mysql_query($query_zmatriz, $vacantes) or die(mysql_error());
						$row_zmatriz = mysql_fetch_assoc($zmatriz);
						?>
                          <tr>
                            <td><?php echo $row_contratos['IDempleado']; $IDempleado_carpeta = 'files/'.$row_contratos['IDempleado']; if (!file_exists($IDempleado_carpeta) AND $row_contratos['Docs'] > 0) {echo " <i class='icon-notification2 text-danger'>Falta</i>";}?>&nbsp; </td>
                            <td><?php echo $row_zmatriz['matriz']; ?>&nbsp; </td>
						...
						<td><?php if ($row_contratos['Docs'] > 0) {echo $row_contratos['Docs']." cargados";} else{ echo "Sin carga";} ?></td>
                            <td><a class="btn btn-primary" href="expedientes_nuevo.php?IDempleado=<?php echo $row_contratos['IDempleado']; ?>">Editar</a>
                           </td>
                          </tr>
