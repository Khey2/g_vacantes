...
$query_puestos_aplicables = 'SET GLOBAL group_concat_max_len=150000';
...
$query_cursos_aplicables = 'SET GLOBAL group_concat_max_len=150000';
...
<head>
	...
	<script src="global_assets/js/demo_pages/datatables_extension_buttons_html5_capab.js"></script>
...
<?php  if ($filtro == 1) {?>
                ...
                <form method="POST" action="capa_reporte_3c.php">
