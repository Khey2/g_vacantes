...
$IDpuesto = $row_usuario['IDusuario_puesto'];
...
$arreglo .= " OR proced_documentos.tags LIKE '%" . $array[$i] . "%'"; 
						...
						<div class="panel-body">
							<form action="procedimientos.php" method="post" class="main-search">
                               ...
                               <?php 		if (isset($_POST['buscado']) && $totalRows_documentos  > 0) { ?> 
								...
								<li><a class="btn btn-default"><i class="icon-filter4"></i><strong>  <?php echo $totalRows_documentos; ?></strong> Documentos encontrados.</a></li>
							...
							<?php if ($totalRows_direcciona > 0 OR $totalRows_areaa > 0 OR $totalRows_subareaa > 0) { ?>
								<li><a class="btn btn-default"><i class="icon-filter4"></i><strong> Filtro Actual:</strong> <?php echo $totalRows_documentos; ?> Documentos </a></li>
							<?php } ?>
							
							<?php if ($totalRows_direcciona > 0) { ?>
								<li><a class="btn btn-default"><strong>Dirección:</strong> <?php echo $row_direcciona['direccion']; ?></a></li>
							<?php } ?>
							<?php if ($totalRows_areaa > 0) { ?>
								<li><a class="btn btn-default"><strong>Área:</strong> <?php echo $row_areaa['area']; ?></a></li>
							<?php } ?>
							<?php if ($totalRows_subareaa > 0) { ?>
								<li><a class="btn btn-default"><strong>Subárea:</strong> <?php echo $row_subareaa['subarea']; ?></a></li>
							<?php } ?>
							</ul>
                                ...
                                <div class="media-left">
									...
									<div class="media-body">
										...
										<ul class="list-inline list-inline-separate">
											<li><strong>Versión: </strong><a><?php echo $row_documentos['version']; ?></a></li>
											<li><strong>Año: </strong> <a><?php echo date('Y', strtotime($row_documentos['anio'])); ?></a></li>
											<li><strong>Tipo de Documento: </strong> <a><?php echo $row_documentos['tipo']; ?></a></li>
											<?php if ($row_documentos['vistas'] > 0) { ?>
											<li><strong>Vistas: </strong> <a><?php echo $row_documentos['vistas']; ?></a></li>
											<?php } ?>
										</ul>
									</div>
									...
									<?php if ($resultado_file1 == 'pdf')  { ?>
									<div onClick="loadDynamicContentModal('<?php echo $row_documentos['IDdocumento']; ?>')" class="btn bg-primary-400 mt-15 btn-block"><i class="icon-file-eye2"></i> Visualizar</a></div>
									<?php } ?>
										...
										<li class="media">
											...
											<div>
												<ul style="list-style: none;">
													<li><a><i class="icon-phone2 "></i> 1223</a></li>
...
function loadDynamicContentModal(modal){
	...
	$('#conte-modal').load('procedimientos_mdl.php?IDdocumento='+ modal, function() {
	...
	&copy; <?php echo $anio; ?>. <a><?php echo $row_variables['nombre_sistema']; ?></a> V: 0.9.2 en <a href="<?php echo $row_variables['direccion_web']; ?>" target="_blank"><?php echo $row_variables['empresa']; ?></a>
				  </div>
					<!-- /footer -->
