...
$query_capa = "SELECT capa_avance_temp.IDC_capa, capa_avance_temp.IDempleado, capa_avance_temp.emp_nombre, capa_avance_temp.emp_paterno, capa_avance_temp.emp_materno, capa_avance_temp.fecha_antiguedad, capa_avance_temp.fecha_baja, capa_avance_temp.fecha_evento, capa_avance_temp.anio, capa_avance_temp.mes, capa_avance_temp.calificacion, capa_avance_temp.IDC_tipo_curso, capa_avance_temp.IDC_programado, capa_avance_temp.IDmatriz, capa_avance_temp.IDarea, capa_avance_temp.IDpuesto, capa_avance_temp.denominacion, capa_avance_temp.estatus, capa_cursos.nombre_curso, capa_tipos_cursos.tipo_evento, vac_areas.area, vac_matriz.matriz, vac_sucursal.sucursal FROM capa_avance_temp LEFT JOIN capa_cursos ON  capa_avance_temp.IDC_capa_cursos = capa_cursos.IDC_capa_cursos LEFT JOIN capa_tipos_cursos ON  capa_cursos.IDC_tipo_curso = capa_tipos_cursos.ID_tipo_evento LEFT JOIN vac_areas ON capa_avance_temp.IDarea = vac_areas.IDarea LEFT JOIN vac_matriz ON  capa_avance_temp.IDmatriz = vac_matriz.IDmatriz LEFT JOIN vac_sucursal ON  capa_avance_temp.IDsucursal = vac_sucursal.IDsucursal"; 
mysql_query("SET NAMES 'utf8'");
