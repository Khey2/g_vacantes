				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body">
					  <p>A continuación se muesta el listado de Becarios activos de la Sucursal <strong><?php echo $row_matriz['matriz']; ?></strong>.</br>
                      En la columna "<strong># Doctos.</strong>" se indica la cantidad de documentos cargados enb el Expediente Digital del Becario.</p>
              
                <form method="POST" action="capa_expedientes_consulta.php">
					<table class="table">
						<tbody>							  
							<tr>
							<td><div class="col-lg-9">
                                 <select class="form-control" name="activo">
                                   <option value="1"<?php if ($activob == 1) {echo "selected=\"selected\"";} ?>>Activos</option>
                                   <option value="0"<?php if ($activob == 0) {echo "selected=\"selected\"";} ?>>Bajas</option>
                                 </select>
						    </div></td>
							<td>
                    ...
                    <tbody>
                        ...
                        <?php do { ?>
                          <tr>
                            ...
                            <td><a class="btn btn-primary" href="capa_expedientes_nuevo.php?IDempleado=<?php echo $row_contratos['IDempleado']; ?>">Documentos</a>
							</td>
                          </tr>
