		...
		<?php require_once('assets/menu.php'); ?>
			...
			<!-- Content area -->
				...
				<div class="content">
					    ...
					    <div class="alert bg-danger-300 alert-styled-left">
							<button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Cerrar</span></button>
                            <a>El monto de incentivos es superior a la semana pasasa, favor de validar.</a>
					    </div>
                        <?php } ?>
					    <!-- /basic alert -->
				...
				<div class="table-responsive">
                    ...
                    <tbody>
						<?php do {  if ($row_detalle['INC1'] + $row_detalle['INC2'] + $row_detalle['INC3'] + $row_detalle['INC4'] + $row_detalle['INC5'] + $row_detalle['INC6'] > 0 ) { 	?>
                        <tr>
...
function loadDynamicContentModal(modal, Tipo){
	...
	$('#conte-modal').load('incX_aut.php?Tipo=' + Tipo + '&IDempleado='+ modal, function() {
