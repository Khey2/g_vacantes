...
mysql_select_db($database_vacantes, $vacantes);
$query_puestro = "SELECT IDpuesto FROM vac_puestos WHERE IDaplica_PROD = 1 AND IDpuesto IN (2,9,18) ORDER BY vac_puestos.denominacion ASC";
...
mysql_select_db($database_vacantes, $vacantes);
$query_puesto = "SELECT * FROM vac_puestos WHERE IDaplica_PROD = 1 AND IDpuesto IN (2,9,18) ORDER BY vac_puestos.denominacion ASC";
...
$captura = $_POST['IDcaptura'];
  ...
  $updateSQL = sprintf("UPDATE prod_captura_2020 SET IDempleado=%s, IDpuesto=%s, fecha_captura=%s, semana=%s, IDmatriz=%s, a1=%s, a2=%s, a3=%s, a4=%s, a5=%s, a6=%s, a7=%s, a8=%s, a9=%s, a10=%s, a11=%s, a12=%s, a13=%s, a14=%s, a15=%s, a16=%s, a17=%s, a18=%s, a19=%s, a20=%s, a21=%s, a22=%s, a23=%s, a24=%s, a25=%s, a26=%s, a27=%s, a28=%s,  autorizador=%s, garantizado=%s, adicional=%s, observaciones=%s, lun=%s, mar=%s, mie=%s, jue=%s, vie=%s, sab=%s,lun_g=%s, mar_g=%s, mie_g=%s, jue_g=%s, vie_g=%s, sab_g=%s, dom=%s WHERE IDcaptura=$captura",
                       ...
                       GetSQLValueString($row_usuario['IDusuario'], "text"),
                       GetSQLValueString(isset($_POST['garantizado']) ? "true" : "", "defined","1","0"),
  ...
  $updateGoTo = "productividad_autoriza_puesto_uptdate_a.php?IDcaptura=$captura&IDmatriz=$la_matriz";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_vacantes, $vacantes);
$query_puestos = "SELECT prod_activos.emp_paterno, prod_activos.IDempleado, prod_activos.emp_materno, prod_activos.emp_nombre, prod_activos.sueldo_total, prod_activos.sueldo_diario, prod_activos.rfc, prod_activos.IDpuesto, prod_activos.IDmatriz, prod_activos.IDsucursal, prod_activos.IDarea, prod_activos.IDmatriz, prod_activos.IDempleado, prod_activos.descripcion_nomina, prod_captura_2020.IDcaptura, prod_captura_2020.pago, prod_captura_2020.pago_total, prod_captura_2020.garantizado, prod_captura_2020.lun, prod_captura_2020.mar, prod_captura_2020.mie, prod_captura_2020.jue, prod_captura_2020.vie, prod_captura_2020.sab, prod_captura_2020.adicional, prod_captura_2020.lun_g, prod_captura_2020.mar_g, prod_captura_2020.mie_g, prod_captura_2020.jue_g, prod_captura_2020.vie_g, prod_captura_2020.sab_g, prod_captura_2020.dom, prod_captura_2020.a1, prod_captura_2020.observaciones, prod_captura_2020.a2, prod_captura_2020.a3, prod_captura_2020.a4, prod_captura_2020.a5, prod_captura_2020.a6, prod_captura_2020.a7, prod_captura_2020.a8, prod_captura_2020.a9, prod_captura_2020.a10, prod_captura_2020.a11, prod_captura_2020.a12, prod_captura_2020.a13, prod_captura_2020.a14, prod_captura_2020.a15, prod_captura_2020.a16, prod_captura_2020.a17, prod_captura_2020.a18, prod_captura_2020.a19, prod_captura_2020.a20, prod_captura_2020.a21, prod_captura_2020.a22, prod_captura_2020.a23, prod_captura_2020.a24, prod_captura_2020.a25, prod_captura_2020.a26, prod_captura_2020.a27, prod_captura_2020.a28, prod_captura_2020.semana, prod_captura_2020.reci, prod_captura_2020.carg, prod_captura_2020.dist, prod_captura_2020.esti, prod_captura_2020.fecha_captura, prod_captura_2020.autorizador, vac_puestos.denominacion, vac_puestos.modal FROM prod_activos LEFT JOIN prod_captura_2020 ON prod_captura_2020.IDempleado = prod_activos.IDempleado  AND prod_captura_2020.semana = '$la_semana' LEFT JOIN vac_puestos ON prod_activos.IDpuesto = vac_puestos.IDpuesto WHERE prod_activos.IDmatriz = '$la_matriz' AND prod_activos.IDpuesto = '$el_puesto'"; 
...
mysql_select_db($database_vacantes, $vacantes);
$query_puestos = "SELECT prod_activos.emp_paterno, prod_activos.IDempleado, prod_activos.emp_materno, prod_activos.emp_nombre, prod_activos.sueldo_total, prod_activos.sueldo_diario, prod_activos.rfc, prod_activos.IDpuesto, prod_activos.IDmatriz, prod_activos.IDsucursal, prod_activos.IDarea, prod_activos.IDmatriz, prod_activos.IDempleado, prod_activos.descripcion_nomina, prod_captura.IDcaptura, prod_captura.pago, prod_captura.pago_total, prod_captura.garantizado, prod_captura.lun, prod_captura.mar, prod_captura.mie, prod_captura.jue, prod_captura.vie, prod_captura.sab, prod_captura.adicional, prod_captura.lun_g, prod_captura.mar_g, prod_captura.mie_g, prod_captura.jue_g, prod_captura.vie_g, prod_captura.sab_g, prod_captura.dom, prod_captura.a1, prod_captura.observaciones, prod_captura.a2, prod_captura.a3, prod_captura.a4, prod_captura.a5, prod_captura.a6, prod_captura.a7, prod_captura.a8, prod_captura.a9, prod_captura.a10, prod_captura.a11, prod_captura.a12, prod_captura.a13, prod_captura.a14, prod_captura.a15, prod_captura.a16, prod_captura.a17, prod_captura.a18, prod_captura.a19, prod_captura.a20, prod_captura.a21, prod_captura.a22, prod_captura.a23, prod_captura.a24, prod_captura.a25, prod_captura.a26, prod_captura.a27, prod_captura.a28, prod_captura.semana, prod_captura.reci, prod_captura.carg, prod_captura.dist, prod_captura.esti, prod_captura.fecha_captura, prod_captura.autorizador, vac_puestos.denominacion, vac_puestos.modal FROM prod_activos LEFT JOIN prod_captura ON prod_captura.IDempleado = prod_activos.IDempleado  AND prod_captura.semana = '$la_semana' AND prod_captura.anio = '$anio' LEFT JOIN vac_puestos ON prod_activos.IDpuesto = vac_puestos.IDpuesto WHERE prod_activos.IDmatriz = '$la_matriz' AND prod_activos.IDpuesto = '$el_puesto'"; 
mysql_query("SET NAMES 'utf8'");
$puestos = mysql_query($query_puestos, $vacantes) or die(mysql_error());
$row_puestos = mysql_fetch_assoc($puestos);
$totalRows_puestos = mysql_num_rows($puestos);
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
                    ...
                    <p>Selecciona el empelado para validar su productividad.</p>
                       ...
                       <form method="GET" action="productividad_reporte_empleado_a.php">
						...
						?>
                          ...
                          <td>
                           <?php if ($row_puestos['IDcaptura'] == "") { ?>
							Sin captura
                           <?php } else { ?>
                          <button type="button" data-target="#modal_form_inline<?php echo $row_puestos['IDempleado']; ?>"  data-toggle="modal" class="btn btn-success btn-icon">Ver Detalles</button>
                           <?php } ?>
                           </td>  
                            ...
                            <?php // agregamos el modal especifico
                           		  $modal = "assets/modals/200000.php";
								  require($modal); ?>
