...
$ins_vac_vacante->registerTrigger("END", "Trigger_Default_Redirect", 99, "master_admin_vacantes.php?info=1");
// Add columns
...
$upd_vac_vacante->registerTrigger("END", "Trigger_Default_Redirect", 99, "master_admin_vacantes.php?IDvacante={IDvacante}");
// Add columns
...
$upd_vac_vacante->addColumn("apoyo", "STRING_TYPE", "POST", "apoyo");
...
if ((isset($_GET['IDvacante_borrar'])) && ($_GET['IDvacante_borrar'] != "")) {
  ...
  header("Location: master_admin_vacantes.php?info=3");
}
              ...
              <?php
	           ...
	           $row_fuente = mysql_fetch_assoc($fuente);
                                    ...
                                    <?php  if (@$_GET['IDvacante'] != "") { ?>
                                     <!-- Basic text input -->
									<div class="form-group">
										<label class="control-label col-lg-3">Apoyo Corporativo:</label>
										<div class="col-lg-9">
						<input type="text" name="apoyo_<?php echo $cnt1; ?>" id="apoyo_<?php echo $cnt1; ?>" class="form-control" placeholder="Si aplica, nombre del apoyo corporativo." value="<?php echo KT_escapeAttribute($row_rsvac_vacante['apoyo']); ?>">
										</div>
									</div>
									<!-- /basic text input -->
									<?php } ?>
