...
<!-- Content area -->
				<div class="content">
					    ...
					    <div class="alert bg-green-600 alert-styled-left">
							...
							Se ha agregado correctamente el valor.
					    </div>
                        <?php } ?>
					    <!-- /basic alert -->
					    ...
					    <div class="alert bg-blue-600 alert-styled-left">
							<button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Cerrar</span></button>
							Se ha actualizado correctamente el valor.
					    </div>
                        <?php } ?>
					    <!-- /basic alert -->
                ...
                <form method="POST" action="admin_productividad_garantias.php">
					<table class="table">
							<tr>
							<td>
                                ...
                                <tbody>
								  ...
								  ?>
                                    <tr>
                                      ...
                                      <td><?php if($row_garant['garantia'] != '') { echo $row_garant['garantia']."%";} else { echo "-";} ?></td>
                                      <td><?php if($row_garant['asistencia'] != 0) { echo "SI";} else { echo "NO";} ?></td>
                                      <td><?php if($row_garant['asistencia'] != 0) { echo "$".$row_garant['monto_asistencia'];} else { echo "-";} ?></td>
                                      <td><a href="admin_productividad_garantias_edit.php?IDpuesto=<?php echo $row_autorizados['IDpuesto']; ?>&IDmatriz=<?php echo $row_autorizados['IDmatriz']; ?>" class="btn btn-primary">Editar</a></tr>
