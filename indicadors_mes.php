...
mysql_select_db($database_vacantes, $vacantes);
$query_anioX = "SELECT * FROM vac_anios ORDER BY vac_anios.IDanio DESC";
$anioX = mysql_query($query_anioX, $vacantes) or die(mysql_error());
$row_anioX = mysql_fetch_assoc($anioX);
$totalRows_anioX = mysql_num_rows($anioX);
			...
			<?php require_once('assets/pheader.php'); ?>
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
                    ...
                    <form method="POST" action="indicadors_mes.php">
                	<table class="table">
						<tbody>							  
							<tr>
                            <td>
				...
				<div class="table-responsive">
                    ...
                    <tr class="bg-success"> 
                      ...
                      <th class="col-lg-1 bg-danger">Obj. Mensual</th>
                      <th class="col-lg-1 bg-danger">Obj. Acumu.</th>
                      <th class="col-lg-1 bg-danger">Res. Acumu.</th>
                      <th class="col-lg-1 bg-danger">Vs. <?php echo $anio_anterior; ?></th>
               		 </tr>
                    </thead>
                    <tbody>					
					<?php do {
...
mysql_select_db($database_vacantes, $vacantes);
$query_res_ms21 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND fecha_antiguedad < '$fter2_ms1k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini2_ms1k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms21 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND ind_bajas.IDmotivo < 15 AND (MONTH(fecha_baja) = 1 AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_res_ms22 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND fecha_antiguedad < '$fter2_ms2k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini2_ms2k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms22 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND ind_bajas.IDmotivo < 15 AND (MONTH(fecha_baja) = 2 AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_res_ms23 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND fecha_antiguedad < '$fter2_ms3k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini2_ms3k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms23 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND ind_bajas.IDmotivo < 15 AND (MONTH(fecha_baja) = 3 AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_res_ms24 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND fecha_antiguedad < '$fter2_ms4k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini2_ms4k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms24 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND ind_bajas.IDmotivo < 15 AND (MONTH(fecha_baja) = 4 AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_res_ms25 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND fecha_antiguedad < '$fter2_ms5k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini2_ms5k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms25 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND ind_bajas.IDmotivo < 15 AND (MONTH(fecha_baja) = 5 AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_res_ms26 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND fecha_antiguedad < '$fter2_ms6k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini2_ms6k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms26 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND ind_bajas.IDmotivo < 15 AND (MONTH(fecha_baja) = 6 AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_res_ms27 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND fecha_antiguedad < '$fter2_ms7k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini2_ms7k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms27 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND ind_bajas.IDmotivo < 15 AND (MONTH(fecha_baja) = 7 AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_res_ms28 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND fecha_antiguedad < '$fter2_ms8k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini2_ms8k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms28 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND ind_bajas.IDmotivo < 15 AND (MONTH(fecha_baja) = 8 AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_res_ms29 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND fecha_antiguedad < '$fter2_ms9k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini2_ms9k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms29 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND ind_bajas.IDmotivo < 15 AND (MONTH(fecha_baja) = 9 AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_res_ms210 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND fecha_antiguedad < '$fter2_ms10k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini2_ms10k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms210 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND ind_bajas.IDmotivo < 15 AND (MONTH(fecha_baja) = 10 AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_res_ms211 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND fecha_antiguedad < '$fter2_ms11k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini2_ms11k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms211 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND ind_bajas.IDmotivo < 15 AND (MONTH(fecha_baja) = 11 AND YEAR(fecha_baja) = $anio_anterior)";
...
mysql_select_db($database_vacantes, $vacantes);
$query_res_ms212 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND fecha_antiguedad < '$fter2_ms12k' AND (ind_bajas.fecha_baja IS NULL OR ind_bajas.fecha_baja > '$fini2_ms12k')";
...
mysql_select_db($database_vacantes, $vacantes);
$query_bja_ms212 = "SELECT Count(ind_bajas.AREA_COSTOS) AS TOTAL FROM ind_bajas WHERE ind_bajas.IDmatriz = $IDmatriz AND ind_bajas.IDmotivo < 15 AND (MONTH(fecha_baja) = 12 AND YEAR(fecha_baja) = $anio_anterior)";
...
?>
                    ...
                    <td><?php echo round(($row_resultados['objetivo'] ) / 12, 1); ?>%</td>
                    <td><?php echo round(($row_resultados['objetivo'] * $mes_actual) / 12, 1); ?>%</td>
					
					
					
                    <td><?php 
					if ($Acumulado > 0)  { $a_ = ($Acumulado / $mes_actual) * 12;	} else {	$a_ = 0; 	}
					$b_ = $a_ * 100;
					$c_ = round($b_, 1);
					$r_ = $row_resultados['objetivo'];
					
					$ppp = round(($Acumulado * 100) / $row_resultados['objetivo'],1);
					$pppp = $ppp * 100;
					if ($c_ >= $r_) {echo "<i class='icon-checkmark-circle text-danger position-left'></i></br>";} else {echo "<i class='icon-checkmark-circle text-success position-left'></i></br>";}
					 $pppp."%";	
					 ?> 
					 <?php echo round($Acumulado * 100, 1); ?>%
					 </td>
					<td>
					
					<?php 
					if(round($RotTotalPREVBA * 100, 1) < round($RotTotalPREVBB * 100, 1)) 
					{echo "<i class='icon-checkmark-circle text-danger position-left'></i></br>".  round($RotTotalPREVBA * 100, 1) . "%";}
					else
					{echo "<i class='icon-checkmark-circle text-success position-left'></i></br>". round($RotTotalPREVBA * 100, 1) . "%";}
					?>
	...
	&copy; 2024. <a href="#"><?php echo $row_variables['nombre_sistema']; ?></a> V: 0.9.2 en <a href="<?php echo $row_variables['direccion_web']; ?>" target="_blank"><?php echo $row_variables['empresa']; ?></a>
				  </div>
					<!-- /footer -->
