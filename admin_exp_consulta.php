			...
			<!-- Content area -->
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
                    ...
                    <form method="POST" action="admin_exp_consulta.php">
					<table class="table">
						<tbody>							  
							<tr>
                  ...
                  <!-- Colored button -->
                    ...
                    <a class="btn btn-success" href="admin_exp_consulta_asignar.php">Agregar<i class="icon-arrow-right14 position-right"></i></a>
                    </div>
					</div>
					<!-- /colored button -->
                    ...
                    <tbody>
                        <?php do { ?>
                          <tr>
                            ...
                            <td><?php echo $row_contratos['fecha_inicio']; ?>&nbsp; </td>
                            <td><?php echo $row_contratos['fecha_fin']; ?>&nbsp; </td>
                            <td><a class="btn btn-primary" href="admin_exp_consulta_asignar.php?IDempleado=<?php echo $row_contratos['IDexpc']; ?>">Editar</a>
                           <a class="btn btn-danger" href="admin_exp_consulta_asignar.php?IDempleado=<?php echo $row_contratos['IDexpc']; ?>$borraro=1">Borrar</a>
                           </td>
                          </tr>
