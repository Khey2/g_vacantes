					    ...
					    <div class="alert bg-danger-600 alert-styled-left">
						 Primero se debe asignar turno.
							...
							<?php } else  { ?>
            					...
            					<form method="post" name="form1<?php echo $row_puestos['IDempleado']; ?>" action="productividad_autoriza_puesto_a_t.php?IDpuesto=<?php echo $row_puestos['IDpuesto']; ?>" 
