...
echo "bono_asistencia: ".$bono_asistencia."<br/>";
echo "dias_laborados: ".$dias_laborados."<br/>";
...
echo "monto_asistencias: ".$monto_asistencias."<br/>";
echo "monto_adicional: ".$monto_adicional."<br/>";
echo "hora_extra: ".$hora_extra."<br/>";
echo "Tabulador: ".$monto_tabulador."<br/>";
echo "Dias Laborados: ".$dias_pagar."<br/>";
echo "% pago días: ".$parap."<br/>";
echo "monto previo: ".$monto_previo."<br/>";
echo "porcentaje_carga: ".$porcentaje_carga."<br/>";
echo "monto: ".$monto."<br/>";

if ($gatantizado >= 1) {  
  $pago_total = $garantia_monto;  echo "pago_total: ".$pago_total."<br/>";
  $pago = ($pago_total / $sueldo_semanal) * 100;  echo "pago: ".$pago."<br/>";
 
 $query1 = "UPDATE prod_captura SET bono_asistencia = '$bono_asistencia', adicional = '$monto_adicional', horas_extra_monto = $horas_extras, pago_total = '$pago_total', pago = '$pago' WHERE IDcaptura = '$IDcaptura'"; 
 $result1 = mysql_query($query1) or die(mysql_error());  

}  else { 
 $pago_total = $monto;  echo "pago_total: ".$pago_total."<br/>";
 $pago = ($pago_total / $sueldo_semanal) * 100;  echo "pago: ".$pago."<br/>";

 $query2 = "UPDATE prod_captura SET bono_asistencia = '$bono_asistencia', adicional = '$monto_adicional', horas_extra_monto = $horas_extras, pago_total = '$pago_total', pago = '$pago'  WHERE IDcaptura = '$IDcaptura'"; 
 $result2 = mysql_query($query2) or die(mysql_error());  
 }
	//redirecto
	header("Location: productividad_valida_puesto_t.php?IDpuesto=$el_puesto"); 	
