...
do{ 
$mail->AddAddress($row_casos_responsable['usuario']);
echo $row_casos_responsable['usuario']." ";
} while($row_casos_responsable = mysql_fetch_array($casos_responsable));


$mail->Subject = 'Notificación de cierre de Caso con Sindicato';
$mail->isHTML(true);
$mail->CharSet = 'UTF-8';
$mail->AltBody = 'Notificación de cierre de Caso con Sindicato';
...
<tr>
  <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
        <!-- section text ======-->
        <div style="line-height: 35px">Notificación de Seguimiento <span style="color: #d8020a;">Sindicato</span> <br /></div>
    </td>
</tr>
<tr>
...
<td align="left" style="color: #888888; font-size: 16px; font-family: "Work Sans", Calibri, sans-serif; line-height: 24px;">
	...
	Se a cerrado un caso en donde usted tiene asingación:
	<p>&nbsp;</p>
<ul>
<li><strong>Asunto:</strong> '.$row_sindicato['asunto'].'.</li>
<li><strong>Matriz:</strong> '.$row_sindicato['matriz'].'.</li>
<li><strong>Area:</strong> '.$row_sindicato['area'].'.</li>
<li><strong>Fecha de registro:</strong> '.$fecha_inicio.'.</li>
<li><strong>Fecha de solución esperada/solicitada:</strong> '.$fecha_fin.'.</li>
</ul>
...
if (!$mail->send()) {    echo "Mailer Error: " . $mail->ErrorInfo; 	}
 ...
 header("Location: casos_sindicato.php?info=99");
