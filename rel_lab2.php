  ...
  $result = mysql_query($deleteSQL, $vacantes) or die(mysql_error());
	...
	$totalRows_lpp = mysql_num_rows($lpp);
		...
		if (in_array($row_lpp['IDpuesto_destino'], $os)) {
			...
			$body .= '</td>';
			$body .= '<td align="center">';
			$body .=  date("d-m-Y", strtotime($row_pprueba['fecha_inicio']));
			$body .= '</td>';
			$body .= '<td align="center">';
			$body .=  $row_lpp['semana'];
			$body .= '</td>';
