...
function Trigger_FileUpload(&$tNG) {
	...
	$IDempleado = $_GET['IDempleado'];
	$IDempleado_carpeta = 'capa_files/'.$IDempleado;
...
mysql_select_db($database_vacantes, $vacantes);
$query_tipos = "SELECT * FROM capa_exp_tipos ORDER BY IDtipo DESC";
mysql_query("SET NAMES 'utf8'");
...
$ins_capa_becarios_exp_files = new tNG_insert($conn_vacantes);
$tNGs->addTransaction($ins_capa_becarios_exp_files);
// Register triggers
$ins_capa_becarios_exp_files->registerTrigger("STARTER", "Trigger_Default_Starter", 1, "POST", "KT_Insert1");
$ins_capa_becarios_exp_files->registerTrigger("BEFORE", "Trigger_Default_FormValidation", 10, $formValidation);
$ins_capa_becarios_exp_files->registerTrigger("END", "Trigger_Default_Redirect", 99, "capa_expedientes_nuevo.php?IDempleado={IDempleado}&info=1");
$ins_capa_becarios_exp_files->registerTrigger("AFTER", "Trigger_FileUpload", 97);
// Add columns
$ins_capa_becarios_exp_files->setTable("capa_becarios_exp_files");
$ins_capa_becarios_exp_files->addColumn("nombre", "FILE_TYPE", "FILES", "nombre");
$ins_capa_becarios_exp_files->addColumn("IDempleado", "STRING_TYPE", "POST", "IDempleado");
$ins_capa_becarios_exp_files->addColumn("IDtipo", "NUMERIC_TYPE", "POST", "IDtipo");
$ins_capa_becarios_exp_files->addColumn("borrado", "NUMERIC_TYPE", "VALUE", "0");
$ins_capa_becarios_exp_files->addColumn("fecha", "STRING_TYPE", "POST", "fecha");
$ins_capa_becarios_exp_files->addColumn("observaciones", "STRING_TYPE", "POST", "observaciones");
$ins_capa_becarios_exp_files->addColumn("emp_paterno", "STRING_TYPE", "POST", "emp_paterno");
$ins_capa_becarios_exp_files->addColumn("emp_materno", "STRING_TYPE", "POST", "emp_materno");
$ins_capa_becarios_exp_files->addColumn("emp_nombre", "STRING_TYPE", "POST", "emp_nombre");
$ins_capa_becarios_exp_files->addColumn("rfc", "STRING_TYPE", "POST", "rfc");
$ins_capa_becarios_exp_files->addColumn("denominacion", "STRING_TYPE", "POST", "denominacion");
$ins_capa_becarios_exp_files->addColumn("IDmatriz", "STRING_TYPE", "POST", "IDmatriz");
$ins_capa_becarios_exp_files->addColumn("IDpuesto", "STRING_TYPE", "POST", "IDpuesto");
$ins_capa_becarios_exp_files->addColumn("IDarea", "STRING_TYPE", "POST", "IDarea");
$ins_capa_becarios_exp_files->addColumn("IDsucursal", "STRING_TYPE", "POST", "IDsucursal");
$ins_capa_becarios_exp_files->setPrimaryKey("id", "NUMERIC_TYPE");

// Execute all the registered transactions
$tNGs->executeTransactions();

// Get the transaction recordset
$rscapa_becarios_exp_files = $tNGs->getRecordset("capa_becarios_exp_files");
$row_rscapa_becarios_exp_files = mysql_fetch_assoc($rscapa_becarios_exp_files);
$totalRows_rscapa_becarios_exp_files = mysql_num_rows($rscapa_becarios_exp_files);
...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  ...
  $IDempleado = $_GET['IDempleado'];
  $borrado = $_GET['id'];
  $deleteSQL = "DELETE FROM capa_becarios_exp_files WHERE id ='$borrado'";

  mysql_select_db($database_vacantes, $vacantes);
  $result = mysql_query($deleteSQL, $vacantes) or die(mysql_error());
  header("Location: capa_expedientes_nuevo.php?IDempleado=$IDempleado&info=3");
}
                  ...
                  <div class="panel panel-flat">
                    ...
                    <div>
								...
								<fieldset class="content-group">
                                            ...
                                            <!-- Basic text input -->
                                          	<div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                   ...
                                                   <?php echo $tNGs->displayFieldError("capa_becarios_exp_files", "nombre"); ?>
                                                </div>
                                            </div>
                                            <!-- /basic text input -->
                						...
                						<option value="" <?php if (!(strcmp("", $row_rscapa_becarios_exp_files['IDtipo']))) {echo "selected=\"selected\"";} ?>>Seleccione una opción</option>
					                    <?php do {  ?>
                <option value="<?php echo $row_tipos['IDTipo']?>"<?php if (!(strcmp($row_tipos['IDTipo'], $row_rscapa_becarios_exp_files['IDtipo']))) {echo "selected=\"selected\"";} ?>><?php echo $row_tipos['tipo']?></option>
                  <?php
                  ...
                  <?php echo $tNGs->displayFieldError("capa_becarios_exp_files", "IDtipo"); ?>
										</div>
									</div>
                                            ...
                                            <!-- Basic text input -->
                                          	<div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                  ...
                                                  <?php echo $tNGs->displayFieldError("capa_becarios_exp_files", "observaciones"); ?>
                                              </div>
                                            </div>
                                            <!-- /basic text input -->
                                        ...
                                        <input type="submit" name="KT_Insert1" id="KT_Insert1" value="Cargar" class="btn btn-primary" />
                         				<button type="button" onClick="window.location.href='capa_expedientes_nuevo.php?IDempleado=<?php echo $IDempleado; ?>'" class="btn btn-default btn-icon">Cancelar</button>
