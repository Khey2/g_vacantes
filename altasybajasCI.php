...
mysql_select_db($database_vacantes, $vacantes);
$query_lmatriz = "SELECT * FROM vac_matriz WHERE IDmatriz <> '27'";
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
						...
						<div class="panel-body">
                           ...
                           La información se actualiza de forma semanal, los dias jueves.</br>
                           <strong> Fecha de última actualización:</strong> <?php echo date('d/m/Y', strtotime($fecha_maxima));?></p>

							<form class="form-horizontal" action="altasybajas_reporte_CI.php" method="POST">
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<select class="form-control" id="con_correo" name="con_correo">
									...
									<!-- Fecha -->
                                    <div class="form-group">
										<label class="control-label col-lg-2">Fecha Comparación:<span class="text-danger">*</span></label>
			                        <div class="col-lg-10">
			                        <div class="input-group">
                                    <span class="input-group-addon"><i class="icon-calendar22"></i></span>
                                    	<input type="text" class="form-control  daterange-single" name="fecha_final" id="fecha_final" required="required">
									</div>
                                   </div>
                                  </div> 
									<!-- Fecha -->
