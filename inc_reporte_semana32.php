...
// Increment the Excel row counter
    ...
    header('Content-Disposition: attachment;filename="Incentivos - Semana ' . $semana . " del " . $anio .  ' global.xls"');
