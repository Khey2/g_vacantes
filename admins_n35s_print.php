...
if (isset($_POST['el_periodo'])) {  $_SESSION['el_periodo'] = $_POST['el_periodo'];} else { $_SESSION['el_periodo'] = 2;}

$la_matriz = $_SESSION['la_matriz']; 
$el_periodo = $_SESSION['el_periodo'];
...
mysql_select_db($database_vacantes, $vacantes);
$query_resultados3 = "SELECT DISTINCT IDempleado FROM nom35_resultados WHERE IDmatriz  IN ($la_matriz) AND IDexamen = 3";
...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title">Resultados NOM035 Sucursal.
</h5>
    </div>
        ...
        <table class="table table-bordered table-condensed">
            ...
            <tbody class="border border-neutral">
                <tr>
                    ...
                    <td><?php echo $totalRows_respuestas1a; ?></td>
                </tr>
                <tr >
