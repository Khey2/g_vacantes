			...
			<?php require_once('assets/f_pheader.php'); ?>
				...
				<div class="content">
					...
					<h1 class="text-center content-group text-danger">
						...
						<small class="display-block"><?php echo $row_usuario['emp_paterno']. " ". $row_usuario['emp_materno']. " ". $row_usuario['emp_nombre'];?></small>
					</h1>
					...
					<div class="row">
						...
						Resultado General
								...
								<?php if ($row_resultadogeneral['Calificacion'] >= 85) {echo "<span class='label label-success'>Sobresaliente</span>";}
										   ...
										   else if ($row_resultadogeneral['Calificacion']  >= 50) {echo "<span class='label label-warning'>Deficiente</span>";} 
							...
							<div class="panel panel-body text-center">
								...
								<div class="text-size-small text-muted">
									<?php if ($row_subdimension4['Calificacion'] >= 85) {echo "<span class='label label-success'>Sobresaliente</span>";}
										   ...
										   else if ($row_subdimension4['Calificacion']  >= 50) {echo "<span class='label label-warning'>Deficiente</span>";} 
										   else {echo "Sin resultados";} ?>
								</div>
							</div>
							<!-- /satisfaction rate -->
							...
							<div class="panel panel-body text-center">
								...
								<div class="text-size-small text-muted">
									<?php if ($row_subdimension5['Calificacion'] >= 85) {echo "<span class='label label-success'>Sobresaliente</span>";}
										   ...
										   else if ($row_subdimension5['Calificacion']  >= 50) {echo "<span class='label label-warning'>Deficiente</span>";} 
										   else {echo "Sin resultados";} ?>
								</div>
							</div>
							<!-- /productivity goal -->
							...
							<div class="panel panel-body text-center">
								...
								<div class="text-size-small text-muted">
									<?php if ($row_subdimension6['Calificacion'] >= 85) {echo "<span class='label label-success'>Sobresaliente</span>";}
										   ...
										   else if ($row_subdimension6['Calificacion']  >= 50) {echo "<span class='label label-warning'>Deficiente</span>";} 
										   else {echo "Sin resultados";} ?>
								</div>
							</div>
							<!-- /productivity goal -->
							...
							<div class="panel panel-body text-center">
								...
								<div class="text-size-small text-muted">
									<?php if ($row_subdimension2['Calificacion'] >= 85) {echo "<span class='label label-success'>Sobresaliente</span>";}
										   ...
										   else if ($row_subdimension2['Calificacion']  >= 50) {echo "<span class='label label-warning'>Deficiente</span>";} 
										   else {echo "Sin resultados";} ?>
								</div>
							</div>
							<!-- /productivity goal -->
							...
							<div class="panel panel-body text-center">
								...
								<div class="text-size-small text-muted">
									<?php if ($row_subdimension1['Calificacion'] >= 85) {echo "<span class='label label-success'>Sobresaliente</span>";}
										   ...
										   else if ($row_subdimension1['Calificacion']  >= 50) {echo "<span class='label label-warning'>Deficiente</span>";} 
										   else {echo "Sin resultados";} ?>
								</div>
							</div>
							<!-- /productivity goal -->
							...
							<div class="panel panel-body text-center">
								...
								<div class="text-size-small text-muted">
									<?php if ($row_subdimension3['Calificacion'] >= 85) {echo "<span class='label label-success'>Sobresaliente</span>";}
										   ...
										   else if ($row_subdimension3['Calificacion']  >= 50) {echo "<span class='label label-warning'>Deficiente</span>";} 
										   else {echo "Sin resultados";} ?>
								</div>
							</div>
							<!-- /productivity goal -->
