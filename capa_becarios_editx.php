...
$fecha_rfc = $_POST['rfc'];}
echo $fecha_rfc;
$y3 = substr( $fecha_rfc, 5, 2 );
$m3 = substr( $fecha_rfc, 7, 2 );
$d3 = substr( $fecha_rfc, 9, 2 );
...
mysql_select_db($database_vacantes, $vacantes);
$query_maximo = "Select IDempleado from capa_becarios order by IDempleado desc limit 1"; 
...
$fecha_c =  $_POST['fecha_nacimiento'];
  ...
  $insertSQL = sprintf("INSERT INTO capa_becarios (IDempleado, password, emp_paterno, emp_materno, emp_nombre, IDpuesto, fecha_alta, hora_entrada, hora_salida, IDmatriz, fecha_nacimiento, rfc, curp, activo, IDsucursal, IDarea, IDempleadoJ, IDempleadoJcorreo, IDtipo, IDsubarea, correo, IDmodalidad, IDrol, telefono, emergencias_a, emergencias_b, IDmotivo_baja, observaciones, descripcion_nomina, descripcion_nivel, denominacion, IDaplica_PROD, IDaplica_SED, IDaplica_INC, manual, file) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                      ...
                      <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="form-horizontal form-validate-jquery" enctype="multipart/form-data">
                              ...
                              <?php  } ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
                              <?php  if (isset($_GET['IDempleado'])) { ?>
											<input type="email" name="correo" id="correo" class="form-control" value="<?php echo htmlentities($row_becario['correo'], ENT_COMPAT, ''); ?>" required="required">
                              <?php  } else { ?>
											<input type="email" name="correo" id="correo" class="form-control" value="" placeholder="Correo electrónico" required="required">
                              <?php  } ?>
										</div>
									</div>
									<!-- /basic text input -->
