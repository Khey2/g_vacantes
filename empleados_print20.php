...
<body>
<br clear="ALL"/>
<p class="justificar"><strong>Anexo 4: Descuento por Servicio de Comedor</strong></p>
&nbsp; <br>
...
<p class="justificar><strong>Código F-RH-RS-04</strong></p>
&nbsp; <br>

<p class="justificar">El que suscribe ' .$row_contratos['a_nombre'].' '.$row_contratos['a_paterno'].' '.$row_contratos['a_materno'].', en mi carácter de empleado de la empresa '.$empresa.', manifiesto que estoy conforme en que se me realice un descuento '.$tipo_nomina.' por concepto de alimento, el cual se me proporciona en las instalaciones del comedor, ubicado en esta empresa, para la cual laboro.</p>
...
$nombreDelDocumento = "ANEXO 4 COMEDOR ".date('dmY')." ".$IDempleado.".pdf";
