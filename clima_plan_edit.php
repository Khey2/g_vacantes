...
$updateSQL = "UPDATE sed_clima_planes_liderazgo SET IDdimension = '$IDdimension', area_oportunidad = '$area_oportunidad', estrategias = '$estrategias', actividades = '$actividades', objetivo = '$objetivo',  periodicidad = '$periodicidad',  resultados = '$resultados'  WHERE IDplan = '$IDplan'"; 
  ...
  header("Location: clima_resultados_plan.php?IDempleado=$el_usuario&info=2");
}
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  header("Location: clima_resultados_plan.php?IDempleado=$el_usuario&info=1");
}
...
if (isset($_GET['borrar'])) {
  ...
  $IDplan = $_GET['IDplan'];
  $deleteSQL = "DELETE FROM sed_clima_planes_liderazgo WHERE IDplan = '$IDplan' AND anio = '$anio'";

  mysql_select_db($database_vacantes, $vacantes);
  $result = mysql_query($deleteSQL, $vacantes) or die(mysql_error());
  header("Location: clima_resultados_plan.php?IDempleado=$el_usuario&info=3");
}
...
$ins_sed_clima_files->registerTrigger("END", "Trigger_Default_Redirect", 99, "clima_plan_edit.php?IDplan={IDplan}&IDempleado={IDusuario}&info=1");
...
$query_evaluado = "SELECT vac_areas.IDarea, vac_areas.area, prod_activos.IDempleado, prod_activos.IDpuesto, vac_matriz.matriz, prod_activos.IDarea, prod_activos.IDsucursal, prod_activos.emp_paterno, prod_activos.emp_materno, prod_activos.emp_nombre, prod_activos.denominacion FROM prod_activos left JOIN vac_areas ON prod_activos.IDarea = vac_areas.IDarea LEFT JOIN vac_matriz ON prod_activos.IDmatriz = vac_matriz.IDmatriz WHERE IDempleado = '$el_usuario'";
mysql_query("SET NAMES 'utf8'");
			...
			<!-- Content area -->
			  <div class="content">
                  ...
                  <div class="panel panel-flat">
					...
					<p><strong>Matriz</strong>: <?php echo $row_evaluado['matriz']; ?></p>
					<p>&nbsp;</p>
...
<?php } else { ?>
        ...
        <option value="6" <?php if (!(strcmp(6, htmlentities($row_plan['IDdimension'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Motivación y Reconocimiento</option>
					        ...
					        <input type="hidden" name="fecha" value="<?php echo $fecha; ?>" />
                                ...
                                <a class="btn bg-info" href="clima_resultados_plan.php?IDempleado=<?php echo $IDempleado; ?>">Regresar</a>
                              </div>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                 ...
                                                                 <a href="clima_plan_edit_borrar.php?IDfile=<?php echo $row_files2['IDfile']; ?>&IDplan=<?php echo $IDplan; ?>&IDempleado=<?php echo $IDempleado; ?>" class="btn btn-danger" >Si borrar</a>
								...
								<?php if (isset($_GET['IDplan'])) { ?>
								  ...
								  <div class="form-group">
									...
									<!-- /basic text input -->
                                        ...
                                        <input type="hidden" name="IDusuario" id="IDusuario" value="<?php $IDempleado; ?>" />
                                        <?php echo $tNGs->getErrorMsg(); ?>
