...
?>
                <?php echo $row_puestos['emp_paterno']; ?> <?php echo $row_puestos['emp_materno']; ?> <?php echo $row_puestos['emp_nombre'];?>													
                            ...
                            <?php if ($IDturno == 0 OR $IDturno == '') { ?>


								<p>&nbsp;</p><p>&nbsp;</p>		
					    <div class="alert bg-danger-600 alert-styled-left">
						 Primero se debe asignar turno.
					    </div>
								<p>&nbsp;</p><p>&nbsp;</p>
                            ...
                            <?php if ($row_puestos['capturador'] != '') { ?>
                                ...
                                class="form-horizontal form-validate-jquery">
									...
									<div class="form-group">
									 <div class="row">
										<label class="control-label col-sm-3" data-popup="tooltip-custom" title="REPORTE DIARIO DE ASISTENCIA">PUNTUALIDAD Y ASISTENCIA</label>
											<div class="col-sm-1">
											<div class="checkbox">
												<label>
                                     ...
                                     <!-- /basic singlecheckbox -->
											...
											<div class="form-group">
											 <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="CAJAS CARGADAS DIA LUNES">LUNES U</label>
												<?php if ($IDturno == 1) { ?>
												<div class="col-sm-2">
													Recibidas<input type="number"  maxlength="4" name="a1" value="<?php echo htmlentities($row_puestos['a1'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
												</div>
												<?php }?>
												<div class="col-sm-2">
													Cargadas<input type="number"  maxlength="4" name="a2" value="<?php echo htmlentities($row_puestos['a2'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
												</div>
											<div class="col-sm-1">
											...
											<div class="form-group">
											 <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="CAJAS CARGADAS DIA MARTES">MARTES</label>
												<?php if ($IDturno == 1) { ?>
												<div class="col-sm-2">
													Recibidas<input type="number"  maxlength="4" name="a5" value="<?php echo htmlentities($row_puestos['a5'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
												</div>
												<?php }?>
												<div class="col-sm-2">
													Cargadas<input type="number"  maxlength="4" name="a6" value="<?php echo htmlentities($row_puestos['a6'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
												</div>
											<div class="col-sm-1">
											...
											<div class="form-group">
											 <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="CAJAS CARGADAS DIA MIERCOLES">MIERCOLES</label>
												<?php if ($IDturno == 1) { ?>
												<div class="col-sm-2">
													Recibidas<input type="number"  maxlength="4" name="a9" value="<?php echo htmlentities($row_puestos['a9'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
												</div>
												<?php }?>
												<div class="col-sm-2">
													Cargadas<input type="number"  maxlength="4" name="a10" value="<?php echo htmlentities($row_puestos['a10'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
												</div>
											<div class="col-sm-1">
											...
											<div class="form-group">
											 <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="CAJAS CARGADAS DIA JUEVES">JUEVES</label>
												<?php if ($IDturno == 1) { ?>
												<div class="col-sm-2">
													Recibidas<input type="number"  maxlength="4" name="a13" value="<?php echo htmlentities($row_puestos['a13'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
												</div>
												<?php }?>
												<div class="col-sm-2">
													Cargadas<input type="number"  maxlength="4" name="a14" value="<?php echo htmlentities($row_puestos['a14'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
												</div>
											<div class="col-sm-1">
											...
											<div class="form-group">
											 <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="CAJAS CARGADAS DIA VIERNES">VIERNES</label>
												<?php if ($IDturno == 1) { ?>
												<div class="col-sm-2">
													Recibidas<input type="number"  maxlength="4" name="a17" value="<?php echo htmlentities($row_puestos['a17'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
												</div>
												<?php }?>
												<div class="col-sm-2">
													Cargadas<input type="number"  maxlength="4" name="a18" value="<?php echo htmlentities($row_puestos['a18'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
												</div>
											<div class="col-sm-1">
											...
											<div class="form-group">
											 <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="CAJAS CARGADAS DIA SABADO">SABADO</label>
												<?php if ($IDturno == 1) { ?>
												<div class="col-sm-2">
													Recibidas<input type="number"  maxlength="4" name="a21" value="<?php echo htmlentities($row_puestos['a21'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
												</div>
												<?php }?>
												<div class="col-sm-2">
													Cargadas<input type="number"  maxlength="4" name="a22" value="<?php echo htmlentities($row_puestos['a22'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
												</div>
											<div class="col-sm-1">
											...
											<div class="form-group">
											 <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="CAJAS CARGADAS DIA DOMINGO">DOMINGO</label>
												<?php if ($IDturno == 1) { ?>
												<div class="col-sm-2">
										...
										<div class="form-group">
		 									 <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="ACTIVIDADES GENERALES">ACTIVIDADES GENERALES</label>
												<div class="col-sm-9">
											<select name="a29" class="form-control">
			<option value="75" <?php if (!(strcmp($row_puestos['a29'],  '75'))) {echo "SELECTED";}?>>Todas las actividades asignadas en tiempo y forma.</option>
			<option value="50" <?php if (!(strcmp($row_puestos['a29'],  '50'))) {echo "SELECTED";}?>>La mayoría de las actividades asignadas en tiempo y forma.</option>
			<option value="0" <?php if (!(strcmp($row_puestos['a29'],  '0'))) {echo "SELECTED";}?>>Actividades asignadas no realizadas o incompletas.</option>
      										</select>
												</div>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<select name="garantizado" class="form-control">
                                                ...
                                                <option value="11" <?php if (!(strcmp($row_puestos['garantizado'], '11'))) {echo "SELECTED";} ?>>Apoyo Acapulco</option>
											...
											<div class="form-group">
											 <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="HORAS EXTRAS">HORAS EXTRAS (No.)</label>
												<div class="col-sm-9">
													<input type="number" name="horas_extra" max="9" value="<?php echo $row_puestos['horas_extra']; ?>" class="form-control" />
												<span class="help-block">Topado a 9, máximo 3 dias consecutivos.</span>
                                                </div>
										</div>
                            ...
                            <?php } else { ?>   
                                ...
                                class="form-horizontal form-validate-jquery">
                                    ...
                                    <div class="row">
										...
										<div class="form-group">
											 <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="CAJAS CARGADAS DIA LUNES">LUNES</label>
												<?php if ($IDturno == 1) { ?>
												<div class="col-sm-2">
													Recibidas<input type="number"  maxlength="4" name="a1" value="" class="form-control" />
												</div>
												<?php } ?>
												<div class="col-sm-2">
													Cargadas<input type="number"  maxlength="4" name="a2" value="" class="form-control" />
												</div>
                                               <div class="col-sm-1">
												<label>
											...
											<div class="form-group">
											 <div class="row">
												...
												<?php if ($IDturno == 1) { ?>
												<div class="col-sm-2">
													Recibidas<input type="number"  maxlength="4" name="a5" value="" class="form-control" />
												</div>
												<?php }?>
												<div class="col-sm-2">
													Cargadas<input type="number"  maxlength="4" name="a6" value="" class="form-control" />
												</div>
                                               <div class="col-sm-1">
												<label>
											...
											<div class="form-group">
											 <div class="row">
												...
												<?php if ($IDturno == 1) { ?>
												<div class="col-sm-2">
													Recibidas<input type="number"  maxlength="4" name="a9" value="" class="form-control" />
												</div>
												<?php }?>
												<div class="col-sm-2">
													Cargadas<input type="number"  maxlength="4" name="a10" value="" class="form-control" />
												</div>
                                               <div class="col-sm-1">
												<label>
											...
											<div class="form-group">
											 <div class="row">
												...
												<?php if ($IDturno == 1) { ?>
												<div class="col-sm-2">
													Recibidas<input type="number"  maxlength="4" name="a13" value="" class="form-control" />
												</div>
												<?php }?>
												<div class="col-sm-2">
													Cargadas<input type="number"  maxlength="4" name="a14" value="" class="form-control" />
												</div>
                                               <div class="col-sm-1">
												<label>
											...
											<div class="form-group">
											 <div class="row">
												...
												<?php if ($IDturno == 1) { ?>
												<div class="col-sm-2">
													Recibidas<input type="number"  maxlength="4" name="a17" value="" class="form-control" />
												</div>
												<?php }?>
												<div class="col-sm-2">
													Cargadas<input type="number"  maxlength="4" name="a18" value="" class="form-control" />
												</div>
                                               <div class="col-sm-1">
												<label>
											...
											<div class="form-group">
											 <div class="row">
												...
												<?php if ($IDturno == 1) { ?>
												<div class="col-sm-2">
													Recibidas<input type="number"  maxlength="4" name="a21" value="" class="form-control" />
												</div>
												<?php }?>
												<div class="col-sm-2">
													Cargadas<input type="number"  maxlength="4" name="a22" value="" class="form-control" />
												</div>
                                               <div class="col-sm-1">
												<label>
										...
										<div class="form-group">
											 <div class="row">
												...
												<?php if ($IDturno == 1) { ?>
												<div class="col-sm-2">
													Recibidas<input type="number"  maxlength="4" name="a25" value="" class="form-control" />
												</div>
												<?php }?>
												<div class="col-sm-2">
													Cargadas<input type="number"  maxlength="4" name="a26" value="" class="form-control" />
												</div>
										   </div>
										</div>
										...
										<div class="form-group">
		 									 <div class="row">
												...
												<div class="col-sm-9">
											<select name="a29" class="form-control">
								<option value="75">Todas las actividades asignadas en tiempo y forma.</option>
								<option value="50">La mayoría de actividades asignadas en tiempo y forma.</option>
								<option value="0">Actividades asigandas no realizadas o incompletas.</option>
      										</select>
												</div>
											</div>
										</div>
										<?php } ?>
											...
											<div class="form-group">
											 <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="HORAS EXTRAS">HORAS EXTRAS (No.)</label>
												<div class="col-sm-9">
													<input type="number" name="horas_extra" max="9" value="" class="form-control" />
												<span class="help-block">Topado a 9, máximo 3 dias consecutivos.</span>
                                                </div>
											</div>
