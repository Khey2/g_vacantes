...
// si ya tiene PP	
$query_empleado_dob = "SELECT * FROM incapacidades_accidentes WHERE IDempleado = $IDempleado AND IDestatus = 1 AND IDincapacidad_accidente = 1";
...
header("Location: incapacidades_edit.php?info=9"); $avalidar = 2;
}
                ...
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
							...
							Notificación de captura <br /><span style="color: #C30F2D;">Accidente de Trabajo</span>
                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: "Work Sans", Calibri, sans-serif; line-height: 24px;">
										...
										Le informamos que se ha capturado un nuevo accidente de trabajo:
                                        </p>
<table id="customers"> 
<thad>
<tr>
...
<th style="text-align:center">ST-7 previo</th>
</tr>
</thead>
';
$body .= '<tbody>';
...
$body .= '</tr>';
$body .= '</tbody></table>';
$body .= '<p style="line-height: 24px; margin-bottom:20px;">&nbsp;</p>
										<p style="line-height: 24px;margin-bottom:15px;">
		...
		<?php require_once('assets/menu.php'); ?>
			...
			<?php require_once('assets/pheader.php'); ?>
				...
				<div class="content">
					    ...
					    <div class="alert bg-warning-600 alert-styled-left">
							<button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Cerrar</span></button>
							El Empleado ya tiene un accidente de trabajo capturado y activo.
					    </div>
                        <?php } ?>
					    <!-- /basic alert -->
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body">
							...
							Una vez validado, captura los datos que se te piden. Todos los campos son obligatorios.<br/>
							Asegurate de cargar el formato ST-7.</p>
                            <p>&nbsp;</p>
						...
						<legend class="text-semibold">Datos Empleado</legend>
                             ...
                             <?php } ?>
                              ...
                              <?php if (isset($_POST['IDempleado']) OR isset($_GET['IDempleado'])) { ?>
								<?php if((isset($alerta) && $alerta != 2)) { ?>
						 <input type="submit" name="KT_insert1" class="btn btn-primary" id="KT_insert1" value="Agregar Accidente" />
						 		<?php } ?>
                    	 <button type="button" onClick="window.location.href='incapacidades_edit.php'" class="btn btn-warning btn-icon">Buscar otro</button>
