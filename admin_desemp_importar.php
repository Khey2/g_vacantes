...
do {
 ...
 header("Location: admin_indiv_edit.php?info=8&IDperiodo=$IDperiodo&IDempleado=$IDempleado&id=$id");
...
do {
 ...
 header("Location: admin_indiv_edit.php?info=9&IDperiodo=$IDperiodo&IDempleado=$IDempleado&id=$id");
}
?>
