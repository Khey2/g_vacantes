...
$dias_laborados = $lun_a + $mar_a + $mie_a + $jue_a + $vie_a + $sab_a + $dom_a;
	if ($dias_laborados >= 6) {$asistencia = 1; }  else  {$asistencia = 0; } 
...
elseif ($dias_laborados == 6) {$dias_pagar = 7; $parap = 1;} 
elseif ($dias_laborados == 5) {$dias_pagar = 6; $parap = 0.8571;} 
elseif ($dias_laborados == 4) {$dias_pagar = 5; $parap = 0.7143;} 
elseif ($dias_laborados == 3) {$dias_pagar = 4; $parap = 0.5714;} 
elseif ($dias_laborados == 2) {$dias_pagar = 3; $parap = 0.4286;} 
elseif ($dias_laborados == 1) {$dias_pagar = 2; $parap = 0.2857;} 
...
echo "gatantizado: " . $gatantizado. "</br>";
...
echo "Adicional: " . $monto_adicional . "</br>";
    ...
    $query2 = "UPDATE prod_captura SET pago = '$porcentaje_carga', pago_total = '$monto', 			adicional2 = '$monto_adicional' WHERE IDcaptura = '$IDcaptura'"; 
    $result2 = mysql_query($query2) or die(mysql_error());  
		}
	//redirecto
	header("Location: productividad_valida_puesto.php?IDpuesto=$el_puesto"); 	
?>