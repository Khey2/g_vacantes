							...
							<div class="media">
								...
								<div class="media-body">
									...
									<div class="text-size-mini text-muted">
										<i class="icon-pin text-size-small"></i> Mastar Administración
									</div>
								</div>
                  ...
                  <div class="panel panel-flat">
					...
					<table class="table datatable-button-html5-columns">
						...
						<?php do { $dias4 = $row_vacantes['fecha_usr4']; ?>
							...
							<td>
                         <button type="button" class="btn btn-primary btn-icon" onClick="window.location.href='admin_vacantem_edit.php?IDvacante=<?php echo $row_vacantes['IDvacante']; ?>'">Ver</button>
                         <button type="button" data-target="#modal_theme_danger<?php echo $row_vacantes['IDvacante']; ?>"  data-toggle="modal" class="btn btn-danger btn-icon">Borrar</button>
                            </td>
						    </tr>
                        <?php } ?>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="vacante_editm.php?IDvacante_borrar=<?php echo $row_vacantes['IDvacante']; ?>">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
