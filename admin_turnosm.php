							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									...
									<ul>
										...
										<li class="active"><a href="admin_areasm.php">Areas</a></li>
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</li>
						</ul>
				...
				<div class="content">
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body">
							<p>Selecciona el registro para ediitar.</p>
					</div>
                      ...
                      <?php // do { ?>
                        <tr>
                         ...
                         <button type="button" data-target="#modal_theme_danger"  data-toggle="modal" class="btn btn-danger btn-icon">Borrar</button></td>
                        </tr>                       
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="admin_admin_XXXXXXXXXXXXXXX_edit.php?IDusuario=<?php echo $row_usuario_['IDusuario']; ?>">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
