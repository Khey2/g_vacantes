...
?>                                                                       
             			<form method="post" class="form-horizontal form-validate-jquery" name="form1" action="admin_aumento_anual.php" >
...
<?php if ($Tipo == 1) { ?>
                                	<input type="hidden" name="tipo" value="1">
											<div class="form-group">
													...
													<div class="col-sm-9">
														<?php echo $row_detalle['emp_paterno']." ".$row_detalle['emp_materno']." ".$row_detalle['emp_nombre']; ?>
													</div>
												</div>
											...
											<div class="form-group">
												...
												<input type="number" min="-50000" max="50000" step="0.01" name="aumento" class="form-control" id="aumento" value="<?php echo $row_detalle['aumento_monto'];?>" required="required">
													</div>
													</div>
...
<?php } else { ?>
                                	<input type="hidden" name="tipo" value="2">
											...
											<div class="form-group">
													...
													<div class="col-sm-9">
													<div class="input-group">
												<input type="number" min="-60" max="60" step="1" name="aumento" class="form-control" id="aumento" value="<?php echo $row_detalle['aumento_porcentaje']; ?>" required="required">
												<span class="input-group-addon">%</span>
													</div>
													</div>
													...
													<div class="col-sm-9">
														<textarea name="comentarios" rows="3" class="form-control" id="comentarios" placeholder="Justificacion."><?php echo $row_detalle['comentarios']; ?></textarea>
													</div>
												</div>
					...
					<div id="modal_theme_danger" class="modal fade" tabindex="-1">
						<div class="modal-dialog modal-sm modal-dialog-centered">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                    <a class="btn btn-danger" href="admin_aumento_anual.php?IDempleado=<?php echo $IDempleado?>&restablecer=1">Si restablecer</a>
								</div>
							</div>
						</div>
					</div>
