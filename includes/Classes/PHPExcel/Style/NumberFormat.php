...
class PHPExcel_Style_NumberFormat extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
	...
	const FORMAT_DATE_DMYSLASH				= 'dd/mm/yyyy';
	const FORMAT_DATE_DMYMINUS				= 'dd/mm/yyyy';
	const FORMAT_DATE_DMMINUS				= 'd-m';
	const FORMAT_DATE_MYMINUS				= 'm-y';
	const FORMAT_DATE_XLSX14				= 'mm-dd-yyyy';
	const FORMAT_DATE_XLSX15				= 'dd/mm/yyyy';
	const FORMAT_DATE_XLSX16				= 'dd-mm';
	const FORMAT_DATE_XLSX17				= 'mmm-yy';
	const FORMAT_DATE_XLSX22				= 'dd/mm/yy h:mm';
	const FORMAT_DATE_DATETIME				= 'dd/mm/yyy h:mm';
