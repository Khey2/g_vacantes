...
*/
	...
	$KT_CMN_uploadErrorMsg = '<strong>File not found:</strong> <br />%s<br /><strong>Please upload the f_includes/ folder to the testing server.</strong>';
	$KT_CMN_uploadFileList = array('f_KT_config.inc.php', 'f_KT_functions.inc.php');
