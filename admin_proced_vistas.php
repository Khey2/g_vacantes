					...
					<p>A continuación se muestran las vistas por Documento.</p>
                      ...
                      <?php do { ?>
                        <tr>
                          ...
                          <td><?php if ( $row_resultados['IDDarea'] > 0) { echo $row_resultados['area']; } else { echo "-"; }?></td>
                          <td><?php if ( $row_resultados['IDsubarea'] > 0) { echo $row_resultados['subarea']; } else { echo "-"; }?></td>
                          <td><?php echo $row_resultados['vistas']; ?></td>
                          <td><?php 
						  $IDempleado_carpeta = "proced/".$row_resultados['IDdireccion']."/".$row_resultados['IDDarea']."/".$row_resultados['IDsubarea']."/".$row_resultados['file']; 		 
						 if (!file_exists($IDempleado_carpeta)) { ?>
						 <a href="admin_proced_directorio.php" class="btn btn-xs btn-danger">Cargar</a>
						 <?php } else { ?>
						 <a href="<?php echo $IDempleado_carpeta; ?>" class="btn btn-xs btn-success">OK</a>
						 <?php }  ?>
                        </tr>      
