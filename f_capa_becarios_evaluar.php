...
$result2 = mysql_query($query2) or die(mysql_error());  	
  echo "<br/>INS Llave: '$key' Valor: '$value'";
}
}
// redireccionar
header("Location: f_capa_becarios_evaluar_update.php?IDempleado=$IDempleado&IDmes=$el_mes&anio=$anio"); 
}
...
$result1 = mysql_query($query1) or die(mysql_error());  	
  echo "<br/>UPD Llave: '$key' Valor: '$value'";
}
}
// redireccionar
header("Location: f_capa_becarios_evaluar_update.php?IDempleado=$IDempleado&IDmes=$el_mes&anio=$anio"); 
		...
		<div class="media-body">
								...
								<ul class="media-list">
									<li class="media panel-body stack-media-on-mobile">
										...
										<div class="media-body">
											...
											<?php if ($row_resultado['IDcalificacion'] != '') { ?>
											<ul class="list-inline list-inline-separate mb-10">
									...
									<button type="button" onClick="window.location.href='f_capa_becarios.php'" class="btn btn-default btn-icon">Regresar</button><p>&nbsp;</p>
							        <span class="display-block text-semibold"><h5>Evaluación de Desempeño</h5></span>
							...
							<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
								...
								<?php } else if ($el_tipo_pregunta == 3 ) {?>		
										...
										<div class="form-group pt-15">
												  <textarea name="<?php echo $row_preguntas['IDpreguntaNum']; ?>" rows="3" class="form-control" id="<?php echo $row_preguntas['IDpreguntaNum']; ?>" placeholder="Tu retroalimentación es muy importe, asegurate de ser objetivo."><?php echo ($row_respuesta['IDrespuesta']); ?></textarea>
										</div>
								<?php } ?>
