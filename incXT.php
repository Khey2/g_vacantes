...
?>
            					...
            					<form method="post" class="form-horizontal form-validate-jquery" name="form1" action="inc_cap_puesto.php" >
                                    ...
                                    <?php } ?>
											...
											<div class="form-group">
			                                    <div class="row">
												<label class="control-label col-sm-3" data-popup="tooltip-custom" title="Excedente">Excedente de Productividad:<span class="text-danger">*</span></label>
												<div class="col-sm-9">
											<select name="IDprod" class="form-control" required="required">
                                            	<option value="0" <?php if (!(strcmp(0, htmlentities($row_detalle['IDprod'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>No</option>
                                            	<option value="1" <?php if (!(strcmp(1, htmlentities($row_detalle['IDprod'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>>Si</option>
									      </select>
												</div>
											</div>
	                                    </div>
										...
										<div class="form-group">
											 <div class="row">
												...
												<div class="col-sm-9">
                                                 ...
                                                 <strong> % pagado por garant&iacute;a en productividad = 35%.</strong>	</br>
                                                 <strong> % adicional solicitado = 5% ($100).</p></strong>												
                                                  </div>
											</div>
										</div>
                                    </div>
                                    ...
                                    <?php if ($row_domingos['veces'] > 2) { //Historico ?>
                                             <div class="form-group">
                                             <span class="label label-flat label-block border-danger text-danger-600">
                                             En las &uacute;ltimas 4 semanas, se han capturado <?php echo $row_domingos['veces']; ?>
                                              domingos trabajados por un monto de <?php echo $row_domingos['Monto']; ?>.</span>
                                             </div>
                                    <?php } ?>
                                    ...
                                    <H6>DIAS FESTIVOS</H6>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
												<input type="number" name="diasf" min="1" max="1" value="<?php echo htmlentities($row_detalle['diasf'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
												</div>
											</div>
	                                    </div>
