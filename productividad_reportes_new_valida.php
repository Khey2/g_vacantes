...
prod_captura.anio = prod_semana_cierre.anio AND prod_captura.IDmatriz = prod_semana_cierre.IDmatriz WHERE prod_captura.anio = '$anio' ".$a1.$b1.$c1.$d1." ORDER BY vac_matriz.IDmatriz ASC";
...
$objPHPExcel = $objReader->load("PRD/cedulaT.xlsx");
  ...
  if ($row_reporte['horas_extra'] == '') { $horas_extra = 0;} else  { $horas_extra = $row_reporte['horas_extra'];}
	...
	$Pre_final = $adicional + $row_reporte['pago_total'] + $row_reporte['adicional3'] + $row_reporte['horas_extra_monto'];
