...
mysql_select_db($database_vacantes, $vacantes);
$query_catalogo = "SELECT capa_eventos_grupo_puestos.*, vac_puestos.denominacion FROM capa_eventos_grupo_puestos INNER JOIN vac_puestos ON capa_eventos_grupo_puestos.IDpuesto = vac_puestos.IDpuesto WHERE IDCcurso = $IDCcurso";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO capa_eventos_grupo_puestos (IDusuario, IDCcurso, IDpuesto) VALUES (%s, %s, %s)",
  ...
  header("Location: capa_catalogos_7.php?info=1&IDCcurso=$IDCcurso"); 	
}
...
if ((isset($_GET['borrar'])) && ($_GET['borrar'] == 1)) {
  ...
  $deleteSQL = "DELETE FROM capa_eventos_grupo_puestos WHERE IDCcurso_tipos = $borrado";

  mysql_select_db($database_vacantes, $vacantes);
  $result = mysql_query($deleteSQL, $vacantes) or die(mysql_error());
  header("Location: capa_catalogos_7.php?info=3&IDCcurso=$IDCcurso");
}
...
$agregartodos = "INSERT INTO capa_eventos_grupo_puestos (IDCcurso, IDpuesto, IDusuario) value ('$IDCcurso', '$elpuesto', '$IDusuario')";
mysql_select_db($database_vacantes, $vacantes);
...
$deleteSQL = "DELETE FROM capa_eventos_grupo_puestos WHERE IDCcurso = $borrado";
mysql_select_db($database_vacantes, $vacantes);
$result = mysql_query($deleteSQL, $vacantes) or die(mysql_error());
header("Location: capa_catalogos_7.php?info=3&IDCcurso=$IDCcurso");
}
...
$deleteSQL = "DELETE FROM capa_eventos_grupo_puestos WHERE IDCcurso = $borrado AND IDpuesto IN ($credenciales)";
mysql_select_db($database_vacantes, $vacantes);
$result = mysql_query($deleteSQL, $vacantes) or die(mysql_error());
header("Location: capa_catalogos_7.php?info=3&IDCcurso=$IDCcurso");
}
...
<body> 
	...
	<div class="page-container">
        ...
        <form method="post" name="form1" action="capa_catalogos_7.php?todos=3&IDCcurso=<?php echo $IDCcurso; ?>">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="capa_catalogos_7.php?IDCcurso_tipos=<?php echo $row_catalogo['IDCcurso_tipos']; ?>&IDCcurso=<?php echo $IDCcurso; ?>&borrar=1">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<form action="capa_catalogos_7.php?IDCcurso=<?php echo $IDCcurso; ?>" method="post" name="importar" id="importar" class="form-horizontal" enctype="multipart/form-data">
									<fieldset>
					...
					<div id="modal_theme_agregar2" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                    <a href="capa_catalogos_7.php?todos=1&IDCcurso=<?php echo $IDCcurso; ?>" class="btn btn-danger">Si Agregar</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div id="modal_theme_agregar3" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                    <a href="capa_catalogos_7.php?todos=2&IDCcurso=<?php echo $IDCcurso; ?>" class="btn btn-danger">Si Borrar</a>
								</div>
							</div>
						</div>
					</div>
