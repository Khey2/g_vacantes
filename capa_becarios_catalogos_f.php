...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $texto = $_POST["texto_a"];
  $updateSQL = "UPDATE capa_becarios_texto SET texto_a = '$texto' WHERE IDcapa = 1";

  mysql_select_db($database_vacantes, $vacantes);
  $Result1 = mysql_query($updateSQL, $vacantes) or die(mysql_error());
  header("Location: capa_becarios_catalogos_f.php?info=1"); 	
}
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body">
							<p>Selecciona el registro para editarlo.</p>
									...
									<form action="capa_becarios_catalogos_f.php" method="post" name="importar" id="importar" class="form-horizontal" enctype="multipart/form-data">
									<fieldset>
											<textarea class="wysihtml5 wysihtml5-min form-control"  name="texto_a" id="texto_a" rows="40"><?php echo $row_catalogo['texto_a']; ?></textarea>
									</fieldset>
														
																			
												</div>
										<div class="modal-footer">
											<button type="submit" id="submit" name="import" class="btn btn-success">Actualizar</button> 
