                      ...
                      <form method="post" name="form1" action="<?php echo $editFormAction; ?>" class="form-horizontal form-validate-jquery">
								...
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<input type="text" name="a_paterno" id="a_paterno" class="form-control" onKeyUp="this.value=this.value.toUpperCase()" placeholder="Apellido Paterno" value="" required>
										</div>
									</div>
									<!-- /basic text input -->
                                      <!-- Basic text input -->
								...
								<!-- Fecha -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
										  <input type="text" id="d_colonia" name="d_colonia" class="form-control" placeholder="Colónia" value="" required="required">
                                        </div>
                                    </div>
                                    <!-- /basic text input -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                          <input type="text" id="d_delegacion_municipio" name="d_delegacion_municipio" class="form-control" placeholder="Alcaldía o Municipio" value="" required="required">
                                        </div>
                                    </div>
                                    <!-- /basic text input -->
										...
										<div class="col-lg-9">
											<select name="d_estado" id="d_estado" class="form-control" required="required">
												<option value="0">Seleccione una opción</option> 
												  <?php  do { ?>
												  <option value="<?php echo $row_estado['estado']?>"><?php echo $row_estado['estado']?></option>
												  <?php
