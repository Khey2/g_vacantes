					...
					<table class="table table-condensed datatable-button-html5-columns">
                      ...
                      <?php do { ?>
                        <tr>
                          ...
                          <td><?php if ($row_puestos['descrito'] == 3) {echo "Capturado: terminado";}
						  elseif ($row_puestos['descrito'] == 2) {echo "Capturado: en revisión";}
						  elseif ($row_puestos['descrito'] == 1) {echo "En captura";}
						  else {echo "Pendiente";} ?></td>
                         <td><button type="button" class="btn btn-success" onClick="window.location.href='dps/imprimir.php?IDpuesto=<?php echo $row_puestos['IDpuesto']; ?>'">Decargar</button></td>
                        </tr>                       
