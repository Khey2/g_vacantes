...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "admins_n35e_resultado.php?info=1";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<!-- Page container -->
	<div class="page-container">
        ...
        <a href="admins_n35e_resultado2_print.php?IDresultado=<?php echo $IDresultado; ?>" target="_blank" class="btn btn-success">Imprimir</a>
					</div>
