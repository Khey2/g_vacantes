...
?>
                            <?php echo $row_puestos['emp_paterno']; ?> <?php echo $row_puestos['emp_materno']; ?> <?php echo $row_puestos['emp_nombre'];?>													
            					...
            					<form method="post" name="form1<?php echo $row_puestos['IDempleado']; ?>" action="productividad_autoriza_empleado_a.php?IDpuesto=<?php echo $row_puestos['IDpuesto']; ?>" 
                                class="form-horizontal form-validate-jquery">
                                    ...
                                    <input type="hidden" name="autorizador" value="<?php echo $row_usuario['IDusuario']; ?>" >
									...
									<div class="form-group">
									 ...
									 <div class="form-group">
											...
											<select name="garantizado" class="form-control">
                                                ...
                                                <option value="5" <?php if (!(strcmp($row_puestos['garantizado'], '5'))) {echo "SELECTED";} ?>>Incapacidad</option>
                                                ...
                                                <option value="9" <?php if (!(strcmp($row_puestos['garantizado'], '9'))) {echo "SELECTED";} ?>>Otro (explicar en Observaciones)</option>
    									    </select>
												</div>
											</div>
										</div>
											 ...
											 <div class="row">
												...
												<div class="col-sm-9">
												   <div class="input-group">
                                                   	<input type="number" name="adicional" maxlength="6" value="<?php echo htmlentities($row_puestos['adicional'], ENT_COMPAT, 'utf-8'); ?>" class="form-control" />
 <span class="help-block">Los montos adicionales se deben solicitar al Jefe Regional de Operaciones. Los motivos de suplencia, horas extras y apoyos adioncales se reportan y pagan en incidencias semanales, previa autorizaci&oacute;n del Jefe Regional de Operaciones.</span>
                                                 </div>
											</div>
										</div>
