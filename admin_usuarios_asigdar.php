...
$upd_vac_usuarios->registerTrigger("END", "Trigger_Default_Redirect", 99, "admin_usuarios.php?info=2");
// Add columns
$upd_vac_usuarios->setTable("vac_usuarios");
$upd_vac_usuarios->addColumn("IDmatrizes", "STRING_TYPE", "POST", "IDmatrizes");
...
<div class="content">
                      ...
                      <form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" class="form-horizontal form-validate-jquery">
						...
						<?php echo $row_usuario_['usuario_nombre'] . " " . $row_usuario_['usuario_parterno'] . " ". $row_usuario_['usuario_materno']; ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
						<input name="IDmatrizes" id="IDmatrizes" value="<?php echo KT_escapeAttribute($row_rsvac_usuarios['IDmatrizes']); ?>"
            ...
            <input type="submit" name="KT_Update1" id="KT_Update1"  value="Asigar Matrices" class="btn bg-indigo btn-icon" />
             <button type="button" onClick="window.location.href='admin_usuarios.php'" class="btn btn-info btn-icon">Regresar</button>
                            </form>
                            <p>&nbsp;</p>
                            </p>
<p>&nbsp;</p>
