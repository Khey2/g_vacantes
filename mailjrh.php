...
$mail->AddAddress('jglopez@sahuayo.mx');
$mail->AddAddress('jsegura@sahuayo.mx');
$mail->Subject = 'Reporte Semanal de Bajas y Altas de Jefes de RH';
$mail->isHTML(true);
$mail->CharSet = 'UTF-8';
$mail->AltBody = 'Reporte Semanal de Bajas y Altas de Jefes de RH';
...
<tr>
  <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
        <!-- section text ======-->
        <div style="line-height: 35px">Reporte Semanal de Altas y Bajas <span style="color: #d8020a;">Jefes de Recursos Humanos</span></div>
    </td>
</tr>
<tr>
...
<td align="left" style="color: #888888; font-size: 16px; font-family: "Work Sans", Calibri, sans-serif; line-height: 24px;">
	...
	A continuación se muestran las bajas y altas de Jefes de Recursos Humanos.<br />
