...
mysql_select_db($database_vacantes, $vacantes);
$query_puestos = "SELECT DISTINCT vac_puestos.IDpuesto, vac_puestos.IDarea, vac_puestos.tipo, vac_puestos.descrito, vac_puestos.visible, vac_puestos.denominacion, vac_areas.area, sed_dps.fecha_actualizacion FROM vac_puestos left JOIN vac_areas ON vac_puestos.IDarea = vac_areas.IDarea left JOIN sed_dps ON sed_dps.IDpuesto = vac_puestos.IDpuesto WHERE vac_puestos.tipo = 2"; 
...
if ((isset($_GET['descrito'])) && ($_GET['descrito'] != "")) {
  ...
  header("Location: puestos.php?info=4");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="content">
                  ...
                  <div class="panel panel-flat">
					...
					<div class="panel-body">
							<p>Selecciona el Puesto a editar.</p>

                    <!-- Colored button -->
					<div class="row">
					<div class="panel-body text-center">
                    <a class="btn btn-primary" href="puestos_edit.php">Agregar Puesto<i class="icon-arrow-right14 position-right"></i></a>
                    </div>
					</div>
					<!-- /colored button -->
                      ...
                      <?php do { ?>
                        <tr>
                          ...
                          <td><?php if ($row_puestos['fecha_actualizacion'] > 0) {echo $row_puestos['fecha_actualizacion'];} else {echo "Sin fecha";} ?></td>
                          <td><?php if ($row_puestos['visible'] == 1) {echo "Si";}  else {echo "No";} ?></td>
                         <td><button type="button" class="btn btn-primary" onClick="window.location.href='puestos_edit.php?IDpuesto=<?php echo $row_puestos['IDpuesto']; ?>'">Editar</button> 
                        </tr>                       
