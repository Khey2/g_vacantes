...
$ins_vac_vacante->registerTrigger("END", "Trigger_Default_Redirect", 99, "admin_vacantes.php?info=1");
...
$upd_vac_vacante->registerTrigger("END", "Trigger_Default_Redirect", 99, "admin_vacantes.php?info=2");
...
if ((isset($_GET['IDvacante_borrar'])) && ($_GET['IDvacante_borrar'] != "")) {
  ...
  header("Location: admin_vacantes.php?info=3");
}
    ...
    <form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" enctype="multipart/form-data" class="form-horizontal form-validate-jquery">
                    ...
                    <?php $cnt1++; ?>
						...
						<input type="file" name="archivo_<?php echo $cnt1; ?>" id="archivo_<?php echo $cnt1; ?>" class="file-styled">
                         ...
                         <button type="button" onClick="window.location.href='admin_vacantes.php'" class="btn btn-default btn-icon">Regresar</button>
                                <?php }  ?>
                            </div>
                          </div>
                       </fieldset>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="admin_vacante_edit.php?IDvacante_borrar=<?php echo $row_vacante['IDvacante']; ?>">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
