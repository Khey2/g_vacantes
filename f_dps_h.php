...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  header("Location: f_dps_h.php?info=1&IDpuesto=$IDpuesto");
}
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  header("Location: f_dps_h.php?info=2&IDpuesto=$IDpuesto");
}
					...
					<div id="modal_theme_danger<?php echo $row_puesto_catalogos['IDcriterio']; ?>" class="modal fade" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                                     <a class="btn btn-danger" href="f_dps_borrar.php?IDcriterio=<?php echo $row_puesto_catalogos['IDcriterio']; ?>&IDpuesto=<?php echo $IDpuesto; ?>&pagina=h">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
