...
<?php if ($row_activos['IDestatus'] != '') { ?>
            					...
            					<form method="post" class="form-horizontal form-validate-jquery" name="form1" action="asistencias_edit.php?IDfecha=<?php echo $IDfecha; ?>&IDmatriz=<?php echo $IDmatriz; ?>" >
									<div class="modal-body">
