...
mysql_select_db($database_vacantes, $vacantes);
$query_calendario = "SELECT * FROM pp_prueba_semanas WHERE IDtipo = $tipo_nomina AND fecha_pago > CURDATE() LIMIT 25";  
...
$insertSQL = sprintf("INSERT INTO pp_prueba_pagos (IDempleado, IDpprueba, fecha_pago, monto_pago, semana, IDestatus) VALUES (%s, %s, %s, %s, %s, %s)",
 ...
 header("Location: admin_pprueba_pagos_edit_pagos.php?IDpprueba=$IDpprueba&info=1");
}
...
header("Location: admin_pprueba_pagos_edit_pagos.php?IDpprueba=$IDpprueba&info=9");
}
...
if ((isset($_GET['IDpprueba_borrar'])) && ($_GET['IDpprueba_borrar'] != "")) {
 ...
 header("Location: admin_pprueba_pagos_edit_pagos.php?IDpprueba=$IDpprueba&info=3");
}
			...
			<?php require_once('assets/pheader.php'); ?>
				...
				<div class="content">
					...
					<div class="panel-body text-center">
                     ...
                     <a class="btn btn-info" href="admin_pprueba_pagos_edit_pagos.php?IDpprueba=<?php echo $IDpprueba; ?>&pregarca=1">Precargar Pagos<i class="icon-arrow-right14 position-right"></i></a>
                     <?php } ?>
                    	 <button type="button" onClick="window.location.href='admin_pprueba_pagos.php'" class="btn btn-default btn-icon">Regresar</button>
                    </div>
					</div>
					<!-- /colored button -->
									...
									<div id="modal_theme_danger<?php echo $row_pprueba['IDpprueba_pagos']; ?>" class="modal fade" tabindex="-1">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-footer">
													<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
													<a class="btn btn-danger" href="admin_pprueba_pagos_edit_pagos.php?IDpprueba=<?php echo $IDpprueba; ?>&IDpprueba_borrar=<?php echo $row_pprueba['IDpprueba_pagos']; ?>">Si borrar</a>
												</div>
											</div>
										</div>
									</div>
