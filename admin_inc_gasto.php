					...
					<div class="row">
							...
							<div class="panel panel-body">
								...
								<div class="progress progress-micro mb-10">
									<div class="progress-bar bg-primary-400" style="width: 100%">
										...
										<span class="text-muted"><strong>Monto:  </strong><?php echo "$" . number_format($row_incidencias_['INC1']); ?></span>
							</div>
						</div>
						...
						<div class="col-sm-2 col-md-2">
							<div class="panel panel-body">
								<div class="media no-margin-top content-group">
									...
									<div class="media-body">
										<h6 class="no-margin text-semibold">Suplencia</h6>
									</div>
								</div>
						...
						<div class="col-sm-2 col-md-2">
							<div class="panel panel-body">
								<div class="media no-margin-top content-group">
									...
									<div class="media-body">
										<h6 class="no-margin text-semibold">Domingos Trabajados</h6>
									</div>
								</div>
						...
						<div class="col-sm-2 col-md-2">
						  <div class="panel panel-body">
								<div class="media no-margin-top content-group">
									<div class="media-body">
										<h6 class="no-margin text-semibold">Productividad<h6>
									</div>
