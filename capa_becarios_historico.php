...
mysql_select_db($database_vacantes, $vacantes);
$query_resultados  = "SELECT * FROM capa_becarios_evaluacion WHERE IDempleado = '$el_becario'";
		...
		<div class="media-body">
					...
					<table class="table table-condensed datatable-button-html5-columns">
						...
						?>
							...
							<td><?php if ($mes_file != '') { do { ?><a href="becariosfiles/<?php echo $row_doctos['IDempleado']; ?>/<?php echo $row_doctos['file']; ?>"><?php echo $row_doctos['tipo_file']; ?></a><br/><?php } while ($row_doctos = mysql_fetch_assoc($doctos)); } ?></td>
							<td>
								<button type="button" class="btn btn-success btn-icon" onClick="window.location.href='capa_becarios_evaluar_historico.php?IDempleado=<?php echo $row_becarios['IDempleado']; ?>&IDmes=<?php echo $row_becarios['IDmes']; ?>&anio=<?php echo $row_becarios['anio']; ?>'">Ver evaluación</button>
								<button type="button" class="btn btn-warning btn-icon" onClick="window.location.href='capa_becarios_print.php?IDempleado=<?php echo $row_becarios['IDempleado']; ?>&IDmes=<?php echo $row_becarios['IDmes']; ?>&anio=<?php echo $row_becarios['anio']; ?>'">Imprimir</button>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
                                    ...
                                    <a class="btn btn-danger" href="capa_becarios_historico.php?IDempleado=<?php echo $el_becario; ?>&IDevaluacion=<?php echo $row_becarios['IDevaluacion']; ?>&borrar=1">Si borrar</a>
								</div>
							</div>
						</div>
					</div>
