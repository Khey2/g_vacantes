...
mysql_select_db($database_vacantes, $vacantes);
$query_respuesta_salto1 = "SELECT * FROM nom35_respuestas WHERE IDexamen = '$el_examen' AND IDpregunta = '45' AND IDempleado = '$el_usuario' AND IDperiodo = $IDperiodo";
$respuesta_salto1 = mysql_query($query_respuesta_salto1, $vacantes) or die(mysql_error());
$row_respuesta_salto1= mysql_fetch_assoc($respuesta_salto1);
$totalRows_respuesta_salto1 = mysql_num_rows($respuesta_salto1);

mysql_select_db($database_vacantes, $vacantes);
$query_respuesta_salto2 = "SELECT * FROM nom35_respuestas WHERE IDexamen = '$el_examen' AND IDpregunta = '70' AND IDempleado = '$el_usuario' AND IDperiodo = $IDperiodo";
$respuesta_salto2 = mysql_query($query_respuesta_salto2, $vacantes) or die(mysql_error());
$row_respuesta_salto2= mysql_fetch_assoc($respuesta_salto2);
$totalRows_respuesta_salto2 = mysql_num_rows($respuesta_salto2);

// respuesta salto
$la_pregunta_salto1 = 45;
$la_pregunta_salto2 = 70;

$la_respuesta_salto1 = $row_respuesta_salto1['IDrespuesta'];
...
$reenvio = 'f_encuestas.php';
     if($pregunta_llave == 1 && $la_respuesta == 5) {$reenvio = 'f_encuestas.php?IDexamen=' . $el_examen . '&IDpregunta=' . $la_pregunta_salto1 . '&IDrespuesta=' . $la_respuesta_salto1;	}
else if($pregunta_llave == 2 && $la_respuesta == 5) {$reenvio = 'f_encuestas_result.php?IDexamen=' . $el_examen . '&IDempleado=' . $el_usuario;	}
else if($pregunta_llave == 3 && $la_respuesta == 5) {$reenvio = 'f_encuestas.php?IDexamen=' . $el_examen . '&IDpregunta=' . $la_pregunta_salto2 . '&IDrespuesta=' . $la_respuesta_salto;	}
else if($pregunta_llave == 4 && $la_respuesta == 5) {$reenvio = 'f_encuestas_result.php?IDexamen=' . $el_examen . '&IDempleado=' . $el_usuario;	}
else if($pregunta_llave == 5 && $la_respuesta == 5) {$reenvio = 'f_encuestas_result.php?IDexamen=' . $el_examen . '&IDempleado=' . $el_usuario. '&cierre=1';	}
