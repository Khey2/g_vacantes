...
mysql_select_db($database_vacantes, $vacantes);
$query_reporte = "SELECT prod_activos.IDempleado, prod_activos.emp_paterno, prod_activos.emp_materno, prod_activos.emp_nombre, vac_puestos.denominacion, prod_activos.sueldo_diario, inc_captura_2020.lul, inc_captura_2020.luf, inc_captura_2020.mal, inc_captura_2020.maf, inc_captura_2020.mil, inc_captura_2020.mif, inc_captura_2020.jul, inc_captura_2020.juf, inc_captura_2020.vil, inc_captura_2020.vif, inc_captura_2020.sal, inc_captura_2020.saf, inc_captura_2020.dol, inc_captura_2020.dof, inc_captura_2020.inc5, inc_captura_2020.validador, inc_captura_2020.obs5, prod_activos.descripcion_nomina FROM prod_activos LEFT JOIN vac_puestos ON prod_activos.IDpuesto = vac_puestos.IDpuesto LEFT JOIN vac_matriz ON prod_activos.IDmatriz = vac_matriz.IDmatriz  INNER JOIN inc_captura_2020 ON inc_captura_2020.IDempleado = prod_activos.IDempleado AND inc_captura_2020.semana = '$semana' LEFT JOIN inc_motivos ON inc_captura_2020.IDmotivo3 = inc_motivos.IDmotivo WHERE prod_activos.IDmatriz = '$IDmatriz' AND inc_captura_2020.inc5 > 0";
...
// Increment the Excel row counter
    ...
    header('Content-Disposition: attachment;filename="Premios por Viaje '.date('dmY') . " " . $matriz . '.xls"');
