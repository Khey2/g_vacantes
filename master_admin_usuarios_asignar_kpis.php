...
$upd_vac_usuarios->addColumn("IDareas_kpis", "STRING_TYPE", "POST", "IDareas_kpis");
$upd_vac_usuarios->addColumn("IDarea_kpi", "STRING_TYPE", "POST", "IDarea_kpi");
...
<div class="content">
                      ...
                      <form method="post" id="form1" action="<?php echo KT_escapeAttribute(KT_getFullUri()); ?>" class="form-horizontal form-validate-jquery">
						...
						<?php echo $row_usuario_['usuario_nombre'] . " " . $row_usuario_['usuario_parterno'] . " ". $row_usuario_['usuario_materno']; ?>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
						<input name="IDareas_kpis" id="IDareas_kpis" value="<?php echo KT_escapeAttribute($row_rsvac_usuarios['IDareas_kpis']); ?>"
                        wdg:recordset="area" wdg:subtype="CommaCheckboxes" wdg:type="widget" wdg:displayfield="area" wdg:valuefield="IDarea" wdg:groupby="1" />
										</div>
									</div>
									<!-- /basic text input -->
                                     ...
                                     <!-- Basic text input -->
									<div class="form-group">
										<label class="control-label col-lg-3">Área Inicial:</label>
										<div class="col-lg-9">
											<select name="IDarea_kpi" class="form-control" required="required">
											<?php  do {  ?>
                                            <option value="<?php echo $row_area2['IDarea']?>" <?php if (!(strcmp($row_area2['IDarea'], htmlentities(KT_escapeAttribute($row_rsvac_usuarios['IDarea_kpi']), ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $row_area2['area']?></option>
                                            <?php } while ($row_area2 = mysql_fetch_assoc($area2)); ?>
                                          </select>
										</div>
									</div>
									<!-- /basic text input -->
            ...
            <input type="submit" name="KT_Update1" id="KT_Update1"  value="Asigar Áreas" class="btn bg-success btn-icon" />
